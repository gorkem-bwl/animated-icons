...
const UTurnArrowRight = forwardRef(({
  size = 24,
  color = 'currentColor',
  primaryColor,
  secondaryColor,
  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-iconoir animated-iconoir-u-turn-arrow-right ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M16 14V8.00005C16 5.23862 13.7614 3 11 3C8.23858 3 6 5.23862 6 8.00005V21" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-primary ai-anim-nudge ai-delay-0" style={{ '--ai-tx': '1px', '--ai-ty': '0px' }} />
        <path d="M12 11C13.5621 12.5621 14.4379 13.4379 16 15C17.5621 13.4379 18.4379 12.5621 20 11" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-secondary ai-anim-nudge ai-delay-1" style={{ '--ai-tx': '2px', '--ai-ty': '0px' }} />
      </svg>
    </>
  );
});

UTurnArrowRight.displayName = 'UTurnArrowRight';

export { UTurnArrowRight };
