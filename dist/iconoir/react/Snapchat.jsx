  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-iconoir animated-iconoir-snapchat ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <rect width="24" height="24" strokeWidth="1.5" fill="white" className="ai-primary ai-anim-fill ai-delay-0" style={{}} />
