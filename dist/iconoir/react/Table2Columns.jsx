...
const Table2Columns = forwardRef(({
  size = 24,
  color = 'currentColor',
  primaryColor,
  secondaryColor,
  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-iconoir animated-iconoir-table-2-columns ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        ...
        <path d="M3 16.5H21" stroke="currentColor" strokeWidth="1.5" className="ai-secondary ai-anim-fade ai-delay-1" style={{}} />
        <path d="M3 12H21" stroke="currentColor" strokeWidth="1.5" className="ai-secondary ai-anim-fade ai-delay-2" style={{}} />
        <path d="M21 7.5H3" stroke="currentColor" strokeWidth="1.5" className="ai-secondary ai-anim-fade ai-delay-3" style={{}} />
        <path d="M12 21V3" stroke="currentColor" strokeWidth="1.5" className="ai-secondary ai-anim-fade ai-delay-4" style={{}} />
      </svg>
    </>
  );
});
