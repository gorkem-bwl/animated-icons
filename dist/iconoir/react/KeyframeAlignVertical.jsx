...
const KeyframeAlignVertical = forwardRef(({
  size = 24,
  color = 'currentColor',
  primaryColor,
  secondaryColor,
  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-iconoir animated-iconoir-keyframe-align-vertical ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
...
KeyframeAlignVertical.displayName = 'KeyframeAlignVertical';

export { KeyframeAlignVertical };
