...
const Square3dFromCenter = forwardRef(({
  size = 24,
  color = 'currentColor',
  primaryColor,
  secondaryColor,
  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-iconoir animated-iconoir-square-3d-from-center ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
...
Square3dFromCenter.displayName = 'Square3dFromCenter';

export { Square3dFromCenter };
