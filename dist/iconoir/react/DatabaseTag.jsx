  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-iconoir animated-iconoir-database-tag ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        ...
        <path d="M16.3571 12C17.0714 12 18.5 12 18.5 10C18.5 8 17.0714 8 16.3571 8L13.5 8V12M16.3571 12C15.2143 12 13.9762 12 13.5 12M16.3571 12C17.0714 12 18.5 12 18.5 14C18.5 16 17.0714 16 16.3571 16H13.5V12" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-secondary ai-anim-fade ai-delay-1" style={{}} />
        <path d="M8.35714 8H5.5V12L5.5 16H8.35714C9.07143 16 10.5 16 10.5 14V10C10.5 8 9.07143 8 8.35714 8Z" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-secondary ai-anim-fade ai-delay-2" style={{}} />
      </svg>
    </>
  );
});

DatabaseTag.displayName = 'DatabaseTag';
