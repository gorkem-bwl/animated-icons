  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-iconoir animated-iconoir-wifi-tag ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        ...
        <path d="M12 14.76L12.01 14.7489" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-secondary ai-anim-fade ai-delay-1" style={{}} />
        <path d="M7 11.2499C9.5 8.25001 14.5 8.25 17 11.25" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-secondary ai-anim-fade ai-delay-2" style={{}} />
        <path d="M9 13.25C10.5 11.25 13.5 11.25 15 13.25" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-secondary ai-anim-fade ai-delay-3" style={{}} />
      </svg>
    </>
  );
});

WifiTag.displayName = 'WifiTag';
