  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-iconoir animated-iconoir-menu ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M3 5H21" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-primary ai-anim-menu-line ai-delay-0" style={{ '--ai-scale-x': '1' }} />
        <path d="M3 12H21" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-secondary ai-anim-menu-line ai-delay-1" style={{ '--ai-scale-x': '0.85' }} />
