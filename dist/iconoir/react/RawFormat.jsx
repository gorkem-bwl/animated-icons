  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-iconoir animated-iconoir-raw-format ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        ...
        <path d="M16.5 9V15L18 12L19.5 15V9" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-secondary ai-anim-scale-pop ai-delay-2" style={{}} />
        <path d="M10.5 15V12M10.5 12V10.5C10.5 9.67157 11.1716 9 12 9V9C12.8284 9 13.5 9.67157 13.5 10.5L13.5 12M10.5 12H13.5M13.5 12L13.5 15" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-secondary ai-anim-scale-pop ai-delay-3" style={{}} />
        <path d="M4.5 15V12V9H6.9C7.23137 9 7.5 9.26863 7.5 9.6L7.5 10.5C7.5 11.3284 6.82843 12 6 12V12" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-secondary ai-anim-scale-pop ai-delay-4" style={{}} />
        <path d="M4.5 12H6V12C6.82843 12 7.5 12.6716 7.5 13.5L7.5 15" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-secondary ai-anim-scale-pop ai-delay-5" style={{}} />
      </svg>
    </>
  );
});

RawFormat.displayName = 'RawFormat';
