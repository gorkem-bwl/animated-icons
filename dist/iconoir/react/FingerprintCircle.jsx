...
const FingerprintCircle = forwardRef(({
  size = 24,
  color = 'currentColor',
  primaryColor,
  secondaryColor,
  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-iconoir animated-iconoir-fingerprint-circle ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
...
FingerprintCircle.displayName = 'FingerprintCircle';

export { FingerprintCircle };
