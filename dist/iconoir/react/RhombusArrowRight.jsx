...
const RhombusArrowRight = forwardRef(({
  size = 24,
  color = 'currentColor',
  primaryColor,
  secondaryColor,
  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-iconoir animated-iconoir-rhombus-arrow-right ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M16 11H10C9 11 8 12 8 13V14M16 11L14 9M16 11L14 13" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-primary ai-anim-nudge ai-delay-0" style={{ '--ai-tx': '1px', '--ai-ty': '0px' }} />
        <path d="M1.42426 11.5757L11.5757 1.42426C11.8101 1.18995 12.1899 1.18995 12.4243 1.42426L22.5757 11.5757C22.8101 11.8101 22.81 12.1899 22.5757 12.4243L12.4243 22.5757C12.1899 22.8101 11.8101 22.81 11.5757 22.5757L1.42426 12.4243C1.18995 12.1899 1.18995 11.8101 1.42426 11.5757Z" stroke="currentColor" strokeLinejoin="round" className="ai-secondary ai-anim-nudge ai-delay-1" style={{ '--ai-tx': '2px', '--ai-ty': '0px' }} />
        <rect width="24" height="24" fill="white" className="ai-secondary ai-anim-nudge ai-delay-2" style={{ '--ai-tx': '2px', '--ai-ty': '0px' }} />
      </svg>
    </>
  );
});

RhombusArrowRight.displayName = 'RhombusArrowRight';

export { RhombusArrowRight };
