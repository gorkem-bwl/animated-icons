  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-iconoir animated-iconoir-mpeg-format ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        ...
        <path d="M7.5 15V12M7.5 12V9H10.5L10.5 12H7.5Z" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-secondary ai-anim-scale-pop ai-delay-2" style={{}} />
        <path d="M1.5 15L1.5 9L3 12L4.5 9L4.5 15" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-secondary ai-anim-scale-pop ai-delay-3" style={{}} />
        <path d="M16.5 9H13.5L13.5 15L16.5 15" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-secondary ai-anim-scale-pop ai-delay-4" style={{}} />
        <path d="M22.5 9H19.5V15L22.5 15V12.6" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-secondary ai-anim-scale-pop ai-delay-5" style={{}} />
        <path d="M13.5 12H15.5" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-secondary ai-anim-scale-pop ai-delay-6" style={{}} />
      </svg>
    </>
  );
});

MpegFormat.displayName = 'MpegFormat';
