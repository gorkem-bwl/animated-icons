...
const NetworkReverse = forwardRef(({
  size = 24,
  color = 'currentColor',
  primaryColor,
  secondaryColor,
  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-iconoir animated-iconoir-network-reverse ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <rect width="7" height="5" rx="0.6" transform="matrix(1 0 0 -1 3 22)" stroke="currentColor" strokeWidth="1.5" className="ai-primary ai-anim-fill ai-delay-0" style={{}} />
        <rect width="7" height="5" rx="0.6" transform="matrix(1 0 0 -1 8.5 7)" stroke="currentColor" strokeWidth="1.5" className="ai-secondary ai-anim-fade ai-delay-1" style={{}} />
        <rect width="7" height="5" rx="0.6" transform="matrix(1 0 0 -1 14 22)" stroke="currentColor" strokeWidth="1.5" className="ai-primary ai-anim-fade ai-delay-2" style={{}} />
        <path d="M6.5 17V13.5C6.5 12.3954 7.39543 11.5 8.5 11.5H15.5C16.6046 11.5 17.5 12.3954 17.5 13.5V17" stroke="currentColor" strokeWidth="1.5" className="ai-secondary ai-anim-fade ai-delay-3" style={{}} />
        <path d="M12 11.5V7" stroke="currentColor" strokeWidth="1.5" className="ai-primary ai-anim-fade ai-delay-4" style={{}} />
      </svg>
    </>
  );
});

NetworkReverse.displayName = 'NetworkReverse';

export { NetworkReverse };
