  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-iconoir animated-iconoir-expand ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M9 9L4 4M4 4V8M4 4H8" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-primary ai-anim-scale-pop ai-delay-0" style={{}} />
        <path d="M15 9L20 4M20 4V8M20 4H16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-secondary ai-anim-scale-pop ai-delay-1" style={{}} />
        <path d="M9 15L4 20M4 20V16M4 20H8" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-secondary ai-anim-scale-pop ai-delay-2" style={{}} />
        <path d="M15 15L20 20M20 20V16M20 20H16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-secondary ai-anim-scale-pop ai-delay-3" style={{}} />
      </svg>
    </>
  );
});
