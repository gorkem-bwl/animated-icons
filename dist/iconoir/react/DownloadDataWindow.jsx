...
const DownloadDataWindow = forwardRef(({
  size = 24,
  color = 'currentColor',
  primaryColor,
  secondaryColor,
  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-iconoir animated-iconoir-download-data-window ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M14 21H4C2.89543 21 2 20.1046 2 19V5C2 3.89543 2.89543 3 4 3H20C21.1046 3 22 3.89543 22 5V14" stroke="currentColor" strokeLinecap="round" className="ai-primary ai-anim-scale-pop ai-delay-0" style={{}} />
        ...
        <path d="M19.5 16V22M19.5 22L17 19.5M19.5 22L22 19.5" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-secondary ai-anim-scale-pop ai-delay-5" style={{}} />
      </svg>
    </>
  );
});

DownloadDataWindow.displayName = 'DownloadDataWindow';

export { DownloadDataWindow };
