  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-iconoir animated-iconoir-sun-light ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M12 18C15.3137 18 18 15.3137 18 12C18 8.68629 15.3137 6 12 6C8.68629 6 6 8.68629 6 12C6 15.3137 8.68629 18 12 18Z" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-primary ai-anim-gear ai-delay-0" style={{ '--ai-rotation': '45deg' }} />
        <path d="M22 12L23 12" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-secondary ai-anim-fade ai-delay-1" style={{ '--ai-rotation': '45deg' }} />
        <path d="M12 2V1" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-secondary ai-anim-fade ai-delay-2" style={{ '--ai-rotation': '45deg' }} />
        <path d="M12 23V22" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-secondary ai-anim-fade ai-delay-3" style={{ '--ai-rotation': '45deg' }} />
        <path d="M20 20L19 19" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-secondary ai-anim-fade ai-delay-4" style={{ '--ai-rotation': '45deg' }} />
        <path d="M20 4L19 5" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-secondary ai-anim-fade ai-delay-5" style={{ '--ai-rotation': '45deg' }} />
        <path d="M4 20L5 19" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-secondary ai-anim-fade ai-delay-6" style={{ '--ai-rotation': '45deg' }} />
        <path d="M4 4L5 5" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-secondary ai-anim-fade ai-delay-7" style={{ '--ai-rotation': '45deg' }} />
        <path d="M1 12L2 12" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-secondary ai-anim-fade ai-delay-7" style={{ '--ai-rotation': '45deg' }} />
      </svg>
    </>
  );
});
