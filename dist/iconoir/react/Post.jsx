  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-iconoir animated-iconoir-post ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        ...
        <path d="M8.92902 6.38184L16.8075 7.77102" stroke="currentColor" strokeLinecap="round" className="ai-secondary ai-anim-scale-pop ai-delay-1" style={{}} />
        <path d="M8.23444 10.3213L16.1129 11.7105" stroke="currentColor" strokeLinecap="round" className="ai-secondary ai-anim-scale-pop ai-delay-2" style={{}} />
        <path d="M7.53986 14.2607L12.4639 15.129" stroke="currentColor" strokeLinecap="round" className="ai-secondary ai-anim-scale-pop ai-delay-3" style={{}} />
      </svg>
    </>
  );
});
