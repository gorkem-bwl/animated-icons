...
const ArrowEmailForward = forwardRef(({
  size = 24,
  color = 'currentColor',
  primaryColor,
  secondaryColor,
  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-iconoir animated-iconoir-arrow-email-forward ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M22 10L8 10C0 10 0 21 8 21M22 10L15 3M22 10L15 17" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-primary ai-anim-mail-flap ai-delay-0" style={{}} />
      </svg>
    </>
  );
});

ArrowEmailForward.displayName = 'ArrowEmailForward';

export { ArrowEmailForward };
