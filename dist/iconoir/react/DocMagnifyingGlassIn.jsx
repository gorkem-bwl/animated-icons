...
const DocMagnifyingGlassIn = forwardRef(({
  size = 24,
  color = 'currentColor',
  primaryColor,
  secondaryColor,
  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-iconoir animated-iconoir-doc-magnifying-glass-in ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
...
DocMagnifyingGlassIn.displayName = 'DocMagnifyingGlassIn';

export { DocMagnifyingGlassIn };
