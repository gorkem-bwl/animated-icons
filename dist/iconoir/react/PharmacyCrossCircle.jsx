...
const PharmacyCrossCircle = forwardRef(({
  size = 24,
  color = 'currentColor',
  primaryColor,
  secondaryColor,
  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-iconoir animated-iconoir-pharmacy-cross-circle ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
...
PharmacyCrossCircle.displayName = 'PharmacyCrossCircle';

export { PharmacyCrossCircle };
