  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-iconoir animated-iconoir-mail-out ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M5 9L9.5 12L14 9" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-primary ai-anim-mail-flap ai-delay-0" style={{}} />
        <path d="M17 19H3C1.89543 19 1 18.1046 1 17V7C1 5.89543 1.89543 5 3 5H16C17.1046 5 18 5.89543 18 7V9" stroke="currentColor" strokeLinecap="round" className="ai-secondary ai-anim-fill ai-delay-1" style={{}} />
        <path d="M17 14H23M23 14L20 11M23 14L20 17" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-secondary ai-anim-fill ai-delay-2" style={{}} />
      </svg>
    </>
  );
});
