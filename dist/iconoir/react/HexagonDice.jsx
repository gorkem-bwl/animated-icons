  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-iconoir animated-iconoir-hexagon-dice ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        ...
        <path d="M17 15L7 15L12 7L17 15Z" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-secondary ai-anim-fade ai-delay-1" style={{}} />
        <path d="M2.5 6.5L12 7" stroke="currentColor" strokeLinejoin="round" className="ai-secondary ai-anim-fade ai-delay-2" style={{}} />
        <path d="M2.5 6.5L7 15" stroke="currentColor" strokeLinejoin="round" className="ai-secondary ai-anim-fade ai-delay-3" style={{}} />
        <path d="M21.5 6.5L17 15" stroke="currentColor" strokeLinejoin="round" className="ai-secondary ai-anim-fade ai-delay-4" style={{}} />
        <path d="M21.5 6.5L12 6.99995L12 1" stroke="currentColor" strokeLinejoin="round" className="ai-secondary ai-anim-fade ai-delay-5" style={{}} />
        <path d="M21.5 17.5L17 15" stroke="currentColor" strokeLinejoin="round" className="ai-secondary ai-anim-fade ai-delay-6" style={{}} />
        <path d="M2.5 17.5L7 15" stroke="currentColor" strokeLinejoin="round" className="ai-secondary ai-anim-fade ai-delay-7" style={{}} />
        <path d="M7 15L12 23L17 15" stroke="currentColor" strokeLinejoin="round" className="ai-secondary ai-anim-fade ai-delay-7" style={{}} />
      </svg>
    </>
  );
});

HexagonDice.displayName = 'HexagonDice';
