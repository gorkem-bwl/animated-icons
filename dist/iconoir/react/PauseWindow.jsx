  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-iconoir animated-iconoir-pause-window ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M16 21H4C2.89543 21 2 20.1046 2 19V5C2 3.89543 2.89543 3 4 3H20C21.1046 3 22 3.89543 22 5V14" stroke="currentColor" strokeLinecap="round" className="ai-primary ai-anim-scale-pop ai-delay-0" style={{}} />
        <path d="M19 17L19 22" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-secondary ai-anim-scale-pop ai-delay-1" style={{}} />
        <path d="M22 17L22 22" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-secondary ai-anim-scale-pop ai-delay-2" style={{}} />
        <path d="M2 7L22 7" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-secondary ai-anim-scale-pop ai-delay-3" style={{}} />
        <path d="M5 5.01L5.01 4.99889" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-secondary ai-anim-scale-pop ai-delay-4" style={{}} />
        <path d="M8 5.01L8.01 4.99889" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-secondary ai-anim-scale-pop ai-delay-5" style={{}} />
        <path d="M11 5.01L11.01 4.99889" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-secondary ai-anim-scale-pop ai-delay-6" style={{}} />
      </svg>
    </>
  );
});

PauseWindow.displayName = 'PauseWindow';
