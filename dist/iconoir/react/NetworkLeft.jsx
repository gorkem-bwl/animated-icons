  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-iconoir animated-iconoir-network-left ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <rect x="2" y="21" width="7" height="5" rx="0.6" transform="rotate(-90 2 21)" stroke="currentColor" strokeWidth="1.5" className="ai-primary ai-anim-fill ai-delay-0" style={{}} />
        <rect x="17" y="15.5" width="7" height="5" rx="0.6" transform="rotate(-90 17 15.5)" stroke="currentColor" strokeWidth="1.5" className="ai-secondary ai-anim-fade ai-delay-1" style={{}} />
        <rect x="2" y="10" width="7" height="5" rx="0.6" transform="rotate(-90 2 10)" stroke="currentColor" strokeWidth="1.5" className="ai-primary ai-anim-fade ai-delay-2" style={{}} />
        <path d="M7 17.5H10.5C11.6046 17.5 12.5 16.6046 12.5 15.5V8.5C12.5 7.39543 11.6046 6.5 10.5 6.5H7" stroke="currentColor" strokeWidth="1.5" className="ai-secondary ai-anim-fade ai-delay-3" style={{}} />
        <path d="M12.5 12H17" stroke="currentColor" strokeWidth="1.5" className="ai-primary ai-anim-fade ai-delay-4" style={{}} />
      </svg>
    </>
  );
});
