...
const DroneChargeLow = forwardRef(({
  size = 24,
  color = 'currentColor',
  primaryColor,
  secondaryColor,
  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-iconoir animated-iconoir-drone-charge-low ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
...
DroneChargeLow.displayName = 'DroneChargeLow';

export { DroneChargeLow };
