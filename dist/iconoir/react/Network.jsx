  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-iconoir animated-iconoir-network ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <rect x="3" y="2" width="7" height="5" rx="0.6" stroke="currentColor" strokeWidth="1.5" className="ai-primary ai-anim-fill ai-delay-0" style={{}} />
        <rect x="8.5" y="17" width="7" height="5" rx="0.6" stroke="currentColor" strokeWidth="1.5" className="ai-secondary ai-anim-fade ai-delay-1" style={{}} />
        <rect x="14" y="2" width="7" height="5" rx="0.6" stroke="currentColor" strokeWidth="1.5" className="ai-primary ai-anim-fade ai-delay-2" style={{}} />
        <path d="M6.5 7V10.5C6.5 11.6046 7.39543 12.5 8.5 12.5H15.5C16.6046 12.5 17.5 11.6046 17.5 10.5V7" stroke="currentColor" strokeWidth="1.5" className="ai-secondary ai-anim-fade ai-delay-3" style={{}} />
        <path d="M12 12.5V17" stroke="currentColor" strokeWidth="1.5" className="ai-primary ai-anim-fade ai-delay-4" style={{}} />
      </svg>
    </>
  );
});
