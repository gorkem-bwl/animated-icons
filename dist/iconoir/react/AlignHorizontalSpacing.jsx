...
const AlignHorizontalSpacing = forwardRef(({
  size = 24,
  color = 'currentColor',
  primaryColor,
  secondaryColor,
  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-iconoir animated-iconoir-align-horizontal-spacing ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M3 22L3 2" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-primary ai-anim-scale-pop ai-delay-0" style={{}} />
        <path d="M21 22V2" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-secondary ai-anim-fade ai-delay-1" style={{}} />
        <path d="M15 16H9C7.89543 16 7 15.1046 7 14V10C7 8.89543 7.89543 8 9 8H15C16.1046 8 17 8.89543 17 10V14C17 15.1046 16.1046 16 15 16Z" stroke="currentColor" className="ai-secondary ai-anim-fade ai-delay-2" style={{}} />
      </svg>
    </>
  );
});

AlignHorizontalSpacing.displayName = 'AlignHorizontalSpacing';

export { AlignHorizontalSpacing };
