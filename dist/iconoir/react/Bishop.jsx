  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-iconoir animated-iconoir-bishop ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M7 17L17 17" stroke="currentColor" strokeLinecap="round" className="ai-primary ai-anim-fill ai-delay-0" style={{}} />
        <path d="M9 12L15 12" stroke="currentColor" strokeLinecap="round" className="ai-secondary ai-anim-fade ai-delay-1" style={{}} />
        <path d="M12 3V2" stroke="currentColor" strokeLinecap="round" className="ai-secondary ai-anim-fade ai-delay-2" style={{}} />
