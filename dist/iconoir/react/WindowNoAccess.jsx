...
const WindowNoAccess = forwardRef(({
  size = 24,
  color = 'currentColor',
  primaryColor,
  secondaryColor,
  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-iconoir animated-iconoir-window-no-access ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M12 21H4C2.89543 21 2 20.1046 2 19V5C2 3.89543 2.89543 3 4 3H20C21.1046 3 22 3.89543 22 5V13" stroke="currentColor" strokeLinecap="round" className="ai-primary ai-anim-scale-pop ai-delay-0" style={{}} />
...
WindowNoAccess.displayName = 'WindowNoAccess';

export { WindowNoAccess };
