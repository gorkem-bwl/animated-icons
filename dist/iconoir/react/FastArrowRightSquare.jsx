...
const FastArrowRightSquare = forwardRef(({
  size = 24,
  color = 'currentColor',
  primaryColor,
  secondaryColor,
  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-iconoir animated-iconoir-fast-arrow-right-square ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M8 8.5L11.5 12L8 15.5" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-primary ai-anim-nudge ai-delay-0" style={{ '--ai-tx': '1px', '--ai-ty': '0px' }} />
        <path d="M14 8.5L17.5 12L14 15.5" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-secondary ai-anim-nudge ai-delay-1" style={{ '--ai-tx': '2px', '--ai-ty': '0px' }} />
        <path d="M3 20.4V3.6C3 3.26863 3.26863 3 3.6 3H20.4C20.7314 3 21 3.26863 21 3.6V20.4C21 20.7314 20.7314 21 20.4 21H3.6C3.26863 21 3 20.7314 3 20.4Z" stroke="currentColor" strokeWidth="1.5" className="ai-secondary ai-anim-nudge ai-delay-2" style={{ '--ai-tx': '2px', '--ai-ty': '0px' }} />
      </svg>
    </>
  );
});

FastArrowRightSquare.displayName = 'FastArrowRightSquare';

export { FastArrowRightSquare };
