...
const DroneChargeFull = forwardRef(({
  size = 24,
  color = 'currentColor',
  primaryColor,
  secondaryColor,
  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-iconoir animated-iconoir-drone-charge-full ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M14.25 14.75L14.5 12.5L14.926 8.66626C14.9655 8.31084 14.6872 8 14.3296 8L9.67036 8C9.31275 8 9.03454 8.31084 9.07403 8.66626L9.9407 16.4663C9.97446 16.7701 10.2313 17 10.537 17H11" stroke="currentColor" strokeLinecap="round" className="ai-primary ai-anim-fill ai-delay-0" style={{}} />
        ...
        <path d="M23 19V21" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-secondary ai-anim-fade ai-delay-7" style={{}} />
        <path d="M15 19V21" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-secondary ai-anim-fade ai-delay-7" style={{}} />
        <path d="M17 19V21" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-secondary ai-anim-fade ai-delay-7" style={{}} />
        <path d="M19 19V21" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-secondary ai-anim-fade ai-delay-7" style={{}} />
        <path d="M13 22.4V17.6C13 17.2686 13.2686 17 13.6 17H20.4C20.7314 17 21 17.2686 21 17.6V22.4C21 22.7314 20.7314 23 20.4 23H13.6C13.2686 23 13 22.7314 13 22.4Z" stroke="currentColor" className="ai-secondary ai-anim-fade ai-delay-7" style={{}} />
      </svg>
    </>
  );
});

DroneChargeFull.displayName = 'DroneChargeFull';

export { DroneChargeFull };
