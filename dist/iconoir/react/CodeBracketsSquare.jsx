...
const CodeBracketsSquare = forwardRef(({
  size = 24,
  color = 'currentColor',
  primaryColor,
  secondaryColor,
  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-iconoir animated-iconoir-code-brackets-square ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
...
CodeBracketsSquare.displayName = 'CodeBracketsSquare';

export { CodeBracketsSquare };
