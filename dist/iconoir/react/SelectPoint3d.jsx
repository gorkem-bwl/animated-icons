...
const SelectPoint3d = forwardRef(({
  size = 24,
  color = 'currentColor',
  primaryColor,
  secondaryColor,
  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-iconoir animated-iconoir-select-point-3d ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
...
SelectPoint3d.displayName = 'SelectPoint3d';

export { SelectPoint3d };
