  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-iconoir animated-iconoir-tiff-format ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        ...
        <path d="M12 15L12 9H15" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-secondary ai-anim-scale-pop ai-delay-2" style={{}} />
        <path d="M17.5 15V9H20.5" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-secondary ai-anim-scale-pop ai-delay-3" style={{}} />
        <path d="M3.5 9H5M6.5 9H5M5 9L5 15" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-secondary ai-anim-scale-pop ai-delay-4" style={{}} />
        <path d="M12 12H14.5" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-secondary ai-anim-scale-pop ai-delay-5" style={{}} />
        <path d="M17.5 12H20" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-secondary ai-anim-scale-pop ai-delay-6" style={{}} />
        <path d="M9 15L9 9" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-secondary ai-anim-scale-pop ai-delay-7" style={{}} />
      </svg>
    </>
  );
});

TiffFormat.displayName = 'TiffFormat';
