  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-iconoir animated-iconoir-key-xmark ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M15.8709 20.1213L17.9922 18M20.1135 15.8787L17.9922 18M17.9922 18L15.8709 15.8787M17.9922 18L20.1135 20.1213" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-primary ai-anim-fade ai-delay-0" style={{}} />
        ...
        <path d="M6.75549 16L8.87681 18.1213" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-secondary ai-anim-fade ai-delay-2" style={{}} />
      </svg>
    </>
  );
});

KeyXmark.displayName = 'KeyXmark';
