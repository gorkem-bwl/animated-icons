...
const KeyframeMinusIn = forwardRef(({
  size = 24,
  color = 'currentColor',
  primaryColor,
  secondaryColor,
  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-iconoir animated-iconoir-keyframe-minus-in ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
...
KeyframeMinusIn.displayName = 'KeyframeMinusIn';

export { KeyframeMinusIn };
