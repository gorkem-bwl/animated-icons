...
const GasTankDroplet = forwardRef(({
  size = 24,
  color = 'currentColor',
  primaryColor,
  secondaryColor,
  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-iconoir animated-iconoir-gas-tank-droplet ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
