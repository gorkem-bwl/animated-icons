  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-iconoir animated-iconoir-menu-scale ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M3 5H11" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-primary ai-anim-menu-line ai-delay-0" style={{ '--ai-scale-x': '1' }} />
        <path d="M3 12H16" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-secondary ai-anim-menu-line ai-delay-1" style={{ '--ai-scale-x': '0.85' }} />
        <path d="M3 19H21" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-primary ai-anim-menu-line ai-delay-2" style={{ '--ai-scale-x': '0.7' }} />
      </svg>
    </>
  );
});
