...
const SettingsProfiles = forwardRef(({
  size = 24,
  color = 'currentColor',
  primaryColor,
  secondaryColor,
  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-iconoir animated-iconoir-settings-profiles ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
