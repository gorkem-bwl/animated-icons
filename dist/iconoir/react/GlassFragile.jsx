  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-iconoir animated-iconoir-glass-fragile ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M8 22H12M16 22H12M12 22L12 15" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-primary ai-anim-fill ai-delay-0" style={{}} />
        <path d="M6.57808 10.0476C7.78286 12.6823 12 15 12 15C12 15 16.2171 12.6823 17.4219 10.0476C18.7226 7.20319 17.4219 2 17.4219 2L6.57808 2C6.57808 2 5.2774 7.20319 6.57808 10.0476Z" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-secondary ai-anim-fade ai-delay-1" style={{}} />
        <path d="M12.5 2L10.5 6H13.5L11.5 10" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-secondary ai-anim-fade ai-delay-2" style={{}} />
      </svg>
    </>
  );
});

GlassFragile.displayName = 'GlassFragile';
