...
const Number3Square = forwardRef(({
  size = 24,
  color = 'currentColor',
  primaryColor,
  secondaryColor,
  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-iconoir animated-iconoir-number-3-square ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        ...
        <path d="M9.5 10C9.5 8.89543 10.6193 8 12 8C13.3807 8 14.5 8.89543 14.5 10C14.5 11.1046 13.8807 12 12.5 12" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-secondary ai-anim-scale-pop ai-delay-1" style={{}} />
        <path d="M9.5 14C9.5 15.1046 10.6193 16 12 16C13.3807 16 14.5 15.1046 14.5 14C14.5 12.8954 13.8807 12 12.5 12" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-secondary ai-anim-scale-pop ai-delay-2" style={{}} />
      </svg>
    </>
  );
});

Number3Square.displayName = 'Number3Square';

export { Number3Square };
