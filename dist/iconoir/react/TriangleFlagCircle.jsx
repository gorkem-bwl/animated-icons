...
const TriangleFlagCircle = forwardRef(({
  size = 24,
  color = 'currentColor',
  primaryColor,
  secondaryColor,
  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-iconoir animated-iconoir-triangle-flag-circle ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
