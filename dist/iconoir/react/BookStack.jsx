  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-iconoir animated-iconoir-book-stack ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M5 19.5V5C5 3.89543 5.89543 3 7 3H18.4C18.7314 3 19 3.26863 19 3.6V21" stroke="currentColor" strokeLinecap="round" className="ai-primary ai-anim-fill ai-delay-0" style={{}} />
        <path d="M9 7L15 7" stroke="currentColor" strokeLinecap="round" className="ai-secondary ai-anim-page-turn ai-delay-1" style={{}} />
        <path d="M6.5 15L19 15" stroke="currentColor" strokeLinecap="round" className="ai-secondary ai-anim-page-turn ai-delay-2" style={{}} />
        <path d="M6.5 18L19 18" stroke="currentColor" strokeLinecap="round" className="ai-secondary ai-anim-page-turn ai-delay-3" style={{}} />
        <path d="M6.5 21L19 21" stroke="currentColor" strokeLinecap="round" className="ai-secondary ai-anim-page-turn ai-delay-4" style={{}} />
        <path d="M6.5 18C5.5 18 5 17.3284 5 16.5C5 15.6716 5.5 15 6.5 15" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-secondary ai-anim-page-turn ai-delay-5" style={{}} />
        <path d="M6.5 21C5.5 21 5 20.3284 5 19.5C5 18.6716 5.5 18 6.5 18" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-secondary ai-anim-page-turn ai-delay-6" style={{}} />
      </svg>
    </>
  );
});
