  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-iconoir animated-iconoir-book-lock ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        ...
        <path d="M14 10H14.4C14.7314 10 15 10.2686 15 10.6V13.4C15 13.7314 14.7314 14 14.4 14H9.6C9.26863 14 9 13.7314 9 13.4V10.6C9 10.2686 9.26863 10 9.6 10H10M14 10V8C14 7.33333 13.6 6 12 6C10.4 6 10 7.33333 10 8V10M14 10H10" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-secondary ai-anim-page-turn ai-delay-1" style={{}} />
        <path d="M6 17L20 17" stroke="currentColor" strokeLinecap="round" className="ai-secondary ai-anim-page-turn ai-delay-2" style={{}} />
        <path d="M6 21L20 21" stroke="currentColor" strokeLinecap="round" className="ai-secondary ai-anim-page-turn ai-delay-3" style={{}} />
        <path d="M6 21C4.89543 21 4 20.1046 4 19C4 17.8954 4.89543 17 6 17" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-secondary ai-anim-page-turn ai-delay-4" style={{}} />
      </svg>
    </>
  );
});
