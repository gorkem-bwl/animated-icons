...
const DropletSnowFlakeIn = forwardRef(({
  size = 24,
  color = 'currentColor',
  primaryColor,
  secondaryColor,
  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-iconoir animated-iconoir-droplet-snow-flake-in ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M20 14C20 9.58172 12 2 12 2C12 2 4 9.58172 4 14C4 18.4183 7.58172 22 12 22C16.4183 22 20 18.4183 20 14Z" stroke="currentColor" strokeWidth="1.5" className="ai-primary ai-anim-fade ai-delay-0" style={{}} />
        <path d="M12 10L12 13.5M12 17L12 13.5M12 13.5L9 11.75M12 13.5L15 15.25M12 13.5L15 11.75M12 13.5L9 15.25" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-secondary ai-anim-fade ai-delay-1" style={{}} />
      </svg>
    </>
  );
});

DropletSnowFlakeIn.displayName = 'DropletSnowFlakeIn';

export { DropletSnowFlakeIn };
