...
const ShoppingBagPlus = forwardRef(({
  size = 24,
  color = 'currentColor',
  primaryColor,
  secondaryColor,
  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-iconoir animated-iconoir-shopping-bag-plus ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        ...
        <path d="M14 5C14 3.89543 13.1046 3 12 3C10.8954 3 10 3.89543 10 5" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-secondary ai-anim-shake ai-delay-1" style={{}} />
        <path d="M8.99219 15H11.9922M14.9922 15H11.9922M11.9922 15V12M11.9922 15V18" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-secondary ai-anim-shake ai-delay-2" style={{}} />
      </svg>
    </>
  );
});
