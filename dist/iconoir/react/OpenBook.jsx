  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-iconoir animated-iconoir-open-book ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M12 21V7C12 5.89543 12.8954 5 14 5H21.4C21.7314 5 22 5.26863 22 5.6V18.7143" stroke="currentColor" strokeLinecap="round" className="ai-primary ai-anim-fill ai-delay-0" style={{}} />
        <path d="M12 21V7C12 5.89543 11.1046 5 10 5H2.6C2.26863 5 2 5.26863 2 5.6V18.7143" stroke="currentColor" strokeLinecap="round" className="ai-secondary ai-anim-page-turn ai-delay-1" style={{}} />
        <path d="M14 19L22 19" stroke="currentColor" strokeLinecap="round" className="ai-secondary ai-anim-page-turn ai-delay-2" style={{}} />
        <path d="M10 19L2 19" stroke="currentColor" strokeLinecap="round" className="ai-secondary ai-anim-page-turn ai-delay-3" style={{}} />
        <path d="M12 21C12 19.8954 12.8954 19 14 19" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-secondary ai-anim-page-turn ai-delay-4" style={{}} />
        <path d="M12 21C12 19.8954 11.1046 19 10 19" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-secondary ai-anim-page-turn ai-delay-5" style={{}} />
      </svg>
    </>
  );
});
