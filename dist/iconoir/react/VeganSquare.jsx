  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-iconoir animated-iconoir-vegan-square ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        ...
        <path d="M14.5 10.5C12.75 12.3824 11 17 11 17C11 17 8.5 10.5 6 9" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-secondary ai-anim-fade ai-delay-1" style={{}} />
...
VeganSquare.displayName = 'VeganSquare';
