  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-iconoir animated-iconoir-mail-open ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
