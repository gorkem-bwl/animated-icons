...
const EmojiTalkingHappy = forwardRef(({
  size = 24,
  color = 'currentColor',
  primaryColor,
  secondaryColor,
  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-iconoir animated-iconoir-emoji-talking-happy ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
