  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-iconoir animated-iconoir-cell-2x2 ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M21 3.6V12H12V3H20.4C20.7314 3 21 3.26863 21 3.6Z" stroke="currentColor" strokeWidth="1.5" className="ai-primary ai-anim-scale-pop ai-delay-0" style={{}} />
        <path d="M21 20.4V12H12V21H20.4C20.7314 21 21 20.7314 21 20.4Z" stroke="currentColor" strokeWidth="1.5" className="ai-secondary ai-anim-scale-pop ai-delay-1" style={{}} />
        <path d="M3 12V3.6C3 3.26863 3.26863 3 3.6 3H12V12H3Z" stroke="currentColor" strokeWidth="1.5" className="ai-secondary ai-anim-scale-pop ai-delay-2" style={{}} />
        <path d="M3 12V20.4C3 20.7314 3.26863 21 3.6 21H12V12H3Z" stroke="currentColor" strokeWidth="1.5" className="ai-secondary ai-anim-scale-pop ai-delay-3" style={{}} />
      </svg>
    </>
  );
});

Cell2x2.displayName = 'Cell2x2';
