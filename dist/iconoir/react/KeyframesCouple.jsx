...
const KeyframesCouple = forwardRef(({
  size = 24,
  color = 'currentColor',
  primaryColor,
  secondaryColor,
  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-iconoir animated-iconoir-keyframes-couple ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
