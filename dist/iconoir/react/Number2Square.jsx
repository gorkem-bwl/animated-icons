...
const Number2Square = forwardRef(({
  size = 24,
  color = 'currentColor',
  primaryColor,
  secondaryColor,
  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-iconoir animated-iconoir-number-2-square ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        ...
        <path d="M9.5 10.8V10.4C9.5 9.07452 10.5332 8 11.8077 8C13.0822 8 14.1154 9.07452 14.1154 10.4C14.1154 10.857 13.9926 11.2841 13.7794 11.6476C12.7289 13.4396 9.5 16 9.5 16H14.5" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-secondary ai-anim-scale-pop ai-delay-1" style={{}} />
      </svg>
    </>
  );
});

Number2Square.displayName = 'Number2Square';

export { Number2Square };
