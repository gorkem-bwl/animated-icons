  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-iconoir animated-iconoir-math-book ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M4 19V5C4 3.89543 4.89543 3 6 3H19.4C19.7314 3 20 3.26863 20 3.6V16.7143" stroke="currentColor" strokeLinecap="round" className="ai-primary ai-anim-fill ai-delay-0" style={{}} />
        <path d="M6 17L20 17" stroke="currentColor" strokeLinecap="round" className="ai-secondary ai-anim-page-turn ai-delay-1" style={{}} />
        <path d="M6 21L20 21" stroke="currentColor" strokeLinecap="round" className="ai-secondary ai-anim-page-turn ai-delay-2" style={{}} />
        <path d="M6 21C4.89543 21 4 20.1046 4 19C4 17.8954 4.89543 17 6 17" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-secondary ai-anim-page-turn ai-delay-3" style={{}} />
        <path d="M10 10H14" stroke="currentColor" strokeLinecap="round" className="ai-secondary ai-anim-page-turn ai-delay-4" style={{}} />
        <path d="M12 13.01L12.01 12.9989" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-secondary ai-anim-page-turn ai-delay-5" style={{}} />
        <path d="M12 7.01L12.01 6.99889" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-secondary ai-anim-page-turn ai-delay-6" style={{}} />
      </svg>
    </>
  );
});

MathBook.displayName = 'MathBook';
