  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-iconoir animated-iconoir-angle-tool ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M3 21L3 3L9 3V15L21 15V21H3Z" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-primary ai-anim-scale-pop ai-delay-0" style={{}} />
        <path d="M13 19V21" stroke="currentColor" strokeLinecap="round" className="ai-secondary ai-anim-fade ai-delay-1" style={{}} />
        <path d="M9 19V21" stroke="currentColor" strokeLinecap="round" className="ai-secondary ai-anim-fade ai-delay-2" style={{}} />
        <path d="M3 7H5" stroke="currentColor" strokeLinecap="round" className="ai-secondary ai-anim-fade ai-delay-3" style={{}} />
        <path d="M3 11H5" stroke="currentColor" strokeLinecap="round" className="ai-secondary ai-anim-fade ai-delay-4" style={{}} />
        <path d="M3 15H5" stroke="currentColor" strokeLinecap="round" className="ai-secondary ai-anim-fade ai-delay-5" style={{}} />
        <path d="M17 19V21" stroke="currentColor" strokeLinecap="round" className="ai-secondary ai-anim-fade ai-delay-6" style={{}} />
      </svg>
    </>
  );
});

AngleTool.displayName = 'AngleTool';
