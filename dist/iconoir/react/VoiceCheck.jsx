  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-iconoir animated-iconoir-voice-check ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        ...
        <path d="M16 6L16 15" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-secondary ai-anim-scale-pop ai-delay-4" style={{}} />
        <path d="M15.5 19.5L17.5 21.5L22.5 16.5" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-secondary ai-anim-scale-pop ai-delay-5" style={{}} />
      </svg>
    </>
  );
});

VoiceCheck.displayName = 'VoiceCheck';
