...
const ShortPantsPockets = forwardRef(({
  size = 24,
  color = 'currentColor',
  primaryColor,
  secondaryColor,
  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-iconoir animated-iconoir-short-pants-pockets ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        ...
        <path d="M4 9.5H5.5C6.60457 9.5 7.5 8.60457 7.5 7.5V5" stroke="currentColor" strokeWidth="1.5" className="ai-secondary ai-anim-fade ai-delay-1" style={{}} />
        <path d="M20.5 9.5H18.5C17.3954 9.5 16.5 8.60457 16.5 7.5V5" stroke="currentColor" strokeWidth="1.5" className="ai-secondary ai-anim-fade ai-delay-2" style={{}} />
      </svg>
    </>
  );
});

ShortPantsPockets.displayName = 'ShortPantsPockets';

export { ShortPantsPockets };
