  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-iconoir animated-iconoir-select-window ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M14 21H4C2.89543 21 2 20.1046 2 19V5C2 3.89543 2.89543 3 4 3H20C21.1046 3 22 3.89543 22 5V15" stroke="currentColor" strokeLinecap="round" className="ai-primary ai-anim-scale-pop ai-delay-0" style={{}} />
        ...
        <path fillRule="evenodd" clipRule="evenodd" d="M22.0822 18.3651C22.576 18.6689 22.5457 19.4082 22.0371 19.4658L19.4705 19.7568L18.3193 22.0691C18.0911 22.5273 17.386 22.3029 17.2695 21.735L16.0142 15.619C15.9157 15.139 16.3471 14.837 16.7644 15.0937L22.0822 18.3651Z" stroke="currentColor" className="ai-secondary ai-anim-scale-pop ai-delay-5" style={{}} />
      </svg>
    </>
  );
});

SelectWindow.displayName = 'SelectWindow';
