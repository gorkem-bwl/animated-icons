...
const DroneChargeHalf = forwardRef(({
  size = 24,
  color = 'currentColor',
  primaryColor,
  secondaryColor,
  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-iconoir animated-iconoir-drone-charge-half ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
...
DroneChargeHalf.displayName = 'DroneChargeHalf';

export { DroneChargeHalf };
