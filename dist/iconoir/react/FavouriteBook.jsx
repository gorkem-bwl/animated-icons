...
const FavouriteBook = forwardRef(({
  size = 24,
  color = 'currentColor',
  primaryColor,
  secondaryColor,
  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-iconoir animated-iconoir-favourite-book ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
...
FavouriteBook.displayName = 'FavouriteBook';
