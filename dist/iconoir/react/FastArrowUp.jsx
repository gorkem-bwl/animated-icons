  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-iconoir animated-iconoir-fast-arrow-up ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M6 11L12 5L18 11" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-primary ai-anim-nudge ai-delay-0" style={{ '--ai-tx': '0px', '--ai-ty': '-1px' }} />
        <path d="M6 19L12 13L18 19" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-secondary ai-anim-nudge ai-delay-1" style={{ '--ai-tx': '0px', '--ai-ty': '-2px' }} />
      </svg>
    </>
  );
});

FastArrowUp.displayName = 'FastArrowUp';
