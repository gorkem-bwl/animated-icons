  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-iconoir animated-iconoir-ecology-book ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        ...
        <path d="M10 14C10 14 10.9 10.8824 13 9" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-secondary ai-anim-page-turn ai-delay-1" style={{}} />
        <path d="M12.8022 12.4245L12.6677 12.4372C10.9758 12.5961 9.469 11.3541 9.30214 9.66298C9.13527 7.97187 10.3715 6.47208 12.0634 6.31311L15.049 6.03257C15.2406 6.01457 15.4111 6.15518 15.43 6.34663L15.6847 8.92756C15.8589 10.6929 14.5683 12.2586 12.8022 12.4245Z" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-secondary ai-anim-page-turn ai-delay-2" style={{}} />
        <path d="M6 17L20 17" stroke="currentColor" strokeLinecap="round" className="ai-secondary ai-anim-page-turn ai-delay-3" style={{}} />
        <path d="M6 21L20 21" stroke="currentColor" strokeLinecap="round" className="ai-secondary ai-anim-page-turn ai-delay-4" style={{}} />
        <path d="M6 21C4.89543 21 4 20.1046 4 19C4 17.8954 4.89543 17 6 17" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-secondary ai-anim-page-turn ai-delay-5" style={{}} />
      </svg>
    </>
  );
});

EcologyBook.displayName = 'EcologyBook';
