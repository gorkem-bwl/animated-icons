...
const LongArrowLeftDown = forwardRef(({
  size = 24,
  color = 'currentColor',
  primaryColor,
  secondaryColor,
  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-iconoir animated-iconoir-long-arrow-left-down ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M4.5 13.5L8 17L11.5 13.5" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-primary ai-anim-nudge ai-delay-0" style={{ '--ai-tx': '-1px', '--ai-ty': '1px' }} />
        <path d="M8 17V11C8 8.79086 9.79086 7 12 7H19" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="ai-secondary ai-anim-nudge ai-delay-1" style={{ '--ai-tx': '-2px', '--ai-ty': '2px' }} />
      </svg>
    </>
  );
});
