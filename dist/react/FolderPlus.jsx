  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-folder-plus ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M12 10v6" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M9 13h6" className="al-secondary al-anim-fade al-delay-1" style={{}} />
