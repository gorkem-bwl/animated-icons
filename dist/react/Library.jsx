...
const Library = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="m16 6 4 14" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M12 6v14" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M8 8v12" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M4 4v16" className="al-secondary al-anim-fade al-delay-3" style={{}} />
      </svg>
    </>
  );
});
