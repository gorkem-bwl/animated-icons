...
const ZodiacPisces = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M19 21a15 15 0 0 1 0-18" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M20 12H4" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M5 3a15 15 0 0 1 0 18" className="al-secondary al-anim-fade al-delay-2" style={{}} />
      </svg>
    </>
  );
});
