...
const ArrowDownRightFromSquare = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M21 11V5a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h6" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="m21 21-9-9" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M21 15v6h-6" className="al-secondary al-anim-fade al-delay-2" style={{}} />
      </svg>
    </>
  );
});
