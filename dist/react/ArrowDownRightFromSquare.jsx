...
const ArrowDownRightFromSquare = forwardRef(({
  size = 24,
  color = 'currentColor',
  primaryColor,
  secondaryColor,
  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-arrow-down-right-from-square ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M21 11V5a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h6" className="al-primary al-anim-scale-pop al-delay-0" style={{}} />
        <path d="m21 21-9-9" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
        <path d="M21 15v6h-6" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
      </svg>
    </>
  );
});

ArrowDownRightFromSquare.displayName = 'ArrowDownRightFromSquare';
