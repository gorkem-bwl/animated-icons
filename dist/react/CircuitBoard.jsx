  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-circuit-board ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        ...
        <path d="M11 9h4a2 2 0 0 0 2-2V3" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <circle cx="9" cy="9" r="2" className="al-primary al-anim-fade al-delay-2" style={{}} />
        <path d="M7 21v-4a2 2 0 0 1 2-2h4" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <circle cx="15" cy="15" r="2" className="al-primary al-anim-fade al-delay-4" style={{}} />
      </svg>
    </>
  );
});
