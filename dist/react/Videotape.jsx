  ...
  return (
    <>
      ...
      >
        ...
        <path d="M2 8h20" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <circle cx="8" cy="14" r="2" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M8 12h8" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <circle cx="16" cy="14" r="2" className="al-secondary al-anim-fade al-delay-4" style={{}} />
      </svg>
    </>
  );
});
