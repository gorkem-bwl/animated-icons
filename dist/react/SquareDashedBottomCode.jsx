...
const SquareDashedBottomCode = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M10 9.5 8 12l2 2.5" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M14 21h1" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="m14 9.5 2 2.5-2 2.5" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M5 21a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <path d="M9 21h1" className="al-secondary al-anim-fade al-delay-4" style={{}} />
      </svg>
    </>
  );
});
