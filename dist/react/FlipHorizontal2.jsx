...
const FlipHorizontal2 = forwardRef(({
  size = 24,
  color = 'currentColor',
  primaryColor,
  secondaryColor,
  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-flip-horizontal-2 ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="m3 7 5 5-5 5V7" className="al-primary al-anim-scale-pop al-delay-0" style={{}} />
        <path d="m21 7-5 5 5 5V7" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
