...
const UndoDot = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M21 17a9 9 0 0 0-15-6.7L3 13" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M3 7v6h6" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <circle cx="12" cy="17" r="1" className="al-secondary al-anim-fade al-delay-2" style={{}} />
      </svg>
    </>
  );
});
