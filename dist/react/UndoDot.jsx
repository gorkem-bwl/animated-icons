  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-undo-dot ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M21 17a9 9 0 0 0-15-6.7L3 13" className="al-primary al-anim-scale-pop al-delay-0" style={{}} />
        <path d="M3 7v6h6" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
        <circle cx="12" cy="17" r="1" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
      </svg>
    </>
  );
});
