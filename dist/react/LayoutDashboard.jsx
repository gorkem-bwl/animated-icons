...
const LayoutDashboard = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <rect width="7" height="9" x="3" y="3" rx="1" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <rect width="7" height="5" x="14" y="3" rx="1" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <rect width="7" height="9" x="14" y="12" rx="1" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <rect width="7" height="5" x="3" y="16" rx="1" className="al-secondary al-anim-fade al-delay-3" style={{}} />
      </svg>
    </>
  );
});
