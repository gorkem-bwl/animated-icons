  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-git-compare-arrows ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        ...
        <path d="M12 6h5a2 2 0 0 1 2 2v7" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
        <path d="m15 9-3-3 3-3" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
        <circle cx="19" cy="18" r="3" className="al-secondary al-anim-scale-pop al-delay-3" style={{}} />
        <path d="M12 18H7a2 2 0 0 1-2-2V9" className="al-secondary al-anim-scale-pop al-delay-4" style={{}} />
        <path d="m9 15 3 3-3 3" className="al-secondary al-anim-scale-pop al-delay-5" style={{}} />
      </svg>
    </>
  );
});
