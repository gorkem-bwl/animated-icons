...
const MonitorSpeaker = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M5.5 20H8" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M17 9h.01" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <rect width="10" height="16" x="12" y="4" rx="2" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M8 6H4a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2h4" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <circle cx="17" cy="15" r="1" className="al-secondary al-anim-fade al-delay-4" style={{}} />
      </svg>
    </>
  );
});
