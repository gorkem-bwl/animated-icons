  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-mars ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        ...
        <path d="m21 3-6.75 6.75" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
        <circle cx="10" cy="14" r="6" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
      </svg>
    </>
  );
});
