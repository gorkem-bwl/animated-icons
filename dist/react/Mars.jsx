  ...
  return (
    <>
      ...
      >
        ...
        <path d="m21 3-6.75 6.75" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <circle cx="10" cy="14" r="6" className="al-secondary al-anim-fade al-delay-2" style={{}} />
      </svg>
    </>
  );
});
