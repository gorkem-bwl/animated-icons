...
const Monitor = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <rect width="20" height="14" x="2" y="3" rx="2" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <line x1="8" x2="16" y1="21" y2="21" className="al-secondary al-anim-fill al-delay-1" style={{}} />
        <line x1="12" x2="12" y1="17" y2="21" className="al-secondary al-anim-fill al-delay-2" style={{}} />
      </svg>
    </>
  );
});
