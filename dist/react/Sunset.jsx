  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-sunset ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        ...
        <path d="m4.93 10.93 1.41 1.41" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M2 18h2" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M20 18h2" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <path d="m19.07 10.93-1.41 1.41" className="al-secondary al-anim-fade al-delay-4" style={{}} />
        <path d="M22 22H2" className="al-secondary al-anim-fade al-delay-5" style={{}} />
        <path d="m16 6-4 4-4-4" className="al-secondary al-anim-fade al-delay-6" style={{}} />
        <path d="M16 18a4 4 0 0 0-8 0" className="al-secondary al-anim-fade al-delay-7" style={{}} />
      </svg>
    </>
  );
});
