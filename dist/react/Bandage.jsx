  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-bandage ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M10 10.01h.01" className="al-primary al-anim-scale-pop al-delay-0" style={{}} />
        <path d="M10 14.01h.01" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
        <path d="M14 10.01h.01" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
        <path d="M14 14.01h.01" className="al-secondary al-anim-scale-pop al-delay-3" style={{}} />
        <path d="M18 6v12" className="al-secondary al-anim-scale-pop al-delay-4" style={{}} />
        <path d="M6 6v12" className="al-secondary al-anim-scale-pop al-delay-5" style={{}} />
        <rect x="2" y="6" width="20" height="12" rx="2" className="al-secondary al-anim-scale-pop al-delay-6" style={{}} />
      </svg>
    </>
  );
});
