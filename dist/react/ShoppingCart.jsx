  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-shopping-cart ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <circle cx="8" cy="21" r="1" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <circle cx="19" cy="21" r="1" className="al-secondary al-anim-fill al-delay-1" style={{}} />
        <path d="M2.05 2.05h2l2.66 12.42a2 2 0 0 0 2 1.58h9.78a2 2 0 0 0 1.95-1.57l1.65-7.43H5.12" className="al-secondary al-anim-shake al-delay-2" style={{}} />
      </svg>
    </>
  );
});
