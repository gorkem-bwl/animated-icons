...
const IndentIncrease = forwardRef(({
  size = 24,
  color = 'currentColor',
  primaryColor,
  secondaryColor,
  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-indent-increase ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M21 5H11" className="al-primary al-anim-scale-pop al-delay-0" style={{}} />
        <path d="M21 12H11" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
        <path d="M21 19H11" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
        <path d="m3 8 4 4-4 4" className="al-secondary al-anim-scale-pop al-delay-3" style={{}} />
      </svg>
    </>
  );
});
