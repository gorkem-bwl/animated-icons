...
const IndentIncrease = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M21 5H11" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M21 12H11" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M21 19H11" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="m3 8 4 4-4 4" className="al-secondary al-anim-fade al-delay-3" style={{}} />
      </svg>
    </>
  );
});
