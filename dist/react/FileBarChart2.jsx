...
const FileBarChart2 = forwardRef(({
  size = 24,
  color = 'currentColor',
  primaryColor,
  secondaryColor,
  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-file-bar-chart-2 ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        ...
        <path d="M8 18v-1" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
        <path d="M12 18v-6" className="al-secondary al-anim-scale-pop al-delay-3" style={{}} />
        <path d="M16 18v-3" className="al-secondary al-anim-scale-pop al-delay-4" style={{}} />
      </svg>
    </>
  );
});
