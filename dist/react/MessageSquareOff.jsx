...
const MessageSquareOff = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M19 19H6.828a2 2 0 0 0-1.414.586l-2.202 2.202A.7.7 0 0 1 2 21.286V5a2 2 0 0 1 1.184-1.826" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="m2 2 20 20" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M8.656 3H20a2 2 0 0 1 2 2v11.344" className="al-secondary al-anim-fade al-delay-2" style={{}} />
      </svg>
    </>
  );
});
