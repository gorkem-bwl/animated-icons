...
const ChartNoAxesGantt = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M6 5h12" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M4 12h10" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M12 19h8" className="al-secondary al-anim-fade al-delay-2" style={{}} />
      </svg>
    </>
  );
});
