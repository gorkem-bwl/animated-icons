...
const TabletSmartphone = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <rect width="10" height="14" x="3" y="8" rx="2" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M5 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v16a2 2 0 0 1-2 2h-2.4" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M8 18h.01" className="al-secondary al-anim-fade al-delay-2" style={{}} />
      </svg>
    </>
  );
});
