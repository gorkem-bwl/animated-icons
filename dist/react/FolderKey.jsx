...
const FolderKey = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M13 20H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h3.9a2 2 0 0 1 1.69.9l.81 1.2a2 2 0 0 0 1.67.9H20a2 2 0 0 1 2 2v1.36" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M19 12v6" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M19 14h2" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <circle cx="19" cy="20" r="2" className="al-secondary al-anim-fade al-delay-3" style={{}} />
      </svg>
    </>
  );
});
