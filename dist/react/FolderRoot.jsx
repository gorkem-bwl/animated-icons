  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-folder-root ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        ...
        <circle cx="12" cy="13" r="2" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
        <path d="M12 15v5" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
      </svg>
    </>
  );
});
