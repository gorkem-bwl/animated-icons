  ...
  return (
    <>
      ...
      >
        ...
        <circle cx="19" cy="16" r="2" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <path d="M20 10c-2 2-3 3.5-3 6" className="al-secondary al-anim-fade al-delay-4" style={{}} />
      </svg>
    </>
  );
});
