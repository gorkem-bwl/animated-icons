  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-stop-circle ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        ...
        <rect x="9" y="9" width="6" height="6" rx="1" className="al-secondary al-anim-fill al-delay-1" style={{}} />
      </svg>
    </>
  );
});
