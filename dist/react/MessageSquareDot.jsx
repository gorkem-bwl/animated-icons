...
const MessageSquareDot = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M12.7 3H4a2 2 0 0 0-2 2v16.286a.71.71 0 0 0 1.212.502l2.202-2.202A2 2 0 0 1 6.828 19H20a2 2 0 0 0 2-2v-4.7" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <circle cx="19" cy="6" r="3" className="al-secondary al-anim-fade al-delay-1" style={{}} />
      </svg>
    </>
  );
});
