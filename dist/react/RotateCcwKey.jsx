...
const RotateCcwKey = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M12 7v6" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M12 9h2" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M3 12a9 9 0 1 0 9-9 9.74 9.74 0 0 0-6.74 2.74L3 8" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M3 3v5h5" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <circle cx="12" cy="15" r="2" className="al-secondary al-anim-fade al-delay-4" style={{}} />
      </svg>
    </>
  );
});
