...
const ClockArrowUp = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M12 6v6l1.56.78" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M13.227 21.925a10 10 0 1 1 8.767-9.588" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="m14 18 4-4 4 4" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M18 22v-8" className="al-secondary al-anim-fade al-delay-3" style={{}} />
      </svg>
    </>
  );
});
