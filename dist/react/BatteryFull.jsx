  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-battery-full ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M10 10v4" className="al-primary al-anim-scale-pop al-delay-0" style={{}} />
        <path d="M14 10v4" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
        <path d="M22 14v-4" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
        <path d="M6 10v4" className="al-secondary al-anim-scale-pop al-delay-3" style={{}} />
        <rect x="2" y="6" width="16" height="12" rx="2" className="al-secondary al-anim-scale-pop al-delay-4" style={{}} />
      </svg>
    </>
  );
});
