  ...
  return (
    <>
      ...
      >
        ...
        <path d="M8 12h4" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M10 16V9.5a2.5 2.5 0 0 1 5 0" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M8 16h7" className="al-secondary al-anim-fade al-delay-3" style={{}} />
      </svg>
    </>
  );
});
