...
const BatteryLow = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M22 14v-4" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M6 14v-4" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <rect x="2" y="6" width="16" height="12" rx="2" className="al-secondary al-anim-fade al-delay-2" style={{}} />
      </svg>
    </>
  );
});
