  ...
  return (
    <>
      ...
      >
        ...
        <path d="M8 18v-2" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M12 18v-4" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <path d="M16 18v-6" className="al-secondary al-anim-fade al-delay-4" style={{}} />
      </svg>
    </>
  );
});
