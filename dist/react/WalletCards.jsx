  ...
  return (
    <>
      ...
      >
        ...
        <path d="M3 9a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M3 11h3c.8 0 1.6.3 2.1.9l1.1.9c1.6 1.6 4.1 1.6 5.7 0l1.1-.9c.5-.5 1.3-.9 2.1-.9H21" className="al-secondary al-anim-fade al-delay-2" style={{}} />
      </svg>
    </>
  );
});
