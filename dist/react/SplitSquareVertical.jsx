...
const SplitSquareVertical = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M5 8V5c0-1 1-2 2-2h10c1 0 2 1 2 2v3" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M19 16v3c0 1-1 2-2 2H7c-1 0-2-1-2-2v-3" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <line x1="4" x2="20" y1="12" y2="12" className="al-secondary al-anim-fade al-delay-2" style={{}} />
      </svg>
    </>
  );
});
