...
const CalendarOff = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M4.2 4.2A2 2 0 0 0 3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 1.82-1.18" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M21 15.5V6a2 2 0 0 0-2-2H9.5" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M16 2v4" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M3 10h7" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <path d="M21 10h-5.5" className="al-secondary al-anim-fade al-delay-4" style={{}} />
