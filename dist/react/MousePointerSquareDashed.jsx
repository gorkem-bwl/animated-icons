...
const MousePointerSquareDashed = forwardRef(({
  size = 24,
  color = 'currentColor',
  primaryColor,
  secondaryColor,
  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-mouse-pointer-square-dashed ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
...
MousePointerSquareDashed.displayName = 'MousePointerSquareDashed';
