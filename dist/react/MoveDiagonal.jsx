  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-move-diagonal ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M11 19H5v-6" className="al-primary al-anim-nudge al-delay-0" style={{ '--al-tx': '0px', '--al-ty': '0px' }} />
        <path d="M13 5h6v6" className="al-secondary al-anim-nudge al-delay-1" style={{ '--al-tx': '0px', '--al-ty': '0px' }} />
        <path d="M19 5 5 19" className="al-secondary al-anim-nudge al-delay-2" style={{ '--al-tx': '0px', '--al-ty': '0px' }} />
      </svg>
    </>
  );
});
