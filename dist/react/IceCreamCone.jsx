...
const IceCreamCone = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="m7 11 4.08 10.35a1 1 0 0 0 1.84 0L17 11" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M17 7A5 5 0 0 0 7 7" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M17 7a2 2 0 0 1 0 4H7a2 2 0 0 1 0-4" className="al-secondary al-anim-fade al-delay-2" style={{}} />
      </svg>
    </>
  );
});
