...
const PilcrowRight = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M10 3v11" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M10 9H7a1 1 0 0 1 0-6h8" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M14 3v11" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="m18 14 4 4H2" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <path d="m22 18-4 4" className="al-secondary al-anim-fade al-delay-4" style={{}} />
      </svg>
    </>
  );
});
