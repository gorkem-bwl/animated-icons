  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-wifi ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        ...
        <path d="M2 8.82a15 15 0 0 1 20 0" className="al-secondary al-anim-pulse-element al-delay-1" style={{}} />
        <path d="M5 12.859a10 10 0 0 1 14 0" className="al-secondary al-anim-pulse-element al-delay-2" style={{}} />
        <path d="M8.5 16.429a5 5 0 0 1 7 0" className="al-secondary al-anim-pulse-element al-delay-3" style={{}} />
      </svg>
    </>
  );
});
