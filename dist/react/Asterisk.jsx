...
const Asterisk = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M12 6v12" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M17.196 9 6.804 15" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="m6.804 9 10.392 6" className="al-secondary al-anim-fade al-delay-2" style={{}} />
      </svg>
    </>
  );
});
