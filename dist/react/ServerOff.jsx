...
const ServerOff = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M7 2h13a2 2 0 0 1 2 2v4a2 2 0 0 1-2 2h-5" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M10 10 2.5 2.5C2 2 2 2.5 2 5v3a2 2 0 0 0 2 2h6z" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M22 17v-1a2 2 0 0 0-2-2h-1" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M4 14a2 2 0 0 0-2 2v4a2 2 0 0 0 2 2h16.5l1-.5.5.5-8-8H4z" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <path d="M6 18h.01" className="al-secondary al-anim-fade al-delay-4" style={{}} />
