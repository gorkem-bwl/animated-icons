  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-ellipse ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <ellipse cx="12" cy="12" rx="10" ry="6" className="al-primary al-anim-scale-pop al-delay-0" style={{}} />
      </svg>
    </>
  );
});
