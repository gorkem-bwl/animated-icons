  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-arrow-down-0-1 ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        ...
        <rect x="15" y="4" width="4" height="6" ry="2" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
        <path d="M17 20v-6h-2" className="al-secondary al-anim-scale-pop al-delay-3" style={{}} />
        <path d="M15 20h4" className="al-secondary al-anim-scale-pop al-delay-4" style={{}} />
      </svg>
    </>
  );
});
