  ...
  return (
    <>
      ...
      >
        ...
        <rect x="15" y="4" width="4" height="6" ry="2" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M17 20v-6h-2" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <path d="M15 20h4" className="al-secondary al-anim-fade al-delay-4" style={{}} />
      </svg>
    </>
  );
});
