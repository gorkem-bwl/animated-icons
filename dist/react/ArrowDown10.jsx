  ...
  return (
    <>
      ...
      >
        ...
        <path d="M17 10V4h-2" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M15 10h4" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <rect x="15" y="14" width="4" height="6" ry="2" className="al-secondary al-anim-fade al-delay-4" style={{}} />
      </svg>
    </>
  );
});
