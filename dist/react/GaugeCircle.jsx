...
const GaugeCircle = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M15.6 2.7a10 10 0 1 0 5.7 5.7" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <circle cx="12" cy="12" r="2" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M13.4 10.6 19 5" className="al-secondary al-anim-fade al-delay-2" style={{}} />
      </svg>
    </>
  );
});
