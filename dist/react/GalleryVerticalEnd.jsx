...
const GalleryVerticalEnd = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M7 2h10" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M5 6h14" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <rect width="18" height="12" x="3" y="10" rx="2" className="al-secondary al-anim-fade al-delay-2" style={{}} />
      </svg>
    </>
  );
});
