  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-alert-triangle ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M12 9v4" className="al-secondary al-anim-pulse-element al-delay-1" style={{}} />
        <path d="M12 17h.01" className="al-secondary al-anim-pulse-element al-delay-2" style={{}} />
      </svg>
    </>
  );
});
