...
const PanelLeftInactive = forwardRef(({
  size = 24,
  color = 'currentColor',
  primaryColor,
  secondaryColor,
  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-panel-left-inactive ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        ...
        <path d="M9 14v1" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
        <path d="M9 19v2" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
        <path d="M9 3v2" className="al-secondary al-anim-scale-pop al-delay-3" style={{}} />
        <path d="M9 9v1" className="al-secondary al-anim-scale-pop al-delay-4" style={{}} />
      </svg>
    </>
  );
});

PanelLeftInactive.displayName = 'PanelLeftInactive';
