...
const ChartNoAxesColumnDecreasing = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M5 21V3" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M12 21V9" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M19 21v-6" className="al-secondary al-anim-fade al-delay-2" style={{}} />
      </svg>
    </>
  );
});
