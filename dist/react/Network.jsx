...
const Network = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <rect x="16" y="16" width="6" height="6" rx="1" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <rect x="2" y="16" width="6" height="6" rx="1" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <rect x="9" y="2" width="6" height="6" rx="1" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M5 16v-3a1 1 0 0 1 1-1h12a1 1 0 0 1 1 1v3" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <path d="M12 12V8" className="al-secondary al-anim-fade al-delay-4" style={{}} />
      </svg>
    </>
  );
});
