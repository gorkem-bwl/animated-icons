...
const RockingChair = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="m15 13 3.708 7.416" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M3 19a15 15 0 0 0 18 0" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="m3 2 3.21 9.633A2 2 0 0 0 8.109 13H18" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="m9 13-3.708 7.416" className="al-secondary al-anim-fade al-delay-3" style={{}} />
      </svg>
    </>
  );
});
