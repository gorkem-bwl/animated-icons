  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-decimals-arrow-left ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="m13 21-3-3 3-3" className="al-primary al-anim-scale-pop al-delay-0" style={{}} />
        <path d="M20 18H10" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
        <path d="M3 11h.01" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
        <rect x="6" y="3" width="5" height="8" rx="2.5" className="al-secondary al-anim-scale-pop al-delay-3" style={{}} />
      </svg>
    </>
  );
});
