  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-git-commit-horizontal ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        ...
        <line x1="3" x2="9" y1="12" y2="12" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
        <line x1="15" x2="21" y1="12" y2="12" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
      </svg>
    </>
  );
});
