  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-server-cog ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        ...
        <path d="M13.148 14.772a3 3 0 1 0-2.296-5.544l-.383-.923" className="al-secondary al-anim-gear al-delay-1" style={{ '--al-rotation': '90deg' }} />
        <path d="m13.148 9.228.383-.923" className="al-secondary al-anim-gear al-delay-2" style={{ '--al-rotation': '90deg' }} />
        <path d="m13.53 15.696-.382-.924a3 3 0 1 1-2.296-5.544" className="al-secondary al-anim-gear al-delay-3" style={{ '--al-rotation': '90deg' }} />
        ...
        <path d="M4.5 10H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v4a2 2 0 0 1-2 2h-.5" className="al-secondary al-anim-gear al-delay-6" style={{ '--al-rotation': '90deg' }} />
        <path d="M4.5 14H4a2 2 0 0 0-2 2v4a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-4a2 2 0 0 0-2-2h-.5" className="al-secondary al-anim-gear al-delay-7" style={{ '--al-rotation': '90deg' }} />
        <path d="M6 18h.01" className="al-secondary al-anim-gear al-delay-7" style={{ '--al-rotation': '90deg' }} />
        <path d="M6 6h.01" className="al-secondary al-anim-gear al-delay-7" style={{ '--al-rotation': '90deg' }} />
