  ...
  return (
    <>
      ...
      >
        ...
        <path d="M5 10v5a7 7 0 0 0 14 0V9c0-3.527-2.608-6.515-6-7" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <circle cx="7" cy="4" r="2" className="al-secondary al-anim-fade al-delay-2" style={{}} />
      </svg>
    </>
  );
});
