  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-calendar-clock ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        ...
        <path d="M21 7.5V6a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h3.5" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
        <path d="M3 10h5" className="al-secondary al-anim-scale-pop al-delay-3" style={{}} />
        <path d="M8 2v4" className="al-secondary al-anim-scale-pop al-delay-4" style={{}} />
        <circle cx="16" cy="16" r="6" className="al-secondary al-anim-scale-pop al-delay-5" style={{}} />
      </svg>
    </>
  );
});
