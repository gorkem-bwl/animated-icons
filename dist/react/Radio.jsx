...
const Radio = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M16.247 7.761a6 6 0 0 1 0 8.478" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M19.075 4.933a10 10 0 0 1 0 14.134" className="al-secondary al-anim-fill al-delay-1" style={{}} />
        <path d="M4.925 19.067a10 10 0 0 1 0-14.134" className="al-secondary al-anim-fill al-delay-2" style={{}} />
        <path d="M7.753 16.239a6 6 0 0 1 0-8.478" className="al-secondary al-anim-fill al-delay-3" style={{}} />
        <circle cx="12" cy="12" r="2" className="al-secondary al-anim-fill al-delay-4" style={{}} />
      </svg>
    </>
  );
});
