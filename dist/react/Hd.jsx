...
const Hd = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M10 12H6" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M10 15V9" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M14 14.5a.5.5 0 0 0 .5.5h1a2.5 2.5 0 0 0 2.5-2.5v-1A2.5 2.5 0 0 0 15.5 9h-1a.5.5 0 0 0-.5.5z" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M6 15V9" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <rect x="2" y="5" width="20" height="14" rx="2" className="al-secondary al-anim-fade al-delay-4" style={{}} />
      </svg>
    </>
  );
});
