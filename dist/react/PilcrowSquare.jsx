  ...
  return (
    <>
      ...
      >
        ...
        <path d="M12 12H9.5a2.5 2.5 0 0 1 0-5H17" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M12 7v10" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M16 7v10" className="al-secondary al-anim-fade al-delay-3" style={{}} />
      </svg>
    </>
  );
});
