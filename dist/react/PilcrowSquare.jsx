...
const PilcrowSquare = forwardRef(({
  size = 24,
  color = 'currentColor',
  primaryColor,
  secondaryColor,
  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-pilcrow-square ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        ...
        <path d="M12 12H9.5a2.5 2.5 0 0 1 0-5H17" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
        <path d="M12 7v10" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
        <path d="M16 7v10" className="al-secondary al-anim-scale-pop al-delay-3" style={{}} />
      </svg>
    </>
  );
});
