...
const Mouse = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <rect x="5" y="2" width="14" height="20" rx="7" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M12 6v4" className="al-secondary al-anim-fade al-delay-1" style={{}} />
      </svg>
    </>
  );
});
