...
const Rat = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M13 22H4a2 2 0 0 1 0-4h12" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M13.236 18a3 3 0 0 0-2.2-5" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M16 9h.01" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M16.82 3.94a3 3 0 1 1 3.237 4.868l1.815 2.587a1.5 1.5 0 0 1-1.5 2.1l-2.872-.453a3 3 0 0 0-3.5 3" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <path d="M17 4.988a3 3 0 1 0-5.2 2.052A7 7 0 0 0 4 14.015 4 4 0 0 0 8 18" className="al-secondary al-anim-fade al-delay-4" style={{}} />
      </svg>
    </>
  );
});
