...
const AlignVerticalDistributeCenter = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M22 17h-3" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M22 7h-5" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M5 17H2" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M7 7H2" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <rect x="5" y="14" width="14" height="6" rx="2" className="al-secondary al-anim-fade al-delay-4" style={{}} />
        <rect x="7" y="4" width="10" height="6" rx="2" className="al-secondary al-anim-fade al-delay-5" style={{}} />
      </svg>
    </>
  );
});
