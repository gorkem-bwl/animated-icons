  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-bus ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M8 6v6" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M15 6v6" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M2 12h19.6" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M18 18h3s.5-1.7.8-2.8c.1-.4.2-.8.2-1.2 0-.4-.1-.8-.2-1.2l-1.4-5C20.1 6.8 19.1 6 18 6H4a2 2 0 0 0-2 2v10h3" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <circle cx="7" cy="18" r="2" className="al-secondary al-anim-fade al-delay-4" style={{}} />
        <path d="M9 18h5" className="al-secondary al-anim-fade al-delay-5" style={{}} />
        <circle cx="16" cy="18" r="2" className="al-secondary al-anim-fade al-delay-6" style={{}} />
      </svg>
    </>
  );
});
