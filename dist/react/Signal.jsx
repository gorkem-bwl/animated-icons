  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-signal ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M2 20h.01" className="al-primary al-anim-pulse-element al-delay-0" style={{}} />
        <path d="M7 20v-4" className="al-secondary al-anim-pulse-element al-delay-1" style={{}} />
        <path d="M12 20v-8" className="al-secondary al-anim-pulse-element al-delay-2" style={{}} />
        <path d="M17 20V8" className="al-secondary al-anim-pulse-element al-delay-3" style={{}} />
        <path d="M22 4v16" className="al-secondary al-anim-pulse-element al-delay-4" style={{}} />
      </svg>
    </>
  );
});
