  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-copy-x ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <line x1="12" x2="18" y1="12" y2="18" className="al-primary al-anim-scale-pop al-delay-0" style={{}} />
        <line x1="12" x2="18" y1="18" y2="12" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
