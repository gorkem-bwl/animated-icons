...
const CopyX = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <line x1="12" x2="18" y1="12" y2="18" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <line x1="12" x2="18" y1="18" y2="12" className="al-secondary al-anim-fade al-delay-1" style={{}} />
