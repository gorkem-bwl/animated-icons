...
const WashingMachine = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M3 6h3" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M17 6h.01" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <rect width="18" height="20" x="3" y="2" rx="2" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <circle cx="12" cy="13" r="5" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <path d="M12 18a2.5 2.5 0 0 0 0-5 2.5 2.5 0 0 1 0-5" className="al-secondary al-anim-fade al-delay-4" style={{}} />
      </svg>
    </>
  );
});
