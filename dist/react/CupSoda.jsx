  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-cup-soda ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="m6 8 1.75 12.28a2 2 0 0 0 2 1.72h4.54a2 2 0 0 0 2-1.72L18 8" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M5 8h14" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M7 15a6.47 6.47 0 0 1 5 0 6.47 6.47 0 0 0 5 0" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="m12 8 1-6h2" className="al-secondary al-anim-fade al-delay-3" style={{}} />
      </svg>
    </>
  );
});
