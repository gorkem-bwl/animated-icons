...
const User2 = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <circle cx="12" cy="8" r="5" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M20 21a8 8 0 0 0-16 0" className="al-secondary al-anim-fade al-delay-1" style={{}} />
      </svg>
    </>
  );
});
