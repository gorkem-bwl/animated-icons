...
const SquareGanttChart = forwardRef(({
  size = 24,
  color = 'currentColor',
  primaryColor,
  secondaryColor,
  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-square-gantt-chart ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        ...
        <path d="M9 8h7" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
        <path d="M8 12h6" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
        <path d="M11 16h5" className="al-secondary al-anim-scale-pop al-delay-3" style={{}} />
      </svg>
    </>
  );
});
