  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-cloud-sun ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M12 2v2" className="al-primary al-anim-gear al-delay-0" style={{ '--al-rotation': '45deg' }} />
        <path d="m4.93 4.93 1.41 1.41" className="al-secondary al-anim-fade al-delay-1" style={{ '--al-rotation': '45deg' }} />
        <path d="M20 12h2" className="al-secondary al-anim-fade al-delay-2" style={{ '--al-rotation': '45deg' }} />
        <path d="m19.07 4.93-1.41 1.41" className="al-secondary al-anim-fade al-delay-3" style={{ '--al-rotation': '45deg' }} />
        <path d="M15.947 12.65a4 4 0 0 0-5.925-4.128" className="al-secondary al-anim-fade al-delay-4" style={{ '--al-rotation': '45deg' }} />
        <path d="M13 22H7a5 5 0 1 1 4.9-6H13a3 3 0 0 1 0 6Z" className="al-secondary al-anim-fade al-delay-5" style={{ '--al-rotation': '45deg' }} />
      </svg>
    </>
  );
});
