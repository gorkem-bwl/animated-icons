  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-user-circle ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        ...
        <circle cx="12" cy="10" r="3" className="al-secondary al-anim-fill al-delay-1" style={{}} />
        <path d="M7 20.662V19a2 2 0 0 1 2-2h6a2 2 0 0 1 2 2v1.662" className="al-secondary al-anim-fade al-delay-2" style={{}} />
      </svg>
    </>
  );
});
