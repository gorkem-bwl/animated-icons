...
const FlaskRound = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M10 2v6.292a7 7 0 1 0 4 0V2" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M5 15h14" className="al-secondary al-anim-fade al-delay-1" style={{}} />
