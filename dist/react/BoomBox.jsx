...
const BoomBox = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M4 9V5a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v4" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M8 8v1" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M12 8v1" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M16 8v1" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <rect width="20" height="12" x="2" y="9" rx="2" className="al-secondary al-anim-fade al-delay-4" style={{}} />
        <circle cx="8" cy="15" r="2" className="al-secondary al-anim-fade al-delay-5" style={{}} />
        <circle cx="16" cy="15" r="2" className="al-secondary al-anim-fade al-delay-6" style={{}} />
      </svg>
    </>
  );
});
