  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-check-check ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M18 6 7 17l-5-5" className="al-primary al-anim-scale-pop al-delay-0" style={{}} />
        <path d="m22 10-7.5 7.5L13 16" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
      </svg>
    </>
  );
});
