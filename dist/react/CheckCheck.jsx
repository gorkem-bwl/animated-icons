...
const CheckCheck = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M18 6 7 17l-5-5" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="m22 10-7.5 7.5L13 16" className="al-secondary al-anim-fade al-delay-1" style={{}} />
      </svg>
    </>
  );
});
