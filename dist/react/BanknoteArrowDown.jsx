  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-banknote-arrow-down ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M12 18H4a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5" className="al-primary al-anim-scale-pop al-delay-0" style={{}} />
        <path d="m16 19 3 3 3-3" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
        <path d="M18 12h.01" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
        <path d="M19 16v6" className="al-secondary al-anim-scale-pop al-delay-3" style={{}} />
        <path d="M6 12h.01" className="al-secondary al-anim-scale-pop al-delay-4" style={{}} />
        <circle cx="12" cy="12" r="2" className="al-secondary al-anim-scale-pop al-delay-5" style={{}} />
      </svg>
    </>
  );
});
