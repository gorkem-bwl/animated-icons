  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-git-compare ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        ...
        <path d="M13 6h3a2 2 0 0 1 2 2v7" className="al-primary al-anim-fade al-delay-2" style={{}} />
        <path d="M11 18H8a2 2 0 0 1-2-2V9" className="al-secondary al-anim-fade al-delay-3" style={{}} />
      </svg>
    </>
  );
});
