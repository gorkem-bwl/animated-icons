...
const CornerRightDown = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="m10 15 5 5 5-5" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M4 4h7a4 4 0 0 1 4 4v12" className="al-secondary al-anim-fade al-delay-1" style={{}} />
      </svg>
    </>
  );
});
