...
const Shredder = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M4 13V4a2 2 0 0 1 2-2h8a2.4 2.4 0 0 1 1.706.706l3.588 3.588A2.4 2.4 0 0 1 20 8v5" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M14 2v5a1 1 0 0 0 1 1h5" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M10 22v-5" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M14 19v-2" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <path d="M18 20v-3" className="al-secondary al-anim-fade al-delay-4" style={{}} />
        <path d="M2 13h20" className="al-secondary al-anim-fade al-delay-5" style={{}} />
        <path d="M6 20v-3" className="al-secondary al-anim-fade al-delay-6" style={{}} />
      </svg>
    </>
  );
});
