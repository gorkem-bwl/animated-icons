  ...
  return (
    <>
      ...
      >
        ...
        <path d="M16 12h.01" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="m17 7 5 5-5 5" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="m7 7-5 5 5 5" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <path d="M8 12h.01" className="al-secondary al-anim-fade al-delay-4" style={{}} />
      </svg>
    </>
  );
});
