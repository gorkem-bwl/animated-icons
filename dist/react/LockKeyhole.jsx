  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-lock-keyhole ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        ...
        <rect x="3" y="10" width="18" height="12" rx="2" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M7 10V7a5 5 0 0 1 10 0v3" className="al-secondary al-anim-fade al-delay-2" style={{}} />
      </svg>
    </>
  );
});
