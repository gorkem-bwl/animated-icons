...
const UnlockKeyhole = forwardRef(({
  size = 24,
  color = 'currentColor',
  primaryColor,
  secondaryColor,
  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-unlock-keyhole ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <circle cx="12" cy="16" r="1" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <rect width="18" height="12" x="3" y="10" rx="2" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M7 10V7a5 5 0 0 1 9.33-2.5" className="al-secondary al-anim-fade al-delay-2" style={{}} />
      </svg>
    </>
  );
});
