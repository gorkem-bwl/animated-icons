...
const Joystick = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M21 17a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v2a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-2Z" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M6 15v-2" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M12 15V9" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <circle cx="12" cy="6" r="3" className="al-secondary al-anim-fade al-delay-3" style={{}} />
      </svg>
    </>
  );
});
