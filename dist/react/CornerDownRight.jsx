  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-corner-down-right ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="m15 10 5 5-5 5" className="al-primary al-anim-nudge al-delay-0" style={{ '--al-tx': '1px', '--al-ty': '1px' }} />
        <path d="M4 4v7a4 4 0 0 0 4 4h12" className="al-secondary al-anim-nudge al-delay-1" style={{ '--al-tx': '2px', '--al-ty': '2px' }} />
      </svg>
    </>
  );
});
