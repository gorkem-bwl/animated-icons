  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-lock ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        ...
        <path d="M7 11V7a5 5 0 0 1 10 0v4" className="al-secondary al-anim-handle-lift al-delay-1" style={{}} />
      </svg>
    </>
  );
});
