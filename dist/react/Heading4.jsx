...
const Heading4 = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M12 18V6" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M17 10v3a1 1 0 0 0 1 1h3" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M21 10v8" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M4 12h8" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <path d="M4 18V6" className="al-secondary al-anim-fade al-delay-4" style={{}} />
      </svg>
    </>
  );
});
