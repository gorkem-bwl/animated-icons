  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-heading-4 ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M12 18V6" className="al-primary al-anim-scale-pop al-delay-0" style={{}} />
        <path d="M17 10v3a1 1 0 0 0 1 1h3" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
        <path d="M21 10v8" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
        <path d="M4 12h8" className="al-secondary al-anim-scale-pop al-delay-3" style={{}} />
        <path d="M4 18V6" className="al-secondary al-anim-scale-pop al-delay-4" style={{}} />
      </svg>
    </>
  );
});
