  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-align-vertical-space-between ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <rect width="14" height="6" x="5" y="15" rx="2" className="al-primary al-anim-scale-pop al-delay-0" style={{}} />
        <rect width="10" height="6" x="7" y="3" rx="2" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
        <path d="M2 21h20" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
        <path d="M2 3h20" className="al-secondary al-anim-scale-pop al-delay-3" style={{}} />
      </svg>
    </>
  );
});
