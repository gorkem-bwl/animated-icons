  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-keyboard ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M10 8h.01" className="al-primary al-anim-scale-pop al-delay-0" style={{}} />
        <path d="M12 12h.01" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
        <path d="M14 8h.01" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
        <path d="M16 12h.01" className="al-secondary al-anim-scale-pop al-delay-3" style={{}} />
        <path d="M18 8h.01" className="al-secondary al-anim-scale-pop al-delay-4" style={{}} />
        <path d="M6 8h.01" className="al-secondary al-anim-scale-pop al-delay-5" style={{}} />
        <path d="M7 16h10" className="al-secondary al-anim-scale-pop al-delay-6" style={{}} />
        <path d="M8 12h.01" className="al-secondary al-anim-scale-pop al-delay-7" style={{}} />
        <rect width="20" height="16" x="2" y="4" rx="2" className="al-secondary al-anim-scale-pop al-delay-7" style={{}} />
      </svg>
    </>
  );
});
