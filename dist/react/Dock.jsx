...
const Dock = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M2 8h20" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <rect width="20" height="16" x="2" y="4" rx="2" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M6 16h12" className="al-secondary al-anim-fade al-delay-2" style={{}} />
      </svg>
    </>
  );
});
