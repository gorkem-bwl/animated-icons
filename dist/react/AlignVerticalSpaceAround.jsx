...
const AlignVerticalSpaceAround = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <rect width="10" height="6" x="7" y="9" rx="2" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M22 20H2" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M22 4H2" className="al-secondary al-anim-fade al-delay-2" style={{}} />
      </svg>
    </>
  );
});
