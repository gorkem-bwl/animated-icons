  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-align-vertical-space-around ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <rect width="10" height="6" x="7" y="9" rx="2" className="al-primary al-anim-scale-pop al-delay-0" style={{}} />
        <path d="M22 20H2" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
        <path d="M22 4H2" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
      </svg>
    </>
  );
});
