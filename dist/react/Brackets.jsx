...
const Brackets = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M16 3h3a1 1 0 0 1 1 1v16a1 1 0 0 1-1 1h-3" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M8 21H5a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h3" className="al-secondary al-anim-fade al-delay-1" style={{}} />
      </svg>
    </>
  );
});
