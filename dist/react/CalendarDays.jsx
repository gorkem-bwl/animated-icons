  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-calendar-days ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        ...
        <rect width="18" height="18" x="3" y="4" rx="2" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
        <path d="M3 10h18" className="al-secondary al-anim-scale-pop al-delay-3" style={{}} />
        <path d="M8 14h.01" className="al-secondary al-anim-scale-pop al-delay-4" style={{}} />
        <path d="M12 14h.01" className="al-secondary al-anim-scale-pop al-delay-5" style={{}} />
        <path d="M16 14h.01" className="al-secondary al-anim-scale-pop al-delay-6" style={{}} />
        <path d="M8 18h.01" className="al-secondary al-anim-scale-pop al-delay-7" style={{}} />
        <path d="M12 18h.01" className="al-secondary al-anim-scale-pop al-delay-7" style={{}} />
        <path d="M16 18h.01" className="al-secondary al-anim-scale-pop al-delay-7" style={{}} />
      </svg>
    </>
  );
});
