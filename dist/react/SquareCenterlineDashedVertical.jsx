...
const SquareCenterlineDashedVertical = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M21 8V5a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v3" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M21 16v3a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-3" className="al-secondary al-anim-fade al-delay-1" style={{}} />
