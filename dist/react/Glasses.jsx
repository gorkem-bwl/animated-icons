...
const Glasses = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <circle cx="6" cy="15" r="4" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <circle cx="18" cy="15" r="4" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M14 15a2 2 0 0 0-2-2 2 2 0 0 0-2 2" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M2.5 13 5 7c.7-1.3 1.4-2 3-2" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <path d="M21.5 13 19 7c-.7-1.3-1.5-2-3-2" className="al-secondary al-anim-fade al-delay-4" style={{}} />
      </svg>
    </>
  );
});
