...
const ColumnsSettings = forwardRef(({
  size = 24,
  color = 'currentColor',
  primaryColor,
  secondaryColor,
  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-columns-settings ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
...
ColumnsSettings.displayName = 'ColumnsSettings';
