  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-more-horizontal ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        ...
        <circle cx="19" cy="12" r="1" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
        <circle cx="5" cy="12" r="1" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
      </svg>
    </>
  );
});
