...
const FolderOutput = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M2 7.5V5a2 2 0 0 1 2-2h3.9a2 2 0 0 1 1.69.9l.81 1.2a2 2 0 0 0 1.67.9H20a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2H4a2 2 0 0 1-2-1.5" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M2 13h10" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="m5 10-3 3 3 3" className="al-secondary al-anim-fade al-delay-2" style={{}} />
      </svg>
    </>
  );
});
