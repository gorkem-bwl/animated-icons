  ...
  return (
    <>
      ...
      >
        ...
        <path d="M14 15h1" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M19 15h2" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M3 15h2" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <path d="M9 15h1" className="al-secondary al-anim-fade al-delay-4" style={{}} />
      </svg>
    </>
  );
});
