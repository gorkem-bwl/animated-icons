...
const PanelBottomInactive = forwardRef(({
  size = 24,
  color = 'currentColor',
  primaryColor,
  secondaryColor,
  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-panel-bottom-inactive ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        ...
        <path d="M14 15h1" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
        <path d="M19 15h2" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
        <path d="M3 15h2" className="al-secondary al-anim-scale-pop al-delay-3" style={{}} />
        <path d="M9 15h1" className="al-secondary al-anim-scale-pop al-delay-4" style={{}} />
      </svg>
    </>
  );
});
