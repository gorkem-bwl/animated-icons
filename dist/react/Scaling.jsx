  ...
  return (
    <>
      ...
      >
        ...
        <path d="M14 15H9v-5" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M16 3h5v5" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M21 3 9 15" className="al-secondary al-anim-fade al-delay-3" style={{}} />
      </svg>
    </>
  );
});
