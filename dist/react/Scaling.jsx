  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-scaling ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        ...
        <path d="M14 15H9v-5" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
        <path d="M16 3h5v5" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
        <path d="M21 3 9 15" className="al-secondary al-anim-scale-pop al-delay-3" style={{}} />
      </svg>
    </>
  );
});
