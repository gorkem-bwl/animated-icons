...
const Plug = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M12 22v-5" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M15 8V2" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M17 8a1 1 0 0 1 1 1v4a4 4 0 0 1-4 4h-4a4 4 0 0 1-4-4V9a1 1 0 0 1 1-1z" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M9 8V2" className="al-secondary al-anim-fade al-delay-3" style={{}} />
      </svg>
    </>
  );
});
