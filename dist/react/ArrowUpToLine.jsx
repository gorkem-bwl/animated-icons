...
const ArrowUpToLine = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M5 3h14" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="m18 13-6-6-6 6" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M12 7v14" className="al-secondary al-anim-fade al-delay-2" style={{}} />
      </svg>
    </>
  );
});
