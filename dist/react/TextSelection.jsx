  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-text-selection ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M14 21h1" className="al-primary al-anim-scale-pop al-delay-0" style={{}} />
        <path d="M14 3h1" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
        <path d="M19 3a2 2 0 0 1 2 2" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
        <path d="M21 14v1" className="al-secondary al-anim-scale-pop al-delay-3" style={{}} />
        <path d="M21 19a2 2 0 0 1-2 2" className="al-secondary al-anim-scale-pop al-delay-4" style={{}} />
        <path d="M21 9v1" className="al-secondary al-anim-scale-pop al-delay-5" style={{}} />
        <path d="M3 14v1" className="al-secondary al-anim-scale-pop al-delay-6" style={{}} />
        ...
        <path d="M5 3a2 2 0 0 0-2 2" className="al-secondary al-anim-scale-pop al-delay-7" style={{}} />
        <path d="M7 12h10" className="al-secondary al-anim-scale-pop al-delay-7" style={{}} />
        <path d="M7 16h6" className="al-secondary al-anim-scale-pop al-delay-7" style={{}} />
        <path d="M7 8h8" className="al-secondary al-anim-scale-pop al-delay-7" style={{}} />
        <path d="M9 21h1" className="al-secondary al-anim-scale-pop al-delay-7" style={{}} />
        <path d="M9 3h1" className="al-secondary al-anim-scale-pop al-delay-7" style={{}} />
      </svg>
    </>
  );
});
