...
const ArrowDownRightFromCircle = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M12 22a10 10 0 1 1 10-10" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M22 22 12 12" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M22 16v6h-6" className="al-secondary al-anim-fade al-delay-2" style={{}} />
      </svg>
    </>
  );
});
