...
const TextCursor = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M17 22h-1a4 4 0 0 1-4-4V6a4 4 0 0 1 4-4h1" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M7 22h1a4 4 0 0 0 4-4v-1" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M7 2h1a4 4 0 0 1 4 4v1" className="al-secondary al-anim-fade al-delay-2" style={{}} />
      </svg>
    </>
  );
});
