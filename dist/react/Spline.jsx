...
const Spline = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <circle cx="19" cy="5" r="2" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <circle cx="5" cy="19" r="2" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M5 17A12 12 0 0 1 17 5" className="al-secondary al-anim-fade al-delay-2" style={{}} />
      </svg>
    </>
  );
});
