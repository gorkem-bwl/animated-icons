  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-reply ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M20 18v-2a4 4 0 0 0-4-4H4" className="al-primary al-anim-mail-flap al-delay-0" style={{}} />
        <path d="m9 17-5-5 5-5" className="al-secondary al-anim-fill al-delay-1" style={{}} />
      </svg>
    </>
  );
});
