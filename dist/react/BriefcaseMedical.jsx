...
const BriefcaseMedical = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M12 11v4" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M14 13h-4" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M16 6V4a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v2" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M18 6v14" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <path d="M6 6v14" className="al-secondary al-anim-fade al-delay-4" style={{}} />
        <rect width="20" height="14" x="2" y="6" rx="2" className="al-secondary al-anim-fade al-delay-5" style={{}} />
      </svg>
    </>
  );
});
