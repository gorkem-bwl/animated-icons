  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-layout-grid ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        ...
        <rect width="7" height="7" x="14" y="3" rx="1" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
        <rect width="7" height="7" x="14" y="14" rx="1" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
        <rect width="7" height="7" x="3" y="14" rx="1" className="al-secondary al-anim-scale-pop al-delay-3" style={{}} />
      </svg>
    </>
  );
});
