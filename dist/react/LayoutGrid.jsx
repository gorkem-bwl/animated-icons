  ...
  return (
    <>
      ...
      >
        ...
        <rect width="7" height="7" x="14" y="3" rx="1" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <rect width="7" height="7" x="14" y="14" rx="1" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <rect width="7" height="7" x="3" y="14" rx="1" className="al-secondary al-anim-fade al-delay-3" style={{}} />
      </svg>
    </>
  );
});
