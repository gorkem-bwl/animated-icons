...
const BookUser = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M15 13a3 3 0 1 0-6 0" className="al-primary al-anim-fill al-delay-0" style={{}} />
        ...
        <circle cx="12" cy="8" r="2" className="al-secondary al-anim-fade al-delay-2" style={{}} />
      </svg>
    </>
  );
});
