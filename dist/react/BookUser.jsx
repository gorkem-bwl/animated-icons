  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-book-user ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M15 13a3 3 0 1 0-6 0" className="al-primary al-anim-scale-pop al-delay-0" style={{}} />
        ...
        <circle cx="12" cy="8" r="2" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
      </svg>
    </>
  );
});
