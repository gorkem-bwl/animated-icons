  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-hand-coins ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M11 15h2a2 2 0 1 0 0-4h-3c-.6 0-1.1.2-1.4.6L3 17" className="al-primary al-anim-scale-pop al-delay-0" style={{}} />
        <path d="m7 21 1.6-1.4c.3-.4.8-.6 1.4-.6h4c1.1 0 2.1-.4 2.8-1.2l4.6-4.4a2 2 0 0 0-2.75-2.91l-4.2 3.9" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
        <path d="m2 16 6 6" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
        <circle cx="16" cy="9" r="2.9" className="al-secondary al-anim-scale-pop al-delay-3" style={{}} />
        <circle cx="6" cy="5" r="3" className="al-secondary al-anim-scale-pop al-delay-4" style={{}} />
      </svg>
    </>
  );
});
