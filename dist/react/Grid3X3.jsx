  ...
  return (
    <>
      ...
      >
        ...
        <path d="M3 9h18" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M3 15h18" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M9 3v18" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <path d="M15 3v18" className="al-secondary al-anim-fade al-delay-4" style={{}} />
      </svg>
    </>
  );
});
