...
const LibrarySquare = forwardRef(({
  size = 24,
  color = 'currentColor',
  primaryColor,
  secondaryColor,
  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-library-square ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        ...
        <path d="M7 7v10" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
        <path d="M11 7v10" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
        <path d="m15 7 2 10" className="al-secondary al-anim-scale-pop al-delay-3" style={{}} />
      </svg>
    </>
  );
});
