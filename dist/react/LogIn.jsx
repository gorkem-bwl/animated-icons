  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-log-in ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="m10 17 5-5-5-5" className="al-primary al-anim-scale-pop al-delay-0" style={{}} />
        <path d="M15 12H3" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
        <path d="M15 3h4a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-4" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
      </svg>
    </>
  );
});
