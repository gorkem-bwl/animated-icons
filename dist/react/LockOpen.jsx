  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-lock-open ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <rect width="18" height="11" x="3" y="11" rx="2" ry="2" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M7 11V7a5 5 0 0 1 9.9-1" className="al-secondary al-anim-handle-lift al-delay-1" style={{}} />
      </svg>
    </>
  );
});
