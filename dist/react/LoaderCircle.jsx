  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-loader-circle ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M21 12a9 9 0 1 1-6.219-8.56" className="al-primary al-anim-spin al-delay-0" style={{}} />
      </svg>
    </>
  );
});
