...
const ArrowUpLeftFromCircle = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M2 8V2h6" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="m2 2 10 10" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M12 2A10 10 0 1 1 2 12" className="al-secondary al-anim-fade al-delay-2" style={{}} />
      </svg>
    </>
  );
});
