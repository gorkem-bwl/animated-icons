...
const SwissFranc = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M10 21V3h8" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M6 16h9" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M10 9.5h7" className="al-secondary al-anim-fade al-delay-2" style={{}} />
      </svg>
    </>
  );
});
