  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-user-round-pen ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M2 21a8 8 0 0 1 10.821-7.487" className="al-primary al-anim-scale-pop al-delay-0" style={{}} />
        ...
        <circle cx="10" cy="8" r="5" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
      </svg>
    </>
  );
});
