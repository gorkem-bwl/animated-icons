...
const ArrowUpRightFromCircle = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M22 12A10 10 0 1 1 12 2" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M22 2 12 12" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M16 2h6v6" className="al-secondary al-anim-fade al-delay-2" style={{}} />
      </svg>
    </>
  );
});
