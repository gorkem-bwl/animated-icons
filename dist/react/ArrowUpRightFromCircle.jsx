...
const ArrowUpRightFromCircle = forwardRef(({
  size = 24,
  color = 'currentColor',
  primaryColor,
  secondaryColor,
  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-arrow-up-right-from-circle ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M22 12A10 10 0 1 1 12 2" className="al-primary al-anim-scale-pop al-delay-0" style={{}} />
        <path d="M22 2 12 12" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
        <path d="M16 2h6v6" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
      </svg>
    </>
  );
});

ArrowUpRightFromCircle.displayName = 'ArrowUpRightFromCircle';
