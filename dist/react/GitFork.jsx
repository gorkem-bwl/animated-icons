  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-git-fork ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <circle cx="12" cy="18" r="3" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <circle cx="6" cy="6" r="3" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <circle cx="18" cy="6" r="3" className="al-primary al-anim-fade al-delay-2" style={{}} />
        <path d="M18 9v2c0 .6-.4 1-1 1H7c-.6 0-1-.4-1-1V9" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <path d="M12 12v3" className="al-primary al-anim-fade al-delay-4" style={{}} />
      </svg>
    </>
  );
});
