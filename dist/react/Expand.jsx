  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-expand ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="m15 15 6 6" className="al-primary al-anim-scale-pop al-delay-0" style={{}} />
        <path d="m15 9 6-6" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
        <path d="M21 16v5h-5" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
        <path d="M21 8V3h-5" className="al-secondary al-anim-scale-pop al-delay-3" style={{}} />
        <path d="M3 16v5h5" className="al-secondary al-anim-scale-pop al-delay-4" style={{}} />
        <path d="m3 21 6-6" className="al-secondary al-anim-scale-pop al-delay-5" style={{}} />
        <path d="M3 8V3h5" className="al-secondary al-anim-scale-pop al-delay-6" style={{}} />
        <path d="M9 9 3 3" className="al-secondary al-anim-scale-pop al-delay-7" style={{}} />
      </svg>
    </>
  );
});
