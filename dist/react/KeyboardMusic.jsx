  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-keyboard-music ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        ...
        <path d="M18 8h.01" className="al-secondary al-anim-scale-pop al-delay-3" style={{}} />
        <path d="M2 12h20" className="al-secondary al-anim-scale-pop al-delay-4" style={{}} />
        <path d="M6 12v4" className="al-secondary al-anim-scale-pop al-delay-5" style={{}} />
        <path d="M10 12v4" className="al-secondary al-anim-scale-pop al-delay-6" style={{}} />
        <path d="M14 12v4" className="al-secondary al-anim-scale-pop al-delay-7" style={{}} />
        <path d="M18 12v4" className="al-secondary al-anim-scale-pop al-delay-7" style={{}} />
      </svg>
    </>
  );
});
