...
const MonitorCheck = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="m9 10 2 2 4-4" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <rect width="20" height="14" x="2" y="3" rx="2" className="al-secondary al-anim-fade al-delay-1" style={{}} />
