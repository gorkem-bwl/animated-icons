  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-users ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2" className="al-primary al-anim-fade al-delay-0" style={{}} />
        <path d="M16 3.128a4 4 0 0 1 0 7.744" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M22 21v-2a4 4 0 0 0-3-3.87" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <circle cx="9" cy="7" r="4" className="al-secondary al-anim-fill al-delay-3" style={{}} />
      </svg>
    </>
  );
});
