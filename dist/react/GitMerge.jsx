  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-git-merge ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        ...
        <path d="M6 21V9a9 9 0 0 0 9 9" className="al-primary al-anim-fade al-delay-2" style={{}} />
      </svg>
    </>
  );
});
