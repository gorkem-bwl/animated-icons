  ...
  return (
    <>
      ...
      >
        ...
        <rect width="3" height="9" x="7" y="7" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <rect width="3" height="5" x="14" y="7" className="al-secondary al-anim-fade al-delay-2" style={{}} />
      </svg>
    </>
  );
});
