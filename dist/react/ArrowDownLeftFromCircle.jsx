...
const ArrowDownLeftFromCircle = forwardRef(({
  size = 24,
  color = 'currentColor',
  primaryColor,
  secondaryColor,
  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-arrow-down-left-from-circle ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M2 12a10 10 0 1 1 10 10" className="al-primary al-anim-scale-pop al-delay-0" style={{}} />
        <path d="m2 22 10-10" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
        <path d="M8 22H2v-6" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
      </svg>
    </>
  );
});
