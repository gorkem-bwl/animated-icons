...
const ArrowDownLeftFromCircle = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M2 12a10 10 0 1 1 10 10" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="m2 22 10-10" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M8 22H2v-6" className="al-secondary al-anim-fade al-delay-2" style={{}} />
      </svg>
    </>
  );
});
