...
const UserPlus2 = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M2 21a8 8 0 0 1 13.292-6" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <circle cx="10" cy="8" r="5" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M19 16v6" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M22 19h-6" className="al-secondary al-anim-fade al-delay-3" style={{}} />
      </svg>
    </>
  );
});
