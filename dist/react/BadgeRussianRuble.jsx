  ...
  return (
    <>
      ...
      >
        ...
        <path d="M9 16h5" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M9 12h5a2 2 0 1 0 0-4h-3v9" className="al-secondary al-anim-fade al-delay-2" style={{}} />
      </svg>
    </>
  );
});
