...
const BetweenHorizonalEnd = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <rect width="13" height="7" x="3" y="3" rx="1" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="m22 15-3-3 3-3" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <rect width="13" height="7" x="3" y="14" rx="1" className="al-secondary al-anim-fade al-delay-2" style={{}} />
      </svg>
    </>
  );
});
