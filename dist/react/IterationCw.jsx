...
const IterationCw = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M4 10a8 8 0 1 1 8 8H4" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="m8 22-4-4 4-4" className="al-secondary al-anim-fade al-delay-1" style={{}} />
      </svg>
    </>
  );
});
