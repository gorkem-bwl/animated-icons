  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-search-x ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="m13.5 8.5-5 5" className="al-primary al-anim-scale-pop al-delay-0" style={{}} />
        <path d="m8.5 8.5 5 5" className="al-secondary al-anim-fill al-delay-1" style={{}} />
        <circle cx="11" cy="11" r="8" className="al-secondary al-anim-fill al-delay-2" style={{}} />
        <path d="m21 21-4.3-4.3" className="al-secondary al-anim-fill al-delay-3" style={{}} />
      </svg>
    </>
  );
});
