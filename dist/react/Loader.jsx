  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-loader ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M12 2v4" className="al-primary al-anim-spin al-delay-0" style={{}} />
        <path d="m16.2 7.8 2.9-2.9" className="al-secondary al-anim-spin al-delay-1" style={{}} />
        <path d="M18 12h4" className="al-secondary al-anim-spin al-delay-2" style={{}} />
        <path d="m16.2 16.2 2.9 2.9" className="al-secondary al-anim-spin al-delay-3" style={{}} />
        <path d="M12 18v4" className="al-secondary al-anim-spin al-delay-4" style={{}} />
        <path d="m4.9 19.1 2.9-2.9" className="al-secondary al-anim-spin al-delay-5" style={{}} />
        <path d="M2 12h4" className="al-secondary al-anim-spin al-delay-6" style={{}} />
        <path d="m4.9 4.9 2.9 2.9" className="al-secondary al-anim-spin al-delay-7" style={{}} />
      </svg>
    </>
  );
});
