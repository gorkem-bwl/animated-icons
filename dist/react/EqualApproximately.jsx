...
const EqualApproximately = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M5 15a6.5 6.5 0 0 1 7 0 6.5 6.5 0 0 0 7 0" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M5 9a6.5 6.5 0 0 1 7 0 6.5 6.5 0 0 0 7 0" className="al-secondary al-anim-fade al-delay-1" style={{}} />
      </svg>
    </>
  );
});
