  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-server ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <rect width="20" height="8" x="2" y="2" rx="2" ry="2" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <rect width="20" height="8" x="2" y="14" rx="2" ry="2" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <line x1="6" x2="6.01" y1="6" y2="6" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <line x1="6" x2="6.01" y1="18" y2="18" className="al-secondary al-anim-fade al-delay-3" style={{}} />
      </svg>
    </>
  );
});
