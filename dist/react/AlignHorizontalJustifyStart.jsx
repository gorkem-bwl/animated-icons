...
const AlignHorizontalJustifyStart = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <rect width="6" height="14" x="6" y="5" rx="2" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <rect width="6" height="10" x="16" y="7" rx="2" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M2 2v20" className="al-secondary al-anim-fade al-delay-2" style={{}} />
      </svg>
    </>
  );
});
