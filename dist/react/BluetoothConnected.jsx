  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-bluetooth-connected ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="m7 7 10 10-5 5V2l5 5L7 17" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <line x1="18" x2="21" y1="12" y2="12" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <line x1="3" x2="6" y1="12" y2="12" className="al-secondary al-anim-fade al-delay-2" style={{}} />
      </svg>
    </>
  );
});
