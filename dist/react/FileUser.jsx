  ...
  return (
    <>
      ...
      >
        ...
        <path d="M16 22a4 4 0 0 0-8 0" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <circle cx="12" cy="15" r="3" className="al-secondary al-anim-fade al-delay-3" style={{}} />
      </svg>
    </>
  );
});
