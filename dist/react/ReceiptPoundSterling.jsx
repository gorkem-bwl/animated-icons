...
const ReceiptPoundSterling = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M10 17V9.5a1 1 0 0 1 5 0" className="al-primary al-anim-fill al-delay-0" style={{}} />
        ...
        <path d="M8 13h5" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M8 17h7" className="al-secondary al-anim-fade al-delay-3" style={{}} />
      </svg>
    </>
  );
});
