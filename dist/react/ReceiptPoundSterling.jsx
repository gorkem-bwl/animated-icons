  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-receipt-pound-sterling ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M10 17V9.5a1 1 0 0 1 5 0" className="al-primary al-anim-scale-pop al-delay-0" style={{}} />
        ...
        <path d="M8 13h5" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
        <path d="M8 17h7" className="al-secondary al-anim-scale-pop al-delay-3" style={{}} />
      </svg>
    </>
  );
});
