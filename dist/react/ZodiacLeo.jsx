...
const ZodiacLeo = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M10 16c0-4-3-4.5-3-8a5 5 0 0 1 10 0c0 3.466-3 6.196-3 10a3 3 0 0 0 6 0" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <circle cx="7" cy="16" r="3" className="al-secondary al-anim-fade al-delay-1" style={{}} />
      </svg>
    </>
  );
});
