...
const ZodiacVirgo = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M11 5.5a1 1 0 0 1 5 0V16a5 5 0 0 0 5 5" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M16 11.5a1 1 0 0 1 5 0V16a5 5 0 0 1-5 5" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M6 19V6a3 3 0 0 0-3-3h0" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M6 5.5a1 1 0 0 1 5 0V19" className="al-secondary al-anim-fade al-delay-3" style={{}} />
      </svg>
    </>
  );
});
