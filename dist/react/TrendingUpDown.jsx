...
const TrendingUpDown = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M14.828 14.828 21 21" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M21 16v5h-5" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="m21 3-9 9-4-4-6 6" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M21 8V3h-5" className="al-secondary al-anim-fade al-delay-3" style={{}} />
      </svg>
    </>
  );
});
