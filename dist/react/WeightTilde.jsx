...
const WeightTilde = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M6.5 8a2 2 0 0 0-1.906 1.46L2.1 18.5A2 2 0 0 0 4 21h16a2 2 0 0 0 1.925-2.54L19.4 9.5A2 2 0 0 0 17.48 8z" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M7.999 15a2.5 2.5 0 0 1 4 0 2.5 2.5 0 0 0 4 0" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <circle cx="12" cy="5" r="3" className="al-secondary al-anim-fade al-delay-2" style={{}} />
      </svg>
    </>
  );
});
