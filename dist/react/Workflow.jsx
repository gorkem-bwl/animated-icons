  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-workflow ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <rect width="8" height="8" x="3" y="3" rx="2" className="al-primary al-anim-scale-pop al-delay-0" style={{}} />
        <path d="M7 11v4a2 2 0 0 0 2 2h4" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
        <rect width="8" height="8" x="13" y="13" rx="2" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
      </svg>
    </>
  );
});
