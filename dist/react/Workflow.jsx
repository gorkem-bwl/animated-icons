...
const Workflow = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <rect width="8" height="8" x="3" y="3" rx="2" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M7 11v4a2 2 0 0 0 2 2h4" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <rect width="8" height="8" x="13" y="13" rx="2" className="al-secondary al-anim-fade al-delay-2" style={{}} />
      </svg>
    </>
  );
});
