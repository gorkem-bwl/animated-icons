...
const ListChevronsDownUp = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M3 5h8" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M3 12h8" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M3 19h8" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="m15 5 3 3 3-3" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <path d="m15 19 3-3 3 3" className="al-secondary al-anim-fade al-delay-4" style={{}} />
      </svg>
    </>
  );
});
