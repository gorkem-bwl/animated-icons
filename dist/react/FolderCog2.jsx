  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-folder-cog-2 ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M10.3 20H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h3.98a2 2 0 0 1 1.69.9l.66 1.2A2 2 0 0 0 12 6h8a2 2 0 0 1 2 2v3.3" className="al-primary al-anim-gear al-delay-0" style={{ '--al-rotation': '90deg' }} />
        <path d="m14.305 19.53.923-.382" className="al-secondary al-anim-gear al-delay-1" style={{ '--al-rotation': '90deg' }} />
        <path d="m15.228 16.852-.923-.383" className="al-secondary al-anim-gear al-delay-2" style={{ '--al-rotation': '90deg' }} />
        <path d="m16.852 15.228-.383-.923" className="al-secondary al-anim-gear al-delay-3" style={{ '--al-rotation': '90deg' }} />
