...
const FolderCog2 = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M10.3 20H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h3.98a2 2 0 0 1 1.69.9l.66 1.2A2 2 0 0 0 12 6h8a2 2 0 0 1 2 2v3.3" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="m14.305 19.53.923-.382" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="m15.228 16.852-.923-.383" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="m16.852 15.228-.383-.923" className="al-secondary al-anim-fade al-delay-3" style={{}} />
