  ...
  return (
    <>
      ...
      >
        ...
        <path d="M22 12a10 10 0 1 0-11 9.95" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="m22 16-5.5 5.5L14 19" className="al-secondary al-anim-fade al-delay-2" style={{}} />
      </svg>
    </>
  );
});
