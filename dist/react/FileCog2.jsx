  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-file-cog-2 ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M15 8a1 1 0 0 1-1-1V2a2.4 2.4 0 0 1 1.704.706l3.588 3.588A2.4 2.4 0 0 1 20 8z" className="al-primary al-anim-gear al-delay-0" style={{ '--al-rotation': '90deg' }} />
        <path d="M20 8v12a2 2 0 0 1-2 2h-4.182" className="al-secondary al-anim-gear al-delay-1" style={{ '--al-rotation': '90deg' }} />
        <path d="m3.305 19.53.923-.382" className="al-secondary al-anim-gear al-delay-2" style={{ '--al-rotation': '90deg' }} />
        <path d="M4 10.592V4a2 2 0 0 1 2-2h8" className="al-secondary al-anim-gear al-delay-3" style={{ '--al-rotation': '90deg' }} />
        <path d="m4.228 16.852-.924-.383" className="al-secondary al-anim-gear al-delay-4" style={{ '--al-rotation': '90deg' }} />
        <path d="m5.852 15.228-.383-.923" className="al-secondary al-anim-gear al-delay-5" style={{ '--al-rotation': '90deg' }} />
        <path d="m5.852 20.772-.383.924" className="al-secondary al-anim-gear al-delay-6" style={{ '--al-rotation': '90deg' }} />
        <path d="m8.148 15.228.383-.923" className="al-secondary al-anim-gear al-delay-7" style={{ '--al-rotation': '90deg' }} />
        <path d="m8.53 21.696-.382-.924" className="al-secondary al-anim-gear al-delay-7" style={{ '--al-rotation': '90deg' }} />
        <path d="m9.773 16.852.922-.383" className="al-secondary al-anim-gear al-delay-7" style={{ '--al-rotation': '90deg' }} />
        <path d="m9.773 19.148.922.383" className="al-secondary al-anim-gear al-delay-7" style={{ '--al-rotation': '90deg' }} />
        <circle cx="7" cy="18" r="3" className="al-secondary al-anim-gear al-delay-7" style={{ '--al-rotation': '90deg' }} />
      </svg>
    </>
  );
});
