  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-cpu ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M12 20v2" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M12 2v2" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M17 20v2" className="al-primary al-anim-fade al-delay-2" style={{}} />
        <path d="M17 2v2" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <path d="M2 12h2" className="al-primary al-anim-fade al-delay-4" style={{}} />
        <path d="M2 17h2" className="al-secondary al-anim-fade al-delay-5" style={{}} />
        <path d="M2 7h2" className="al-primary al-anim-fade al-delay-6" style={{}} />
        <path d="M20 12h2" className="al-secondary al-anim-fade al-delay-7" style={{}} />
        <path d="M20 17h2" className="al-primary al-anim-fade al-delay-7" style={{}} />
        <path d="M20 7h2" className="al-secondary al-anim-fade al-delay-7" style={{}} />
        <path d="M7 20v2" className="al-primary al-anim-fade al-delay-7" style={{}} />
        <path d="M7 2v2" className="al-secondary al-anim-fade al-delay-7" style={{}} />
        <rect x="4" y="4" width="16" height="16" rx="2" className="al-primary al-anim-fade al-delay-7" style={{}} />
        <rect x="8" y="8" width="8" height="8" rx="1" className="al-secondary al-anim-fade al-delay-7" style={{}} />
      </svg>
    </>
  );
});
