...
const Refrigerator = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M5 6a4 4 0 0 1 4-4h6a4 4 0 0 1 4 4v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6Z" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M5 10h14" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M15 7v6" className="al-secondary al-anim-fade al-delay-2" style={{}} />
      </svg>
    </>
  );
});
