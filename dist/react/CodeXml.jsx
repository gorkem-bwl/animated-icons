  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-code-xml ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="m18 16 4-4-4-4" className="al-primary al-anim-scale-pop al-delay-0" style={{}} />
        <path d="m6 8-4 4 4 4" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
        <path d="m14.5 4-5 16" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
      </svg>
    </>
  );
});
