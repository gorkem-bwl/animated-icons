  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-cloud-hail ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        ...
        <path d="M16 14v2" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M8 14v2" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M16 20h.01" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <path d="M8 20h.01" className="al-secondary al-anim-fade al-delay-4" style={{}} />
        <path d="M12 16v2" className="al-secondary al-anim-fade al-delay-5" style={{}} />
        <path d="M12 22h.01" className="al-secondary al-anim-fade al-delay-6" style={{}} />
      </svg>
    </>
  );
});
