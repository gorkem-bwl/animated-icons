  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-arrows-up-from-line ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="m4 6 3-3 3 3" className="al-primary al-anim-scale-pop al-delay-0" style={{}} />
        <path d="M7 17V3" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
        <path d="m14 6 3-3 3 3" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
        <path d="M17 17V3" className="al-secondary al-anim-scale-pop al-delay-3" style={{}} />
        <path d="M4 21h16" className="al-secondary al-anim-scale-pop al-delay-4" style={{}} />
      </svg>
    </>
  );
});
