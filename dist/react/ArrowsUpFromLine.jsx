...
const ArrowsUpFromLine = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="m4 6 3-3 3 3" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M7 17V3" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="m14 6 3-3 3 3" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M17 17V3" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <path d="M4 21h16" className="al-secondary al-anim-fade al-delay-4" style={{}} />
      </svg>
    </>
  );
});
