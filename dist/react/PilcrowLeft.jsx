...
const PilcrowLeft = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M14 3v11" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M14 9h-3a3 3 0 0 1 0-6h9" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M18 3v11" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M22 18H2l4-4" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <path d="m6 22-4-4" className="al-secondary al-anim-fade al-delay-4" style={{}} />
      </svg>
    </>
  );
});
