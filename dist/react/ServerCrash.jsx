...
const ServerCrash = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M6 10H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v4a2 2 0 0 1-2 2h-2" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M6 14H4a2 2 0 0 0-2 2v4a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-4a2 2 0 0 0-2-2h-2" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M6 6h.01" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M6 18h.01" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <path d="m13 6-4 6h6l-4 6" className="al-secondary al-anim-fade al-delay-4" style={{}} />
      </svg>
    </>
  );
});
