  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-notebook-tabs ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M2 6h4" className="al-primary al-anim-scale-pop al-delay-0" style={{}} />
        <path d="M2 10h4" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
        <path d="M2 14h4" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
        <path d="M2 18h4" className="al-secondary al-anim-scale-pop al-delay-3" style={{}} />
        <rect width="16" height="20" x="4" y="2" rx="2" className="al-secondary al-anim-scale-pop al-delay-4" style={{}} />
        <path d="M15 2v20" className="al-secondary al-anim-scale-pop al-delay-5" style={{}} />
        <path d="M15 7h5" className="al-secondary al-anim-scale-pop al-delay-6" style={{}} />
        <path d="M15 12h5" className="al-secondary al-anim-scale-pop al-delay-7" style={{}} />
        <path d="M15 17h5" className="al-secondary al-anim-scale-pop al-delay-7" style={{}} />
      </svg>
    </>
  );
});
