  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-user-check ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="m16 11 2 2 4-4" className="al-primary al-anim-fade al-delay-0" style={{}} />
        <path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <circle cx="9" cy="7" r="4" className="al-secondary al-anim-fill al-delay-2" style={{}} />
      </svg>
    </>
  );
});
