...
const ParkingMeter = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M11 15h2" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M12 12v3" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M12 19v3" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M15.282 19a1 1 0 0 0 .948-.68l2.37-6.988a7 7 0 1 0-13.2 0l2.37 6.988a1 1 0 0 0 .948.68z" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <path d="M9 9a3 3 0 1 1 6 0" className="al-secondary al-anim-fade al-delay-4" style={{}} />
      </svg>
    </>
  );
});
