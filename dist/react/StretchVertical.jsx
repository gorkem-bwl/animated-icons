  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-stretch-vertical ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <rect width="6" height="20" x="4" y="2" rx="2" className="al-primary al-anim-scale-pop al-delay-0" style={{}} />
        <rect width="6" height="20" x="14" y="2" rx="2" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
      </svg>
    </>
  );
});
