...
const StretchVertical = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <rect width="6" height="20" x="4" y="2" rx="2" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <rect width="6" height="20" x="14" y="2" rx="2" className="al-secondary al-anim-fade al-delay-1" style={{}} />
      </svg>
    </>
  );
});
