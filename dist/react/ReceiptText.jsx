  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-receipt-text ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
