  ...
  return (
    <>
      ...
      >
        ...
        <path d="m16 6-4 4-4-4" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <rect width="20" height="8" x="2" y="14" rx="2" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M6 18h.01" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <path d="M10 18h.01" className="al-secondary al-anim-fade al-delay-4" style={{}} />
      </svg>
    </>
  );
});
