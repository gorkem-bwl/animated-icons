  ...
  return (
    <>
      ...
      >
        ...
        <path d="M17 13v-3h4" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <path d="M17 17.7c.4.2.8.3 1.3.3 1.5 0 2.7-1.1 2.7-2.5S19.8 13 18.3 13H17" className="al-secondary al-anim-fade al-delay-4" style={{}} />
      </svg>
    </>
  );
});
