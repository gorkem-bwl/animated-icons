  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-square-dashed-top-solid ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        ...
        <path d="M21 14v1" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
        <path d="M21 19a2 2 0 0 1-2 2" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
        <path d="M21 9v1" className="al-secondary al-anim-scale-pop al-delay-3" style={{}} />
        <path d="M3 14v1" className="al-secondary al-anim-scale-pop al-delay-4" style={{}} />
        <path d="M3 5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2" className="al-secondary al-anim-scale-pop al-delay-5" style={{}} />
        <path d="M3 9v1" className="al-secondary al-anim-scale-pop al-delay-6" style={{}} />
