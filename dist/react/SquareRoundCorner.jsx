...
const SquareRoundCorner = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M21 11a8 8 0 0 0-8-8" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4" className="al-secondary al-anim-fade al-delay-1" style={{}} />
      </svg>
    </>
  );
});
