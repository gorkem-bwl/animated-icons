...
const Pocket = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M20 3a2 2 0 0 1 2 2v6a1 1 0 0 1-20 0V5a2 2 0 0 1 2-2z" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="m8 10 4 4 4-4" className="al-secondary al-anim-fade al-delay-1" style={{}} />
      </svg>
    </>
  );
});
