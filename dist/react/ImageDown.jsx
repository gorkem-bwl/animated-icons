...
const ImageDown = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M10.3 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v10l-3.1-3.1a2 2 0 0 0-2.814.014L6 21" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="m14 19 3 3v-5.5" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="m17 22 3-3" className="al-secondary al-anim-fade al-delay-2" style={{}} />
