...
const Cloudy = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M17.5 12a1 1 0 1 1 0 9H9.006a7 7 0 1 1 6.702-9z" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M21.832 9A3 3 0 0 0 19 7h-2.207a5.5 5.5 0 0 0-10.72.61" className="al-secondary al-anim-fade al-delay-1" style={{}} />
      </svg>
    </>
  );
});
