  ...
  return (
    <>
      ...
      >
        ...
        <path d="M7 22v-2a2 2 0 0 1 2-2h6a2 2 0 0 1 2 2v2" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M8 2v2" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <circle cx="12" cy="11" r="3" className="al-secondary al-anim-fade al-delay-3" style={{}} />
