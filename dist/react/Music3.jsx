  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-music-3 ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <circle cx="12" cy="18" r="4" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M16 18V2" strokeDasharray="20" className="al-secondary al-anim-draw al-delay-1" style={{ '--al-dash-len': '20' }} />
      </svg>
    </>
  );
});
