  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-send-horizontal ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M3.714 3.048a.498.498 0 0 0-.683.627l2.843 7.627a2 2 0 0 1 0 1.396l-2.842 7.627a.498.498 0 0 0 .682.627l18-8.5a.5.5 0 0 0 0-.904z" className="al-primary al-anim-shake al-delay-0" style={{}} />
        <path d="M6 12h16" className="al-secondary al-anim-shake al-delay-1" style={{}} />
      </svg>
    </>
  );
});
