...
const Contact2 = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M16 2v2" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M17.915 22a6 6 0 0 0-12 0" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M8 2v2" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <circle cx="12" cy="12" r="4" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <rect x="3" y="4" width="18" height="18" rx="2" className="al-secondary al-anim-fade al-delay-4" style={{}} />
      </svg>
    </>
  );
});
