  ...
  return (
    <>
      ...
      >
        ...
        <path d="M12 6h5a2 2 0 0 1 2 2v3" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <path d="M19 15v6" className="al-secondary al-anim-fade al-delay-4" style={{}} />
        <path d="M22 18h-6" className="al-secondary al-anim-fade al-delay-5" style={{}} />
      </svg>
    </>
  );
});
