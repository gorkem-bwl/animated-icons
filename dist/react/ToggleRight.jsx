  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-toggle-right ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <circle cx="15" cy="12" r="3" className="al-primary al-anim-scale-pop al-delay-0" style={{}} />
        <rect width="20" height="14" x="2" y="5" rx="7" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
      </svg>
    </>
  );
});
