...
const SplitSquareHorizontal = forwardRef(({
  size = 24,
  color = 'currentColor',
  primaryColor,
  secondaryColor,
  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-split-square-horizontal ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M8 19H5c-1 0-2-1-2-2V7c0-1 1-2 2-2h3" className="al-primary al-anim-scale-pop al-delay-0" style={{}} />
        <path d="M16 5h3c1 0 2 1 2 2v10c0 1-1 2-2 2h-3" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
        <line x1="12" x2="12" y1="4" y2="20" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
      </svg>
    </>
  );
});

SplitSquareHorizontal.displayName = 'SplitSquareHorizontal';
