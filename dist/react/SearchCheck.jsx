  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-search-check ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="m8 11 2 2 4-4" className="al-primary al-anim-scale-pop al-delay-0" style={{}} />
        <circle cx="11" cy="11" r="8" className="al-secondary al-anim-fill al-delay-1" style={{}} />
        <path d="m21 21-4.3-4.3" className="al-secondary al-anim-fill al-delay-2" style={{}} />
      </svg>
    </>
  );
});
