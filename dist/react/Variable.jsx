...
const Variable = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M8 21s-4-3-4-9 4-9 4-9" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M16 3s4 3 4 9-4 9-4 9" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <line x1="15" x2="9" y1="9" y2="15" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <line x1="9" x2="15" y1="9" y2="15" className="al-secondary al-anim-fade al-delay-3" style={{}} />
      </svg>
    </>
  );
});
