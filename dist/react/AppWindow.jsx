  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-app-window ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <rect x="2" y="4" width="20" height="16" rx="2" className="al-primary al-anim-scale-pop al-delay-0" style={{}} />
        <path d="M10 4v4" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
        <path d="M2 8h20" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
        <path d="M6 4v4" className="al-secondary al-anim-scale-pop al-delay-3" style={{}} />
      </svg>
    </>
  );
});
