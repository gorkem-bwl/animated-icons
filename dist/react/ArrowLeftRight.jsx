...
const ArrowLeftRight = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M8 3 4 7l4 4" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M4 7h16" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="m16 21 4-4-4-4" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M20 17H4" className="al-secondary al-anim-fade al-delay-3" style={{}} />
      </svg>
    </>
  );
});
