...
const Ligature = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M14 12h2v8" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M14 20h4" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M6 12h4" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M6 20h4" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <path d="M8 20V8a4 4 0 0 1 7.464-2" className="al-secondary al-anim-fade al-delay-4" style={{}} />
      </svg>
    </>
  );
});
