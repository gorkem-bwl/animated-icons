  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-package-plus ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        ...
        <path d="M16 17h6" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
        <path d="M19 14v6" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
        <path d="M21 10.535V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.729l7 4a2 2 0 0 0 2 .001l1.675-.955" className="al-secondary al-anim-scale-pop al-delay-3" style={{}} />
