  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-timer ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <line x1="10" x2="14" y1="2" y2="2" className="al-primary al-anim-fade al-delay-0" style={{}} />
        <line x1="12" x2="15" y1="14" y2="11" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <circle cx="12" cy="14" r="8" className="al-secondary al-anim-fill al-delay-2" style={{}} />
      </svg>
    </>
  );
});
