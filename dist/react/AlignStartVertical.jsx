  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-align-start-vertical ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <rect width="9" height="6" x="6" y="14" rx="2" className="al-primary al-anim-scale-pop al-delay-0" style={{}} />
        <rect width="16" height="6" x="6" y="4" rx="2" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
