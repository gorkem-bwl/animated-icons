...
const TextCursorInput = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M12 20h-1a2 2 0 0 1-2-2 2 2 0 0 1-2 2H6" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M13 8h7a2 2 0 0 1 2 2v4a2 2 0 0 1-2 2h-7" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M5 16H4a2 2 0 0 1-2-2v-4a2 2 0 0 1 2-2h1" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M6 4h1a2 2 0 0 1 2 2 2 2 0 0 1 2-2h1" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <path d="M9 6v12" className="al-secondary al-anim-fade al-delay-4" style={{}} />
      </svg>
    </>
  );
});
