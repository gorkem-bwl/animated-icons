  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-mailbox ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M22 17a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V9.5C2 7 4 5 6.5 5H18c2.2 0 4 1.8 4 4v8Z" className="al-primary al-anim-mail-flap al-delay-0" style={{}} />
        <polyline points="15,9 18,9 18,11" className="al-secondary al-anim-fill al-delay-1" style={{}} />
        <path d="M6.5 5C9 5 11 7 11 9.5V17a2 2 0 0 1-2 2" className="al-secondary al-anim-fill al-delay-2" style={{}} />
        <line x1="6" x2="7" y1="10" y2="10" className="al-secondary al-anim-fill al-delay-3" style={{}} />
      </svg>
    </>
  );
});
