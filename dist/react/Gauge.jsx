  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-gauge ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="m12 14 4-4" className="al-primary al-anim-scale-pop al-delay-0" style={{}} />
        <path d="M3.34 19a10 10 0 1 1 17.32 0" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
      </svg>
    </>
  );
});
