...
const Gauge = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="m12 14 4-4" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M3.34 19a10 10 0 1 1 17.32 0" className="al-secondary al-anim-fade al-delay-1" style={{}} />
      </svg>
    </>
  );
});
