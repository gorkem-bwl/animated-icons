  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-log-out ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="m16 17 5-5-5-5" className="al-primary al-anim-scale-pop al-delay-0" style={{}} />
        <path d="M21 12H9" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
        <path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
      </svg>
    </>
  );
});
