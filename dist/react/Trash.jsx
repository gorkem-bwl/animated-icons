  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-trash ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6" className="al-secondary al-anim-handle-lift al-delay-0" style={{}} />
        <path d="M3 6h18" className="al-primary al-anim-fill al-delay-1" style={{}} />
        <path d="M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2" className="al-primary al-anim-fill al-delay-2" style={{}} />
      </svg>
    </>
  );
});
