...
const WrapText = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="m16 16-3 3 3 3" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M3 12h14.5a1 1 0 0 1 0 7H13" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M3 19h6" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M3 5h18" className="al-secondary al-anim-fade al-delay-3" style={{}} />
      </svg>
    </>
  );
});
