  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-link-2 ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M9 17H7A5 5 0 0 1 7 7h2" className="al-primary al-anim-scale-pop al-delay-0" style={{}} />
        <path d="M15 7h2a5 5 0 1 1 0 10h-2" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
        <line x1="8" x2="16" y1="12" y2="12" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
      </svg>
    </>
  );
});
