...
const ListFilterPlus = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M12 5H2" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M6 12h12" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M9 19h6" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M16 5h6" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <path d="M19 8V2" className="al-secondary al-anim-fade al-delay-4" style={{}} />
      </svg>
    </>
  );
});
