  ...
  return (
    <>
      ...
      >
        ...
        <path d="M2 5h20" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M3 3v2" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M7 3v2" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <path d="M17 3v2" className="al-secondary al-anim-fade al-delay-4" style={{}} />
        <path d="M21 3v2" className="al-secondary al-anim-fade al-delay-5" style={{}} />
        <path d="m19 5-7 7-7-7" className="al-secondary al-anim-fade al-delay-6" style={{}} />
      </svg>
    </>
  );
});
