...
const FileCode2 = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M4 12.15V4a2 2 0 0 1 2-2h8a2.4 2.4 0 0 1 1.706.706l3.588 3.588A2.4 2.4 0 0 1 20 8v12a2 2 0 0 1-2 2h-3.35" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M14 2v5a1 1 0 0 0 1 1h5" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="m5 16-3 3 3 3" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="m9 22 3-3-3-3" className="al-secondary al-anim-fade al-delay-3" style={{}} />
      </svg>
    </>
  );
});
