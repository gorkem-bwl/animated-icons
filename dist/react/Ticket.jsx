...
const Ticket = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M2 9a3 3 0 0 1 0 6v2a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-2a3 3 0 0 1 0-6V7a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2Z" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M13 5v2" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M13 17v2" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M13 11v2" className="al-secondary al-anim-fade al-delay-3" style={{}} />
      </svg>
    </>
  );
});
