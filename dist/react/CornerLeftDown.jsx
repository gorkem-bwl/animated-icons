...
const CornerLeftDown = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="m14 15-5 5-5-5" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M20 4h-7a4 4 0 0 0-4 4v12" className="al-secondary al-anim-fade al-delay-1" style={{}} />
      </svg>
    </>
  );
});
