  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-user ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2" className="al-primary al-anim-fade al-delay-0" style={{}} />
        <circle cx="12" cy="7" r="4" className="al-secondary al-anim-fill al-delay-1" style={{}} />
      </svg>
    </>
  );
});
