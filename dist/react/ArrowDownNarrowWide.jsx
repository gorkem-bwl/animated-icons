  ...
  return (
    <>
      ...
      >
        ...
        <path d="M11 4h4" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M11 8h7" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <path d="M11 12h10" className="al-secondary al-anim-fade al-delay-4" style={{}} />
      </svg>
    </>
  );
});
