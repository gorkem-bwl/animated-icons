  ...
  return (
    <>
      ...
      >
        ...
        <rect width="16" height="18" x="4" y="4" rx="2" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <path d="M8 10h6" className="al-secondary al-anim-fade al-delay-4" style={{}} />
        <path d="M8 14h8" className="al-secondary al-anim-fade al-delay-5" style={{}} />
        <path d="M8 18h5" className="al-secondary al-anim-fade al-delay-6" style={{}} />
      </svg>
    </>
  );
});
