  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-bar-chart-2 ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        ...
        <path d="M12 21V3" className="al-secondary al-anim-bar al-delay-1" style={{}} />
        <path d="M19 21V9" className="al-primary al-anim-bar al-delay-2" style={{}} />
      </svg>
    </>
  );
});
