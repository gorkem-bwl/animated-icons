...
const StretchHorizontal = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <rect width="20" height="6" x="2" y="4" rx="2" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <rect width="20" height="6" x="2" y="14" rx="2" className="al-secondary al-anim-fade al-delay-1" style={{}} />
      </svg>
    </>
  );
});
