  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-fingerprint ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M12 10a2 2 0 0 0-2 2c0 1.02-.1 2.51-.26 4" className="al-primary al-anim-fade al-delay-0" style={{}} />
