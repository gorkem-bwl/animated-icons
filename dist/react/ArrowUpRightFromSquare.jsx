...
const ArrowUpRightFromSquare = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M21 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h6" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="m21 3-9 9" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M15 3h6v6" className="al-secondary al-anim-fade al-delay-2" style={{}} />
      </svg>
    </>
  );
});
