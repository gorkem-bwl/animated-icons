...
const PhilippinePeso = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M20 11H4" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M20 7H4" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M7 21V4a1 1 0 0 1 1-1h4a1 1 0 0 1 0 12H7" className="al-secondary al-anim-fade al-delay-2" style={{}} />
      </svg>
    </>
  );
});
