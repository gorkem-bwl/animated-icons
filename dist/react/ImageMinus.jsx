...
const ImageMinus = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M21 9v10a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h7" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <line x1="16" x2="22" y1="5" y2="5" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <circle cx="9" cy="9" r="2" className="al-secondary al-anim-fade al-delay-2" style={{}} />
