  ...
  return (
    <>
      ...
      >
        ...
        <path d="M8 8h8" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M8 12h8" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="m13 17-5-1h1a4 4 0 0 0 0-8" className="al-secondary al-anim-fade al-delay-3" style={{}} />
      </svg>
    </>
  );
});
