  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-arrow-up-down ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="m21 16-4 4-4-4" className="al-primary al-anim-nudge al-delay-0" style={{ '--al-tx': '0px', '--al-ty': '1px' }} />
        <path d="M17 20V4" className="al-secondary al-anim-nudge al-delay-1" style={{ '--al-tx': '0px', '--al-ty': '2px' }} />
        <path d="m3 8 4-4 4 4" className="al-secondary al-anim-nudge al-delay-2" style={{ '--al-tx': '0px', '--al-ty': '2px' }} />
        <path d="M7 4v16" className="al-secondary al-anim-nudge al-delay-3" style={{ '--al-tx': '0px', '--al-ty': '2px' }} />
      </svg>
    </>
  );
});
