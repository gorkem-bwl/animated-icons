  ...
  return (
    <>
      ...
      >
        ...
        <path d="m14.5 10 1.5 8" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M7 10h10" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="m8 18 1.5-8" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <circle cx="12" cy="6" r="4" className="al-secondary al-anim-fade al-delay-4" style={{}} />
      </svg>
    </>
  );
});
