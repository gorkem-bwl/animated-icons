...
const ArrowDownToLine = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M12 17V3" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="m6 11 6 6 6-6" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M19 21H5" className="al-secondary al-anim-fade al-delay-2" style={{}} />
      </svg>
    </>
  );
});
