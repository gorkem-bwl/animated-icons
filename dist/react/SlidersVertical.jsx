...
const SlidersVertical = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M10 8h4" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M12 21v-9" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M12 8V3" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M17 16h4" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <path d="M19 12V3" className="al-secondary al-anim-fade al-delay-4" style={{}} />
        <path d="M19 21v-5" className="al-secondary al-anim-fade al-delay-5" style={{}} />
        <path d="M3 14h4" className="al-secondary al-anim-fade al-delay-6" style={{}} />
        <path d="M5 10V3" className="al-secondary al-anim-fade al-delay-7" style={{}} />
        <path d="M5 21v-7" className="al-secondary al-anim-fade al-delay-7" style={{}} />
      </svg>
    </>
  );
});
