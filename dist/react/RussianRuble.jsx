...
const RussianRuble = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M6 11h8a4 4 0 0 0 0-8H9v18" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M6 15h8" className="al-secondary al-anim-fade al-delay-1" style={{}} />
      </svg>
    </>
  );
});
