  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-bar-chart-4 ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M13 17V9" className="al-primary al-anim-bar al-delay-0" style={{}} />
        <path d="M18 17V5" className="al-secondary al-anim-bar al-delay-1" style={{}} />
