...
const PhoneCall = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M13 2a9 9 0 0 1 9 9" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M13 6a5 5 0 0 1 5 5" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M13.832 16.568a1 1 0 0 0 1.213-.303l.355-.465A2 2 0 0 1 17 15h3a2 2 0 0 1 2 2v3a2 2 0 0 1-2 2A18 18 0 0 1 2 4a2 2 0 0 1 2-2h3a2 2 0 0 1 2 2v3a2 2 0 0 1-.8 1.6l-.468.351a1 1 0 0 0-.292 1.233 14 14 0 0 0 6.392 6.384" className="al-secondary al-anim-fade al-delay-2" style={{}} />
      </svg>
    </>
  );
});
