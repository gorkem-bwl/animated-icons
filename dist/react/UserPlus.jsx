  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-user-plus ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        ...
        <circle cx="9" cy="7" r="4" className="al-secondary al-anim-fill al-delay-1" style={{}} />
        <line x1="19" x2="19" y1="8" y2="14" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <line x1="22" x2="16" y1="11" y2="11" className="al-secondary al-anim-fade al-delay-3" style={{}} />
      </svg>
    </>
  );
});
