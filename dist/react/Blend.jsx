  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-blend ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <circle cx="9" cy="9" r="7" className="al-primary al-anim-scale-pop al-delay-0" style={{}} />
        <circle cx="15" cy="15" r="7" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
      </svg>
    </>
  );
});
