...
const PoundSterling = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M18 7c0-5.333-8-5.333-8 0" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M10 7v14" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M6 21h12" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M6 13h10" className="al-secondary al-anim-fade al-delay-3" style={{}} />
      </svg>
    </>
  );
});
