  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-ellipsis-vertical ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        ...
        <circle cx="12" cy="5" r="1" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
        <circle cx="12" cy="19" r="1" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
      </svg>
    </>
  );
});
