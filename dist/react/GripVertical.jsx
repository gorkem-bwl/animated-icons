  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-grip-vertical ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <circle cx="9" cy="12" r="1" className="al-primary al-anim-scale-pop al-delay-0" style={{}} />
        <circle cx="9" cy="5" r="1" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
        <circle cx="9" cy="19" r="1" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
        <circle cx="15" cy="12" r="1" className="al-secondary al-anim-scale-pop al-delay-3" style={{}} />
        <circle cx="15" cy="5" r="1" className="al-secondary al-anim-scale-pop al-delay-4" style={{}} />
        <circle cx="15" cy="19" r="1" className="al-secondary al-anim-scale-pop al-delay-5" style={{}} />
      </svg>
    </>
  );
});
