...
const Battery = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M 22 14 L 22 10" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <rect x="2" y="6" width="16" height="12" rx="2" className="al-secondary al-anim-fade al-delay-1" style={{}} />
      </svg>
    </>
  );
});
