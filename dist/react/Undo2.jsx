...
const Undo2 = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M9 14 4 9l5-5" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M4 9h10.5a5.5 5.5 0 0 1 5.5 5.5a5.5 5.5 0 0 1-5.5 5.5H11" className="al-secondary al-anim-fade al-delay-1" style={{}} />
      </svg>
    </>
  );
});
