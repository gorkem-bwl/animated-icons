...
const Venus = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M12 15v7" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M9 19h6" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <circle cx="12" cy="9" r="6" className="al-secondary al-anim-fade al-delay-2" style={{}} />
      </svg>
    </>
  );
});
