...
const TrendingDown = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M16 17h6v-6" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="m22 17-8.5-8.5-5 5L2 7" className="al-secondary al-anim-fade al-delay-1" style={{}} />
      </svg>
    </>
  );
});
