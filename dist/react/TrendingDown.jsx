  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-trending-down ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M16 17h6v-6" className="al-primary al-anim-nudge al-delay-0" style={{ '--al-tx': '1.5px', '--al-ty': '1.5px' }} />
        <path d="m22 17-8.5-8.5-5 5L2 7" className="al-secondary al-anim-nudge al-delay-1" style={{ '--al-tx': '1.5px', '--al-ty': '1.5px' }} />
      </svg>
    </>
  );
});
