...
const DecimalsArrowRight = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M10 18h10" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="m17 21 3-3-3-3" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M3 11h.01" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <rect x="15" y="3" width="5" height="8" rx="2.5" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <rect x="6" y="3" width="5" height="8" rx="2.5" className="al-secondary al-anim-fade al-delay-4" style={{}} />
      </svg>
    </>
  );
});
