...
const KanbanSquareDashed = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M8 7v7" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M12 7v4" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M16 7v9" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M5 3a2 2 0 0 0-2 2" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <path d="M9 3h1" className="al-secondary al-anim-fade al-delay-4" style={{}} />
        <path d="M14 3h1" className="al-secondary al-anim-fade al-delay-5" style={{}} />
        <path d="M19 3a2 2 0 0 1 2 2" className="al-secondary al-anim-fade al-delay-6" style={{}} />
        <path d="M21 9v1" className="al-secondary al-anim-fade al-delay-7" style={{}} />
        <path d="M21 14v1" className="al-secondary al-anim-fade al-delay-7" style={{}} />
        <path d="M21 19a2 2 0 0 1-2 2" className="al-secondary al-anim-fade al-delay-7" style={{}} />
        <path d="M14 21h1" className="al-secondary al-anim-fade al-delay-7" style={{}} />
        <path d="M9 21h1" className="al-secondary al-anim-fade al-delay-7" style={{}} />
        <path d="M5 21a2 2 0 0 1-2-2" className="al-secondary al-anim-fade al-delay-7" style={{}} />
