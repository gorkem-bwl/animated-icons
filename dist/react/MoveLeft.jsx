  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-move-left ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M6 8L2 12L6 16" className="al-primary al-anim-nudge al-delay-0" style={{ '--al-tx': '-1px', '--al-ty': '0px' }} />
