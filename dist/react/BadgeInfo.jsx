  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-badge-info ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        ...
        <line x1="12" x2="12" y1="16" y2="12" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
        <line x1="12" x2="12.01" y1="8" y2="8" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
      </svg>
    </>
  );
});
