  ...
  return (
    <>
      ...
      >
        ...
        <path d="M3 12h18" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M9 3v18" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <rect x="3" y="3" width="18" height="18" rx="2" className="al-secondary al-anim-fade al-delay-3" style={{}} />
      </svg>
    </>
  );
});
