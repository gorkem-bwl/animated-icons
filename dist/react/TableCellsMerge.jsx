  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-table-cells-merge ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M12 21v-6" className="al-primary al-anim-scale-pop al-delay-0" style={{}} />
        <path d="M12 9V3" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
        <path d="M3 15h18" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
        <path d="M3 9h18" className="al-secondary al-anim-scale-pop al-delay-3" style={{}} />
        <rect width="18" height="18" x="3" y="3" rx="2" className="al-secondary al-anim-scale-pop al-delay-4" style={{}} />
      </svg>
    </>
  );
});
