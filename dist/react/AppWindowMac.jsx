  ...
  return (
    <>
      ...
      >
        ...
        <path d="M6 8h.01" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M10 8h.01" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M14 8h.01" className="al-secondary al-anim-fade al-delay-3" style={{}} />
      </svg>
    </>
  );
});
