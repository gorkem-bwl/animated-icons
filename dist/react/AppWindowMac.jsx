  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-app-window-mac ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        ...
        <path d="M6 8h.01" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
        <path d="M10 8h.01" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
        <path d="M14 8h.01" className="al-secondary al-anim-scale-pop al-delay-3" style={{}} />
      </svg>
    </>
  );
});
