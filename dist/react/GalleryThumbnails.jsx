...
const GalleryThumbnails = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <rect width="18" height="14" x="3" y="3" rx="2" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M4 21h1" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M9 21h1" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M14 21h1" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <path d="M19 21h1" className="al-secondary al-anim-fade al-delay-4" style={{}} />
      </svg>
    </>
  );
});
