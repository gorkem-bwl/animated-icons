...
const TableRowsSplit = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M14 10h2" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M15 22v-8" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M15 2v4" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M2 10h2" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <path d="M20 10h2" className="al-secondary al-anim-fade al-delay-4" style={{}} />
        <path d="M3 19h18" className="al-secondary al-anim-fade al-delay-5" style={{}} />
        <path d="M3 22v-6a2 2 135 0 1 2-2h14a2 2 45 0 1 2 2v6" className="al-secondary al-anim-fade al-delay-6" style={{}} />
        <path d="M3 2v2a2 2 45 0 0 2 2h14a2 2 135 0 0 2-2V2" className="al-secondary al-anim-fade al-delay-7" style={{}} />
        <path d="M8 10h2" className="al-secondary al-anim-fade al-delay-7" style={{}} />
        <path d="M9 22v-8" className="al-secondary al-anim-fade al-delay-7" style={{}} />
        <path d="M9 2v4" className="al-secondary al-anim-fade al-delay-7" style={{}} />
      </svg>
    </>
  );
});
