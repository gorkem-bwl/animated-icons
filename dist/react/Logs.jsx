...
const Logs = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M3 5h1" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M3 12h1" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M3 19h1" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M8 5h1" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <path d="M8 12h1" className="al-secondary al-anim-fade al-delay-4" style={{}} />
        <path d="M8 19h1" className="al-secondary al-anim-fade al-delay-5" style={{}} />
        <path d="M13 5h8" className="al-secondary al-anim-fade al-delay-6" style={{}} />
        <path d="M13 12h8" className="al-secondary al-anim-fade al-delay-7" style={{}} />
        <path d="M13 19h8" className="al-secondary al-anim-fade al-delay-7" style={{}} />
      </svg>
    </>
  );
});
