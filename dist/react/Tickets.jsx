  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-tickets ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="m3.173 8.18 11-5a2 2 0 0 1 2.647.993L18.56 8" className="al-primary al-anim-scale-pop al-delay-0" style={{}} />
        <path d="M6 10V8" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
        <path d="M6 14v1" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
        <path d="M6 19v2" className="al-secondary al-anim-scale-pop al-delay-3" style={{}} />
        <rect x="2" y="8" width="20" height="13" rx="2" className="al-secondary al-anim-scale-pop al-delay-4" style={{}} />
      </svg>
    </>
  );
});
