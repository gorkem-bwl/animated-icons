  ...
  return (
    <>
      ...
      >
        ...
        <rect x="2" y="3" width="20" height="14" rx="2" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <rect x="9" y="7" width="6" height="6" rx="1" className="al-secondary al-anim-fade al-delay-3" style={{}} />
      </svg>
    </>
  );
});
