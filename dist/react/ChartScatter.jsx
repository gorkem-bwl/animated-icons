...
const ChartScatter = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <circle cx="7.5" cy="7.5" r=".5" fill="currentColor" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <circle cx="18.5" cy="5.5" r=".5" fill="currentColor" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <circle cx="11.5" cy="11.5" r=".5" fill="currentColor" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <circle cx="7.5" cy="16.5" r=".5" fill="currentColor" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <circle cx="17.5" cy="14.5" r=".5" fill="currentColor" className="al-secondary al-anim-fade al-delay-4" style={{}} />
        <path d="M3 3v16a2 2 0 0 0 2 2h16" className="al-secondary al-anim-fade al-delay-5" style={{}} />
      </svg>
    </>
  );
});
