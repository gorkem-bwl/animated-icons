  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-folder-git ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <circle cx="12" cy="13" r="2" className="al-primary al-anim-scale-pop al-delay-0" style={{}} />
        <path d="M20 20a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-7.9a2 2 0 0 1-1.69-.9L9.6 3.9A2 2 0 0 0 7.93 3H4a2 2 0 0 0-2 2v13a2 2 0 0 0 2 2Z" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
        <path d="M14 13h3" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
        <path d="M7 13h3" className="al-secondary al-anim-scale-pop al-delay-3" style={{}} />
      </svg>
    </>
  );
});
