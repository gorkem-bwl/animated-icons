  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-screen-share-off ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M13 3H4a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-3" className="al-primary al-anim-scale-pop al-delay-0" style={{}} />
        <path d="M8 21h8" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
        <path d="M12 17v4" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
        <path d="m22 3-5 5" className="al-secondary al-anim-scale-pop al-delay-3" style={{}} />
        <path d="m17 3 5 5" className="al-secondary al-anim-scale-pop al-delay-4" style={{}} />
      </svg>
    </>
  );
});
