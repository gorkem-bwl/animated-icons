...
const GlobeLock = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M15.686 15A14.5 14.5 0 0 1 12 22a14.5 14.5 0 0 1 0-20 10 10 0 1 0 9.542 13" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M2 12h8.5" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M20 6V4a2 2 0 1 0-4 0v2" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <rect width="8" height="5" x="14" y="6" rx="1" className="al-secondary al-anim-fade al-delay-3" style={{}} />
      </svg>
    </>
  );
});
