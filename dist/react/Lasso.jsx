...
const Lasso = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M3.704 14.467a10 8 0 1 1 3.115 2.375" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M7 22a5 5 0 0 1-2-3.994" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <circle cx="5" cy="16" r="2" className="al-secondary al-anim-fade al-delay-2" style={{}} />
      </svg>
    </>
  );
});
