  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-heading ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M6 12h12" className="al-primary al-anim-scale-pop al-delay-0" style={{}} />
        <path d="M6 20V4" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
        <path d="M18 20V4" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
      </svg>
    </>
  );
});
