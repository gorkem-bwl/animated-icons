...
const Heading = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M6 12h12" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M6 20V4" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M18 20V4" className="al-secondary al-anim-fade al-delay-2" style={{}} />
      </svg>
    </>
  );
});
