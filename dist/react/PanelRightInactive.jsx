  ...
  return (
    <>
      ...
      >
        ...
        <path d="M15 14v1" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M15 19v2" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M15 3v2" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <path d="M15 9v1" className="al-secondary al-anim-fade al-delay-4" style={{}} />
      </svg>
    </>
  );
});
