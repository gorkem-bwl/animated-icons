...
const ReceiptCent = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M12 7v10" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M14.828 14.829a4 4 0 0 1-5.656 0 4 4 0 0 1 0-5.657 4 4 0 0 1 5.656 0" className="al-secondary al-anim-fade al-delay-1" style={{}} />
