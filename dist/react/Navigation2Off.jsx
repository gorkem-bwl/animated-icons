...
const Navigation2Off = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M9.31 9.31 5 21l7-4 7 4-1.17-3.17" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M14.53 8.88 12 2l-1.17 3.17" className="al-secondary al-anim-fade al-delay-1" style={{}} />
