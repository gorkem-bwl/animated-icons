  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-boxes ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M2.97 12.92A2 2 0 0 0 2 14.63v3.24a2 2 0 0 0 .97 1.71l3 1.8a2 2 0 0 0 2.06 0L12 19v-5.5l-5-3-4.03 2.42Z" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="m7 16.5-4.74-2.85" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="m7 16.5 5-3" className="al-primary al-anim-fade al-delay-2" style={{}} />
        <path d="M7 16.5v5.17" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <path d="M12 13.5V19l3.97 2.38a2 2 0 0 0 2.06 0l3-1.8a2 2 0 0 0 .97-1.71v-3.24a2 2 0 0 0-.97-1.71L17 10.5l-5 3Z" className="al-primary al-anim-fade al-delay-4" style={{}} />
        <path d="m17 16.5-5-3" className="al-secondary al-anim-fade al-delay-5" style={{}} />
        <path d="m17 16.5 4.74-2.85" className="al-primary al-anim-fade al-delay-6" style={{}} />
        <path d="M17 16.5v5.17" className="al-secondary al-anim-fade al-delay-7" style={{}} />
        <path d="M7.97 4.42A2 2 0 0 0 7 6.13v4.37l5 3 5-3V6.13a2 2 0 0 0-.97-1.71l-3-1.8a2 2 0 0 0-2.06 0l-3 1.8Z" className="al-primary al-anim-fade al-delay-7" style={{}} />
        <path d="M12 8 7.26 5.15" className="al-secondary al-anim-fade al-delay-7" style={{}} />
        <path d="m12 8 4.74-2.85" className="al-primary al-anim-fade al-delay-7" style={{}} />
        <path d="M12 13.5V8" className="al-secondary al-anim-fade al-delay-7" style={{}} />
      </svg>
    </>
  );
});
