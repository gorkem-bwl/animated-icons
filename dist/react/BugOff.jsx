  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-bug-off ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M12 20v-8" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M12.656 7H14a4 4 0 0 1 4 4v1.344" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M14.12 3.88 16 2" className="al-primary al-anim-fade al-delay-2" style={{}} />
        <path d="M17.123 17.123A6 6 0 0 1 6 14v-3a4 4 0 0 1 1.72-3.287" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <path d="m2 2 20 20" className="al-primary al-anim-fade al-delay-4" style={{}} />
        <path d="M21 5a4 4 0 0 1-3.55 3.97" className="al-secondary al-anim-fade al-delay-5" style={{}} />
        <path d="M22 13h-3.344" className="al-primary al-anim-fade al-delay-6" style={{}} />
        <path d="M3 21a4 4 0 0 1 3.81-4" className="al-secondary al-anim-fade al-delay-7" style={{}} />
        <path d="M3 5a4 4 0 0 0 3.55 3.97" className="al-primary al-anim-fade al-delay-7" style={{}} />
        <path d="M6 13H2" className="al-secondary al-anim-fade al-delay-7" style={{}} />
        <path d="m8 2 1.88 1.88" className="al-primary al-anim-fade al-delay-7" style={{}} />
        <path d="M9.712 4.06A3 3 0 0 1 15 6v1.13" className="al-secondary al-anim-fade al-delay-7" style={{}} />
      </svg>
    </>
  );
});
