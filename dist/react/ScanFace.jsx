  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-scan-face ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        ...
        <path d="M21 17v2a2 2 0 0 1-2 2h-2" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M7 21H5a2 2 0 0 1-2-2v-2" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <path d="M8 14s1.5 2 4 2 4-2 4-2" className="al-secondary al-anim-fade al-delay-4" style={{}} />
        <path d="M9 9h.01" className="al-secondary al-anim-fade al-delay-5" style={{}} />
        <path d="M15 9h.01" className="al-secondary al-anim-fade al-delay-6" style={{}} />
      </svg>
    </>
  );
});
