...
const GlobeX = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="m16 3 5 5" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M2 12h20A10 10 0 1 1 12 2a14.5 14.5 0 0 0 0 20 14.5 14.5 0 0 0 4-10" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="m21 3-5 5" className="al-secondary al-anim-fade al-delay-2" style={{}} />
      </svg>
    </>
  );
});
