...
const FileClock = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M16 22h2a2 2 0 0 0 2-2V8a2.4 2.4 0 0 0-.706-1.706l-3.588-3.588A2.4 2.4 0 0 0 14 2H6a2 2 0 0 0-2 2v2.85" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M14 2v5a1 1 0 0 0 1 1h5" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M8 14v2.2l1.6 1" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <circle cx="8" cy="16" r="6" className="al-secondary al-anim-fade al-delay-3" style={{}} />
      </svg>
    </>
  );
});
