...
const AlignVerticalJustifyStart = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <rect width="14" height="6" x="5" y="16" rx="2" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <rect width="10" height="6" x="7" y="6" rx="2" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M2 2h20" className="al-secondary al-anim-fade al-delay-2" style={{}} />
      </svg>
    </>
  );
});
