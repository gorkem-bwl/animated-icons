  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-projector ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M5 7 3 5" className="al-primary al-anim-scale-pop al-delay-0" style={{}} />
        <path d="M9 6V3" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
        <path d="m13 7 2-2" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
        <circle cx="9" cy="13" r="3" className="al-secondary al-anim-scale-pop al-delay-3" style={{}} />
        <path d="M11.83 12H20a2 2 0 0 1 2 2v4a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2v-4a2 2 0 0 1 2-2h2.17" className="al-secondary al-anim-scale-pop al-delay-4" style={{}} />
        <path d="M16 16h2" className="al-secondary al-anim-scale-pop al-delay-5" style={{}} />
      </svg>
    </>
  );
});
