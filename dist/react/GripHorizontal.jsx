  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-grip-horizontal ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <circle cx="12" cy="9" r="1" className="al-primary al-anim-scale-pop al-delay-0" style={{}} />
        <circle cx="19" cy="9" r="1" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
        <circle cx="5" cy="9" r="1" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
        <circle cx="12" cy="15" r="1" className="al-secondary al-anim-scale-pop al-delay-3" style={{}} />
        <circle cx="19" cy="15" r="1" className="al-secondary al-anim-scale-pop al-delay-4" style={{}} />
        <circle cx="5" cy="15" r="1" className="al-secondary al-anim-scale-pop al-delay-5" style={{}} />
      </svg>
    </>
  );
});
