...
const Laptop2 = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <rect width="18" height="12" x="3" y="4" rx="2" ry="2" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <line x1="2" x2="22" y1="20" y2="20" className="al-secondary al-anim-fade al-delay-1" style={{}} />
      </svg>
    </>
  );
});
