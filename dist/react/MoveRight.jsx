  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-move-right ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M18 8L22 12L18 16" className="al-primary al-anim-nudge al-delay-0" style={{ '--al-tx': '1px', '--al-ty': '0px' }} />
        <path d="M2 12H22" className="al-secondary al-anim-nudge al-delay-1" style={{ '--al-tx': '2px', '--al-ty': '0px' }} />
      </svg>
    </>
  );
});
