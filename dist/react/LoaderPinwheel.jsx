...
const LoaderPinwheel = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M22 12a1 1 0 0 1-10 0 1 1 0 0 0-10 0" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M7 20.7a1 1 0 1 1 5-8.7 1 1 0 1 0 5-8.6" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M7 3.3a1 1 0 1 1 5 8.6 1 1 0 1 0 5 8.6" className="al-secondary al-anim-fade al-delay-2" style={{}} />
