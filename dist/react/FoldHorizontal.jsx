...
const FoldHorizontal = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M2 12h6" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M22 12h-6" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        ...
        <path d="m19 9-3 3 3 3" className="al-secondary al-anim-fade al-delay-6" style={{}} />
        <path d="m5 15 3-3-3-3" className="al-secondary al-anim-fade al-delay-7" style={{}} />
      </svg>
    </>
  );
});
