...
const UnfoldVertical = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M12 22v-6" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M12 8V2" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M4 12H2" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M10 12H8" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <path d="M16 12h-2" className="al-secondary al-anim-fade al-delay-4" style={{}} />
        <path d="M22 12h-2" className="al-secondary al-anim-fade al-delay-5" style={{}} />
        <path d="m15 19-3 3-3-3" className="al-secondary al-anim-fade al-delay-6" style={{}} />
        <path d="m15 5-3-3-3 3" className="al-secondary al-anim-fade al-delay-7" style={{}} />
      </svg>
    </>
  );
});
