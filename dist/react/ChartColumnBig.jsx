  ...
  return (
    <>
      ...
      >
        ...
        <rect x="15" y="5" width="4" height="12" rx="1" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <rect x="7" y="8" width="4" height="9" rx="1" className="al-secondary al-anim-fade al-delay-2" style={{}} />
      </svg>
    </>
  );
});
