  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-tornado ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M21 4H3" className="al-primary al-anim-fade al-delay-0" style={{}} />
        <path d="M18 8H6" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M19 12H9" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M16 16h-6" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <path d="M11 20H9" className="al-secondary al-anim-fade al-delay-4" style={{}} />
      </svg>
    </>
  );
});
