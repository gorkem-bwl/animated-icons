...
const RulerDimensionLine = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M10 15v-3" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M14 15v-3" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M18 15v-3" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M2 8V4" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <path d="M22 6H2" className="al-secondary al-anim-fade al-delay-4" style={{}} />
        <path d="M22 8V4" className="al-secondary al-anim-fade al-delay-5" style={{}} />
        <path d="M6 15v-3" className="al-secondary al-anim-fade al-delay-6" style={{}} />
        <rect x="2" y="12" width="20" height="8" rx="2" className="al-secondary al-anim-fade al-delay-7" style={{}} />
      </svg>
    </>
  );
});
