  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-undo ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M3 7v6h6" className="al-primary al-anim-spin al-delay-0" style={{}} />
        <path d="M21 17a9 9 0 0 0-9-9 9 9 0 0 0-6 2.3L3 13" className="al-secondary al-anim-spin al-delay-1" style={{}} />
      </svg>
    </>
  );
});
