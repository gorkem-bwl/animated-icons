  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-menu ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M4 5h16" className="al-primary al-anim-menu-line al-delay-0" style={{ '--al-scale-x': '1' }} />
        <path d="M4 12h16" className="al-secondary al-anim-menu-line al-delay-1" style={{ '--al-scale-x': '0.85' }} />
        <path d="M4 19h16" className="al-primary al-anim-menu-line al-delay-2" style={{ '--al-scale-x': '0.7' }} />
      </svg>
    </>
  );
});
