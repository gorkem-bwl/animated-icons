...
const ChartGantt = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M10 6h8" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M12 16h6" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M3 3v16a2 2 0 0 0 2 2h16" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M8 11h7" className="al-secondary al-anim-fade al-delay-3" style={{}} />
      </svg>
    </>
  );
});
