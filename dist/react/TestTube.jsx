...
const TestTube = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M14.5 2v17.5c0 1.4-1.1 2.5-2.5 2.5c-1.4 0-2.5-1.1-2.5-2.5V2" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M8.5 2h7" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M14.5 16h-5" className="al-secondary al-anim-fade al-delay-2" style={{}} />
      </svg>
    </>
  );
});
