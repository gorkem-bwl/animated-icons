  ...
  return (
    <>
      ...
      >
        ...
        <path d="m16 12-4-4-4 4" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M12 16V8" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M2.5 8.875a10 10 0 0 0-.5 3" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <path d="M2.83 16a10 10 0 0 0 2.43 3.4" className="al-secondary al-anim-fade al-delay-4" style={{}} />
        <path d="M4.636 5.235a10 10 0 0 1 .891-.857" className="al-secondary al-anim-fade al-delay-5" style={{}} />
        <path d="M8.644 21.42a10 10 0 0 0 7.631-.38" className="al-secondary al-anim-fade al-delay-6" style={{}} />
      </svg>
    </>
  );
});
