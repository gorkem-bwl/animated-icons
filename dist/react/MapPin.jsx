  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-map-pin ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        ...
        <circle cx="12" cy="10" r="3" className="al-secondary al-anim-dot-appear al-delay-1" style={{}} />
      </svg>
    </>
  );
});
