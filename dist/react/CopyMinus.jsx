  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-copy-minus ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <line x1="12" x2="18" y1="15" y2="15" className="al-primary al-anim-scale-pop al-delay-0" style={{}} />
