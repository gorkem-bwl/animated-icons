  ...
  return (
    <>
      ...
      >
        ...
        <path d="M10 11v2" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <path d="M8 17h8" className="al-secondary al-anim-fade al-delay-4" style={{}} />
        <path d="M14 16v2" className="al-secondary al-anim-fade al-delay-5" style={{}} />
      </svg>
    </>
  );
});
