  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-accessibility ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <circle cx="16" cy="4" r="1" className="al-primary al-anim-scale-pop al-delay-0" style={{}} />
        <path d="m18 19 1-7-6 1" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
        <path d="m5 8 3-3 5.5 3-2.36 3.5" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
        <path d="M4.24 14.5a5 5 0 0 0 6.88 6" className="al-secondary al-anim-scale-pop al-delay-3" style={{}} />
        <path d="M13.76 17.5a5 5 0 0 0-6.88-6" className="al-secondary al-anim-scale-pop al-delay-4" style={{}} />
      </svg>
    </>
  );
});
