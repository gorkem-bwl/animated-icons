  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-sun ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <circle cx="12" cy="12" r="4" className="al-primary al-anim-gear al-delay-0" style={{ '--al-rotation': '45deg' }} />
        <path d="M12 2v2" className="al-secondary al-anim-fade al-delay-1" style={{ '--al-rotation': '45deg' }} />
        <path d="M12 20v2" className="al-secondary al-anim-fade al-delay-2" style={{ '--al-rotation': '45deg' }} />
        <path d="m4.93 4.93 1.41 1.41" className="al-secondary al-anim-fade al-delay-3" style={{ '--al-rotation': '45deg' }} />
        <path d="m17.66 17.66 1.41 1.41" className="al-secondary al-anim-fade al-delay-4" style={{ '--al-rotation': '45deg' }} />
        <path d="M2 12h2" className="al-secondary al-anim-fade al-delay-5" style={{ '--al-rotation': '45deg' }} />
        <path d="M20 12h2" className="al-secondary al-anim-fade al-delay-6" style={{ '--al-rotation': '45deg' }} />
        <path d="m6.34 17.66-1.41 1.41" className="al-secondary al-anim-fade al-delay-7" style={{ '--al-rotation': '45deg' }} />
        <path d="m19.07 4.93-1.41 1.41" className="al-secondary al-anim-fade al-delay-7" style={{ '--al-rotation': '45deg' }} />
      </svg>
    </>
  );
});
