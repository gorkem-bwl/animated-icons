  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-layout-template ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        ...
        <rect width="9" height="7" x="3" y="14" rx="1" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
        <rect width="5" height="7" x="16" y="14" rx="1" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
      </svg>
    </>
  );
});
