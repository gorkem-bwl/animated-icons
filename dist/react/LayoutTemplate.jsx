  ...
  return (
    <>
      ...
      >
        ...
        <rect width="9" height="7" x="3" y="14" rx="1" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <rect width="5" height="7" x="16" y="14" rx="1" className="al-secondary al-anim-fade al-delay-2" style={{}} />
      </svg>
    </>
  );
});
