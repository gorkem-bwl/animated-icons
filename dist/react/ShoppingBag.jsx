  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-shopping-bag ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M16 10a4 4 0 0 1-8 0" className="al-primary al-anim-shake al-delay-0" style={{}} />
        <path d="M3.103 6.034h17.794" className="al-secondary al-anim-shake al-delay-1" style={{}} />
        <path d="M3.4 5.467a2 2 0 0 0-.4 1.2V20a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6.667a2 2 0 0 0-.4-1.2l-2-2.667A2 2 0 0 0 17 2H7a2 2 0 0 0-1.6.8z" className="al-secondary al-anim-shake al-delay-2" style={{}} />
      </svg>
    </>
  );
});
