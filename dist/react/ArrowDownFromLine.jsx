...
const ArrowDownFromLine = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M19 3H5" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M12 21V7" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="m6 15 6 6 6-6" className="al-secondary al-anim-fade al-delay-2" style={{}} />
      </svg>
    </>
  );
});
