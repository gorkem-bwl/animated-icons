  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-align-horizontal-justify-center ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <rect width="6" height="14" x="2" y="5" rx="2" className="al-primary al-anim-scale-pop al-delay-0" style={{}} />
        <rect width="6" height="10" x="16" y="7" rx="2" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
        <path d="M12 2v20" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
      </svg>
    </>
  );
});
