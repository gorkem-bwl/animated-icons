  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-mail-question ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M22 10.5V6a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2v12c0 1.1.9 2 2 2h12.5" className="al-primary al-anim-mail-flap al-delay-0" style={{}} />
        <path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7" className="al-secondary al-anim-fill al-delay-1" style={{}} />
        <path d="M18 15.28c.2-.4.5-.8.9-1a2.1 2.1 0 0 1 2.6.4c.3.4.5.8.5 1.3 0 1.3-2 2-2 2" className="al-secondary al-anim-fill al-delay-2" style={{}} />
        <path d="M20 22v.01" className="al-secondary al-anim-fill al-delay-3" style={{}} />
      </svg>
    </>
  );
});
