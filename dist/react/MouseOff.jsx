...
const MouseOff = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M12 6v.343" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M18.218 18.218A7 7 0 0 1 5 15V9a7 7 0 0 1 .782-3.218" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M19 13.343V9A7 7 0 0 0 8.56 2.902" className="al-secondary al-anim-fade al-delay-2" style={{}} />
