...
const Unplug = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="m19 5 3-3" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="m2 22 3-3" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M6.3 20.3a2.4 2.4 0 0 0 3.4 0L12 18l-6-6-2.3 2.3a2.4 2.4 0 0 0 0 3.4Z" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M7.5 13.5 10 11" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <path d="M10.5 16.5 13 14" className="al-secondary al-anim-fade al-delay-4" style={{}} />
        <path d="m12 6 6 6 2.3-2.3a2.4 2.4 0 0 0 0-3.4l-2.6-2.6a2.4 2.4 0 0 0-3.4 0Z" className="al-secondary al-anim-fade al-delay-5" style={{}} />
      </svg>
    </>
  );
});
