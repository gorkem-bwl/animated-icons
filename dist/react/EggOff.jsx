  ...
  return (
    <>
      ...
      >
        ...
        <path d="M20 14.347V14c0-6-4-12-8-12-1.078 0-2.157.436-3.157 1.19" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M6.206 6.21C4.871 8.4 4 11.2 4 14a8 8 0 0 0 14.568 4.568" className="al-secondary al-anim-fade al-delay-2" style={{}} />
      </svg>
    </>
  );
});
