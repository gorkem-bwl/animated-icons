...
const GeorgianLari = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M11.5 21a7.5 7.5 0 1 1 7.35-9" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M13 12V3" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M4 21h16" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M9 12V3" className="al-secondary al-anim-fade al-delay-3" style={{}} />
      </svg>
    </>
  );
});
