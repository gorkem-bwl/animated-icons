  ...
  return (
    <>
      ...
      >
        ...
        <path d="M21 13V6a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h8" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M3 10h18" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <path d="m17 22 5-5" className="al-secondary al-anim-fade al-delay-4" style={{}} />
        <path d="m17 17 5 5" className="al-secondary al-anim-fade al-delay-5" style={{}} />
      </svg>
    </>
  );
});
