...
const LayoutList = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <rect width="7" height="7" x="3" y="3" rx="1" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <rect width="7" height="7" x="3" y="14" rx="1" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M14 4h7" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M14 9h7" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <path d="M14 15h7" className="al-secondary al-anim-fade al-delay-4" style={{}} />
        <path d="M14 20h7" className="al-secondary al-anim-fade al-delay-5" style={{}} />
      </svg>
    </>
  );
});
