...
const ArrowUpLeftFromSquare = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M13 3h6a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-6" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="m3 3 9 9" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M3 9V3h6" className="al-secondary al-anim-fade al-delay-2" style={{}} />
      </svg>
    </>
  );
});
