  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-gallery-vertical ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M3 2h18" className="al-primary al-anim-scale-pop al-delay-0" style={{}} />
        <rect width="18" height="12" x="3" y="6" rx="2" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
        <path d="M3 22h18" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
      </svg>
    </>
  );
});
