  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-switch-camera ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M11 19H4a2 2 0 0 1-2-2V7a2 2 0 0 1 2-2h5" className="al-primary al-anim-scale-pop al-delay-0" style={{}} />
        <path d="M13 5h7a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2h-5" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
        <circle cx="12" cy="12" r="3" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
        <path d="m18 22-3-3 3-3" className="al-secondary al-anim-scale-pop al-delay-3" style={{}} />
        <path d="m6 2 3 3-3 3" className="al-secondary al-anim-scale-pop al-delay-4" style={{}} />
      </svg>
    </>
  );
});
