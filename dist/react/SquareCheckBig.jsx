...
const SquareCheckBig = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M21 10.656V19a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h12.344" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="m9 11 3 3L22 4" className="al-secondary al-anim-fade al-delay-1" style={{}} />
      </svg>
    </>
  );
});
