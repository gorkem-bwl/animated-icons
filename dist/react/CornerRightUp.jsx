...
const CornerRightUp = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="m10 9 5-5 5 5" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M4 20h7a4 4 0 0 0 4-4V4" className="al-secondary al-anim-fade al-delay-1" style={{}} />
      </svg>
    </>
  );
});
