  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-mail-x ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M22 13V6a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2v12c0 1.1.9 2 2 2h9" className="al-primary al-anim-mail-flap al-delay-0" style={{}} />
        <path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7" className="al-secondary al-anim-fill al-delay-1" style={{}} />
        <path d="m17 17 4 4" className="al-secondary al-anim-fill al-delay-2" style={{}} />
        <path d="m21 17-4 4" className="al-secondary al-anim-fill al-delay-3" style={{}} />
      </svg>
    </>
  );
});
