  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-rows-4 ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        ...
        <path d="M21 7.5H3" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
        <path d="M21 12H3" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
        <path d="M21 16.5H3" className="al-secondary al-anim-scale-pop al-delay-3" style={{}} />
      </svg>
    </>
  );
});
