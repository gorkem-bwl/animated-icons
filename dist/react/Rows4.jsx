  ...
  return (
    <>
      ...
      >
        ...
        <path d="M21 7.5H3" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M21 12H3" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M21 16.5H3" className="al-secondary al-anim-fade al-delay-3" style={{}} />
      </svg>
    </>
  );
});
