  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-id-card ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M16 10h2" className="al-primary al-anim-scale-pop al-delay-0" style={{}} />
        <path d="M16 14h2" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
        <path d="M6.17 15a3 3 0 0 1 5.66 0" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
        <circle cx="9" cy="11" r="2" className="al-secondary al-anim-scale-pop al-delay-3" style={{}} />
