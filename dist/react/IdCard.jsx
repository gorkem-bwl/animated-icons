...
const IdCard = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M16 10h2" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M16 14h2" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M6.17 15a3 3 0 0 1 5.66 0" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <circle cx="9" cy="11" r="2" className="al-secondary al-anim-fade al-delay-3" style={{}} />
