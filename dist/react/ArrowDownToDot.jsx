...
const ArrowDownToDot = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M12 2v14" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="m19 9-7 7-7-7" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <circle cx="12" cy="21" r="1" className="al-secondary al-anim-fade al-delay-2" style={{}} />
      </svg>
    </>
  );
});
