  ...
  return (
    <>
      ...
      >
        ...
        <circle cx="9" cy="9" r="2" className="al-secondary al-anim-fill al-delay-1" style={{}} />
        <path d="m21 15-3.086-3.086a2 2 0 0 0-2.828 0L6 21" className="al-secondary al-anim-fill al-delay-2" style={{}} />
      </svg>
    </>
  );
});
