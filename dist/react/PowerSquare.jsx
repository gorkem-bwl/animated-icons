  ...
  return (
    <>
      ...
      >
        ...
        <path d="M7.998 9.003a5 5 0 1 0 8-.005" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <rect x="3" y="3" width="18" height="18" rx="2" className="al-secondary al-anim-fade al-delay-2" style={{}} />
      </svg>
    </>
  );
});
