...
const CloudAlert = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M12 12v4" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M12 20h.01" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M8.128 16.949A7 7 0 1 1 15.71 8h1.79a1 1 0 0 1 0 9h-1.642" className="al-secondary al-anim-fade al-delay-2" style={{}} />
      </svg>
    </>
  );
});
