  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-tram-front ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <rect width="16" height="16" x="4" y="3" rx="2" className="al-primary al-anim-scale-pop al-delay-0" style={{}} />
        <path d="M4 11h16" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
        <path d="M12 3v8" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
        <path d="m8 19-2 3" className="al-secondary al-anim-scale-pop al-delay-3" style={{}} />
        <path d="m18 22-2-3" className="al-secondary al-anim-scale-pop al-delay-4" style={{}} />
