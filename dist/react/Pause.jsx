...
const Pause = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <rect x="14" y="3" width="5" height="18" rx="1" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <rect x="5" y="3" width="5" height="18" rx="1" className="al-secondary al-anim-fill al-delay-1" style={{}} />
      </svg>
    </>
  );
});
