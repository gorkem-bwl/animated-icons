...
const FlipVertical2 = forwardRef(({
  size = 24,
  color = 'currentColor',
  primaryColor,
  secondaryColor,
  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-flip-vertical-2 ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="m17 3-5 5-5-5h10" className="al-primary al-anim-scale-pop al-delay-0" style={{}} />
        <path d="m17 21-5-5-5 5h10" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
