...
const FlipVertical2 = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="m17 3-5 5-5-5h10" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="m17 21-5-5-5 5h10" className="al-secondary al-anim-fade al-delay-1" style={{}} />
