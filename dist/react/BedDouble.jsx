...
const BedDouble = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M2 20v-8a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v8" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M4 10V6a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v4" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M12 4v6" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M2 18h20" className="al-secondary al-anim-fade al-delay-3" style={{}} />
      </svg>
    </>
  );
});
