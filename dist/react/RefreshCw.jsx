  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-refresh-cw ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M3 12a9 9 0 0 1 9-9 9.75 9.75 0 0 1 6.74 2.74L21 8" className="al-primary al-anim-spin al-delay-0" style={{}} />
        <path d="M21 3v5h-5" className="al-secondary al-anim-spin al-delay-1" style={{}} />
        <path d="M21 12a9 9 0 0 1-9 9 9.75 9.75 0 0 1-6.74-2.74L3 16" className="al-secondary al-anim-spin al-delay-2" style={{}} />
        <path d="M8 16H3v5" className="al-secondary al-anim-spin al-delay-3" style={{}} />
      </svg>
    </>
  );
});
