...
const CaseSensitive = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="m2 16 4.039-9.69a.5.5 0 0 1 .923 0L11 16" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M22 9v7" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M3.304 13h6.392" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <circle cx="18.5" cy="12.5" r="3.5" className="al-secondary al-anim-fade al-delay-3" style={{}} />
      </svg>
    </>
  );
});
