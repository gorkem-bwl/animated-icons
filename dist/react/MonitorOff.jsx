  ...
  return (
    <>
      ...
      >
        ...
        <path d="M17 17H4a2 2 0 0 1-2-2V5a2 2 0 0 1 1.184-1.826" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="m2 2 20 20" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M8 21h8" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <path d="M8.656 3H20a2 2 0 0 1 2 2v10a2 2 0 0 1-.293 1.042" className="al-secondary al-anim-fade al-delay-4" style={{}} />
      </svg>
    </>
  );
});
