...
const BrainCog = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="m10.852 14.772-.383.923" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="m10.852 9.228-.383-.923" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="m13.148 14.772.382.924" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="m13.531 8.305-.383.923" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <path d="m14.772 10.852.923-.383" className="al-secondary al-anim-fade al-delay-4" style={{}} />
        <path d="m14.772 13.148.923.383" className="al-secondary al-anim-fade al-delay-5" style={{}} />
        <path d="M17.598 6.5A3 3 0 1 0 12 5a3 3 0 0 0-5.63-1.446 3 3 0 0 0-.368 1.571 4 4 0 0 0-2.525 5.771" className="al-secondary al-anim-fade al-delay-6" style={{}} />
        <path d="M17.998 5.125a4 4 0 0 1 2.525 5.771" className="al-secondary al-anim-fade al-delay-7" style={{}} />
        <path d="M19.505 10.294a4 4 0 0 1-1.5 7.706" className="al-secondary al-anim-fade al-delay-7" style={{}} />
        <path d="M4.032 17.483A4 4 0 0 0 11.464 20c.18-.311.892-.311 1.072 0a4 4 0 0 0 7.432-2.516" className="al-secondary al-anim-fade al-delay-7" style={{}} />
        <path d="M4.5 10.291A4 4 0 0 0 6 18" className="al-secondary al-anim-fade al-delay-7" style={{}} />
        <path d="M6.002 5.125a3 3 0 0 0 .4 1.375" className="al-secondary al-anim-fade al-delay-7" style={{}} />
        <path d="m9.228 10.852-.923-.383" className="al-secondary al-anim-fade al-delay-7" style={{}} />
        <path d="m9.228 13.148-.923.383" className="al-secondary al-anim-fade al-delay-7" style={{}} />
        <circle cx="12" cy="12" r="3" className="al-secondary al-anim-fade al-delay-7" style={{}} />
      </svg>
    </>
  );
});
