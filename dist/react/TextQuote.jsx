...
const TextQuote = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M17 5H3" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M21 12H8" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M21 19H8" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M3 12v7" className="al-secondary al-anim-fade al-delay-3" style={{}} />
      </svg>
    </>
  );
});
