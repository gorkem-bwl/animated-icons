  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-webcam ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <circle cx="12" cy="10" r="8" className="al-primary al-anim-scale-pop al-delay-0" style={{}} />
        <circle cx="12" cy="10" r="3" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
        <path d="M7 22h10" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
        <path d="M12 22v-4" className="al-secondary al-anim-scale-pop al-delay-3" style={{}} />
      </svg>
    </>
  );
});
