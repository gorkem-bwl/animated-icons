  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-arrow-down-a-z ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="m3 16 4 4 4-4" className="al-primary al-anim-scale-pop al-delay-0" style={{}} />
        <path d="M7 20V4" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
        <path d="M20 8h-5" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
        <path d="M15 10V6.5a2.5 2.5 0 0 1 5 0V10" className="al-secondary al-anim-scale-pop al-delay-3" style={{}} />
        <path d="M15 14h5l-5 6h5" className="al-secondary al-anim-scale-pop al-delay-4" style={{}} />
      </svg>
    </>
  );
});
