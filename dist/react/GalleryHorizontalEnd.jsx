  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-gallery-horizontal-end ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M2 7v10" className="al-primary al-anim-scale-pop al-delay-0" style={{}} />
        <path d="M6 5v14" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
        <rect width="12" height="18" x="10" y="3" rx="2" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
      </svg>
    </>
  );
});
