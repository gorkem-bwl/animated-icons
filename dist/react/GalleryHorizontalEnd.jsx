...
const GalleryHorizontalEnd = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M2 7v10" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M6 5v14" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <rect width="12" height="18" x="10" y="3" rx="2" className="al-secondary al-anim-fade al-delay-2" style={{}} />
      </svg>
    </>
  );
});
