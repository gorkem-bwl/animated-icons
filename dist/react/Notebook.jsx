  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-notebook ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        ...
        <path d="M2 10h4" className="al-secondary al-anim-page-turn al-delay-1" style={{}} />
        <path d="M2 14h4" className="al-secondary al-anim-page-turn al-delay-2" style={{}} />
        <path d="M2 18h4" className="al-secondary al-anim-page-turn al-delay-3" style={{}} />
        <rect width="16" height="20" x="4" y="2" rx="2" className="al-secondary al-anim-page-turn al-delay-4" style={{}} />
        <path d="M16 2v20" className="al-secondary al-anim-page-turn al-delay-5" style={{}} />
      </svg>
    </>
  );
});
