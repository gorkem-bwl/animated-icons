  ...
  return (
    <>
      ...
      >
        ...
        <path d="M10 15h4" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M10 9h4" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M12 7v4" className="al-secondary al-anim-fade al-delay-3" style={{}} />
      </svg>
    </>
  );
});
