...
const Barcode = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M3 5v14" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M8 5v14" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M12 5v14" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M17 5v14" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <path d="M21 5v14" className="al-secondary al-anim-fade al-delay-4" style={{}} />
      </svg>
    </>
  );
});
