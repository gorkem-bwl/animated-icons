...
const BotMessageSquare = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M12 6V2H8" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M15 11v2" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M2 12h2" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M20 12h2" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <path d="M20 16a2 2 0 0 1-2 2H8.828a2 2 0 0 0-1.414.586l-2.202 2.202A.71.71 0 0 1 4 20.286V8a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2z" className="al-secondary al-anim-fade al-delay-4" style={{}} />
        <path d="M9 11v2" className="al-secondary al-anim-fade al-delay-5" style={{}} />
      </svg>
    </>
  );
});
