...
const Balloon = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M12 16v1a2 2 0 0 0 2 2h1a2 2 0 0 1 2 2v1" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M12 6a2 2 0 0 1 2 2" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M18 8c0 4-3.5 8-6 8s-6-4-6-8a6 6 0 0 1 12 0" className="al-secondary al-anim-fade al-delay-2" style={{}} />
      </svg>
    </>
  );
});
