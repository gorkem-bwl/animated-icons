...
const UserX2 = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M2 21a8 8 0 0 1 11.873-7" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <circle cx="10" cy="8" r="5" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="m17 17 5 5" className="al-secondary al-anim-fade al-delay-2" style={{}} />
