  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-laptop-minimal-check ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M2 20h20" className="al-primary al-anim-scale-pop al-delay-0" style={{}} />
        <path d="m9 10 2 2 4-4" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
        <rect x="3" y="4" width="18" height="12" rx="2" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
      </svg>
    </>
  );
});
