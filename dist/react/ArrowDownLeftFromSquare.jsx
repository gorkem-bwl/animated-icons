...
const ArrowDownLeftFromSquare = forwardRef(({
  size = 24,
  color = 'currentColor',
  primaryColor,
  secondaryColor,
  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-arrow-down-left-from-square ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M13 21h6a2 2 0 0 0 2-2V5a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v6" className="al-primary al-anim-scale-pop al-delay-0" style={{}} />
        <path d="m3 21 9-9" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
        <path d="M9 21H3v-6" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
      </svg>
    </>
  );
});

ArrowDownLeftFromSquare.displayName = 'ArrowDownLeftFromSquare';
