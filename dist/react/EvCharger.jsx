...
const EvCharger = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M14 13h2a2 2 0 0 1 2 2v2a2 2 0 0 0 4 0v-6.998a2 2 0 0 0-.59-1.42L18 5" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M14 21V5a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v16" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M2 21h13" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M3 7h11" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <path d="m9 11-2 3h3l-2 3" className="al-secondary al-anim-fade al-delay-4" style={{}} />
      </svg>
    </>
  );
});
