  ...
  return (
    <>
      ...
      >
        ...
        <path d="M8 15h.01" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M11.5 13.5a2.5 2.5 0 0 1 0 3" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <path d="M15 12a5 5 0 0 1 0 6" className="al-secondary al-anim-fade al-delay-4" style={{}} />
      </svg>
    </>
  );
});
