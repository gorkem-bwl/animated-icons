...
const AlignCenterHorizontal = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M2 12h20" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M10 16v4a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2v-4" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M10 8V4a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2v4" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M20 16v1a2 2 0 0 1-2 2h-2a2 2 0 0 1-2-2v-1" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <path d="M14 8V7c0-1.1.9-2 2-2h2a2 2 0 0 1 2 2v1" className="al-secondary al-anim-fade al-delay-4" style={{}} />
      </svg>
    </>
  );
});
