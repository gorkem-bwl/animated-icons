...
const IterationCcw = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="m16 14 4 4-4 4" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M20 10a8 8 0 1 0-8 8h8" className="al-secondary al-anim-fade al-delay-1" style={{}} />
      </svg>
    </>
  );
});
