...
const DraftingCompass = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="m12.99 6.74 1.93 3.44" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M19.136 12a10 10 0 0 1-14.271 0" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="m21 21-2.16-3.84" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="m3 21 8.02-14.26" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <circle cx="12" cy="5" r="2" className="al-secondary al-anim-fade al-delay-4" style={{}} />
      </svg>
    </>
  );
});
