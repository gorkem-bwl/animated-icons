...
const Ungroup = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <rect width="8" height="6" x="5" y="4" rx="1" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <rect width="8" height="6" x="11" y="14" rx="1" className="al-secondary al-anim-fade al-delay-1" style={{}} />
      </svg>
    </>
  );
});
