  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-layout-panel-left ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <rect width="7" height="18" x="3" y="3" rx="1" className="al-primary al-anim-scale-pop al-delay-0" style={{}} />
