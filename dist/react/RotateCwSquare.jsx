...
const RotateCwSquare = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M12 5H6a2 2 0 0 0-2 2v3" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="m9 8 3-3-3-3" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M4 14v4a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-2" className="al-secondary al-anim-fade al-delay-2" style={{}} />
      </svg>
    </>
  );
});
