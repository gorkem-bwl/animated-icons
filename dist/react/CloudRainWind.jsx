  ...
  return (
    <>
      ...
      >
        ...
        <path d="m9.2 22 3-7" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="m9 13-3 7" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="m17 13-3 7" className="al-secondary al-anim-fade al-delay-3" style={{}} />
      </svg>
    </>
  );
});
