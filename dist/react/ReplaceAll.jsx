...
const ReplaceAll = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M14 14a1 1 0 0 1 1 1v5a1 1 0 0 1-1 1" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M14 4a1 1 0 0 1 1-1" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M15 10a1 1 0 0 1-1-1" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M19 14a1 1 0 0 1 1 1v5a1 1 0 0 1-1 1" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <path d="M21 4a1 1 0 0 0-1-1" className="al-secondary al-anim-fade al-delay-4" style={{}} />
        <path d="M21 9a1 1 0 0 1-1 1" className="al-secondary al-anim-fade al-delay-5" style={{}} />
        <path d="m3 7 3 3 3-3" className="al-secondary al-anim-fade al-delay-6" style={{}} />
        <path d="M6 10V5a2 2 0 0 1 2-2h2" className="al-secondary al-anim-fade al-delay-7" style={{}} />
        <rect x="3" y="14" width="7" height="7" rx="1" className="al-secondary al-anim-fade al-delay-7" style={{}} />
      </svg>
    </>
  );
});
