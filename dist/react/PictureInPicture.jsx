...
const PictureInPicture = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M2 10h6V4" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="m2 4 6 6" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M21 10V7a2 2 0 0 0-2-2h-7" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M3 14v2a2 2 0 0 0 2 2h3" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <rect x="12" y="14" width="10" height="7" rx="1" className="al-secondary al-anim-fade al-delay-4" style={{}} />
      </svg>
    </>
  );
});
