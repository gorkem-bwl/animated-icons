...
const RadioReceiver = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M5 16v2" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M19 16v2" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <rect width="20" height="8" x="2" y="8" rx="2" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M18 12h.01" className="al-secondary al-anim-fade al-delay-3" style={{}} />
      </svg>
    </>
  );
});
