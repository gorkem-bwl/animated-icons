  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-binary ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <rect x="14" y="14" width="4" height="6" rx="2" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <rect x="6" y="4" width="4" height="6" rx="2" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M6 20h4" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M14 10h4" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <path d="M6 14h2v6" className="al-secondary al-anim-fade al-delay-4" style={{}} />
        <path d="M14 4h2v6" className="al-secondary al-anim-fade al-delay-5" style={{}} />
      </svg>
    </>
  );
});
