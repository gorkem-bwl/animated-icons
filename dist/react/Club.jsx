...
const Club = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M17.28 9.05a5.5 5.5 0 1 0-10.56 0A5.5 5.5 0 1 0 12 17.66a5.5 5.5 0 1 0 5.28-8.6Z" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M12 17.66L12 22" className="al-secondary al-anim-fade al-delay-1" style={{}} />
      </svg>
    </>
  );
});
