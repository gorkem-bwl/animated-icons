...
const GalleryHorizontal = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M2 3v18" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <rect width="12" height="18" x="6" y="3" rx="2" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M22 3v18" className="al-secondary al-anim-fade al-delay-2" style={{}} />
      </svg>
    </>
  );
});
