...
const Diameter = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <circle cx="19" cy="19" r="2" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <circle cx="5" cy="5" r="2" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M6.48 3.66a10 10 0 0 1 13.86 13.86" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="m6.41 6.41 11.18 11.18" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <path d="M3.66 6.48a10 10 0 0 0 13.86 13.86" className="al-secondary al-anim-fade al-delay-4" style={{}} />
      </svg>
    </>
  );
});
