  ...
  return (
    <>
      ...
      >
        ...
        <path d="M8 8h.01" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M8 16h.01" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <path d="M16 16h.01" className="al-secondary al-anim-fade al-delay-4" style={{}} />
        <path d="M12 12h.01" className="al-secondary al-anim-fade al-delay-5" style={{}} />
      </svg>
    </>
  );
});
