  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-bookmark-plus ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        ...
        <path d="M15 10H9" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
        <path d="M17 3a2 2 0 0 1 2 2v15a1 1 0 0 1-1.496.868l-4.512-2.578a2 2 0 0 0-1.984 0l-4.512 2.578A1 1 0 0 1 5 20V5a2 2 0 0 1 2-2z" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
      </svg>
    </>
  );
});
