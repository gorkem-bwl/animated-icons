  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-user-minus ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        ...
        <line x1="22" x2="16" y1="11" y2="11" className="al-secondary al-anim-fade al-delay-2" style={{}} />
      </svg>
    </>
  );
});
