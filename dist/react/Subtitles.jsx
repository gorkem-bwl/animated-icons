...
const Subtitles = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <rect width="18" height="14" x="3" y="5" rx="2" ry="2" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M7 15h4M15 15h2M7 11h2M13 11h4" className="al-secondary al-anim-fade al-delay-1" style={{}} />
      </svg>
    </>
  );
});
