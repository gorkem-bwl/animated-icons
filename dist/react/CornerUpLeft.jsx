  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-corner-up-left ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M20 20v-7a4 4 0 0 0-4-4H4" className="al-primary al-anim-nudge al-delay-0" style={{ '--al-tx': '-1px', '--al-ty': '-1px' }} />
        <path d="M9 14 4 9l5-5" className="al-secondary al-anim-nudge al-delay-1" style={{ '--al-tx': '-2px', '--al-ty': '-2px' }} />
      </svg>
    </>
  );
});
