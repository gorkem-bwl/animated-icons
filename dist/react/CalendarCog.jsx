  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-calendar-cog ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="m15.228 16.852-.923-.383" className="al-primary al-anim-gear al-delay-0" style={{ '--al-rotation': '90deg' }} />
        <path d="m15.228 19.148-.923.383" className="al-secondary al-anim-gear al-delay-1" style={{ '--al-rotation': '90deg' }} />
        <path d="M16 2v4" className="al-secondary al-anim-gear al-delay-2" style={{ '--al-rotation': '90deg' }} />
        <path d="m16.47 14.305.382.923" className="al-secondary al-anim-gear al-delay-3" style={{ '--al-rotation': '90deg' }} />
        <path d="m16.852 20.772-.383.924" className="al-secondary al-anim-gear al-delay-4" style={{ '--al-rotation': '90deg' }} />
        <path d="m19.148 15.228.383-.923" className="al-secondary al-anim-gear al-delay-5" style={{ '--al-rotation': '90deg' }} />
        <path d="m19.53 21.696-.382-.924" className="al-secondary al-anim-gear al-delay-6" style={{ '--al-rotation': '90deg' }} />
        <path d="m20.772 16.852.924-.383" className="al-secondary al-anim-gear al-delay-7" style={{ '--al-rotation': '90deg' }} />
        <path d="m20.772 19.148.924.383" className="al-secondary al-anim-gear al-delay-7" style={{ '--al-rotation': '90deg' }} />
        <path d="M21 10.592V6a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h6" className="al-secondary al-anim-gear al-delay-7" style={{ '--al-rotation': '90deg' }} />
        <path d="M3 10h18" className="al-secondary al-anim-gear al-delay-7" style={{ '--al-rotation': '90deg' }} />
        <path d="M8 2v4" className="al-secondary al-anim-gear al-delay-7" style={{ '--al-rotation': '90deg' }} />
