  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-user-cog-2 ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        ...
        <path d="M2 21a8 8 0 0 1 10.434-7.62" className="al-secondary al-anim-scale-pop al-delay-6" style={{}} />
        ...
        <circle cx="10" cy="8" r="5" className="al-secondary al-anim-scale-pop al-delay-7" style={{}} />
