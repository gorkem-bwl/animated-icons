  ...
  return (
    <>
      ...
      >
        ...
        <rect width="6" height="10" x="12" y="7" rx="2" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M22 2v20" className="al-secondary al-anim-fade al-delay-2" style={{}} />
      </svg>
    </>
  );
});
