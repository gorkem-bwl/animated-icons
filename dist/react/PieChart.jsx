  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-pie-chart ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M21 12c.552 0 1.005-.449.95-.998a10 10 0 0 0-8.953-8.951c-.55-.055-.998.398-.998.95v8a1 1 0 0 0 1 1z" className="al-primary al-anim-gear al-delay-0" style={{ '--al-rotation': '45deg' }} />
        <path d="M21.21 15.89A10 10 0 1 1 8 2.83" className="al-secondary al-anim-fade al-delay-1" style={{ '--al-rotation': '45deg' }} />
      </svg>
    </>
  );
});
