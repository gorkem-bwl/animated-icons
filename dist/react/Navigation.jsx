  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-navigation ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <polygon points="3 11 22 2 13 21 11 13 3 11" className="al-primary al-anim-rocket-lift al-delay-0" style={{}} />
      </svg>
    </>
  );
});
