...
const BetweenHorizonalStart = forwardRef(({
  size = 24,
  color = 'currentColor',
  primaryColor,
  secondaryColor,
  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-between-horizonal-start ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <rect width="13" height="7" x="8" y="3" rx="1" className="al-primary al-anim-scale-pop al-delay-0" style={{}} />
        <path d="m2 9 3 3-3 3" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
        <rect width="13" height="7" x="8" y="14" rx="1" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
      </svg>
    </>
  );
});
