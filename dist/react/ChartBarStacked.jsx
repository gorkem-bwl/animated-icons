  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-chart-bar-stacked ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M11 13v4" className="al-primary al-anim-scale-pop al-delay-0" style={{}} />
        <path d="M15 5v4" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
        <path d="M3 3v16a2 2 0 0 0 2 2h16" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
        <rect x="7" y="13" width="9" height="4" rx="1" className="al-secondary al-anim-scale-pop al-delay-3" style={{}} />
        <rect x="7" y="5" width="12" height="4" rx="1" className="al-secondary al-anim-scale-pop al-delay-4" style={{}} />
      </svg>
    </>
  );
});
