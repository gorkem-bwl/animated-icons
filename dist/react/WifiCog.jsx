  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-wifi-cog ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="m14.305 19.53.923-.382" className="al-primary al-anim-gear al-delay-0" style={{ '--al-rotation': '90deg' }} />
        <path d="m15.228 16.852-.923-.383" className="al-secondary al-anim-gear al-delay-1" style={{ '--al-rotation': '90deg' }} />
        <path d="m16.852 15.228-.383-.923" className="al-secondary al-anim-gear al-delay-2" style={{ '--al-rotation': '90deg' }} />
        <path d="m16.852 20.772-.383.924" className="al-secondary al-anim-gear al-delay-3" style={{ '--al-rotation': '90deg' }} />
        <path d="m19.148 15.228.383-.923" className="al-secondary al-anim-gear al-delay-4" style={{ '--al-rotation': '90deg' }} />
        <path d="m19.53 21.696-.382-.924" className="al-secondary al-anim-gear al-delay-5" style={{ '--al-rotation': '90deg' }} />
        <path d="M2 7.82a15 15 0 0 1 20 0" className="al-secondary al-anim-gear al-delay-6" style={{ '--al-rotation': '90deg' }} />
        ...
        <path d="M5 11.858a10 10 0 0 1 11.5-1.785" className="al-secondary al-anim-gear al-delay-7" style={{ '--al-rotation': '90deg' }} />
        <path d="M8.5 15.429a5 5 0 0 1 2.413-1.31" className="al-secondary al-anim-gear al-delay-7" style={{ '--al-rotation': '90deg' }} />
