...
const Scale3d = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M5 7v11a1 1 0 0 0 1 1h11" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M5.293 18.707 11 13" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <circle cx="19" cy="19" r="2" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <circle cx="5" cy="5" r="2" className="al-secondary al-anim-fade al-delay-3" style={{}} />
      </svg>
    </>
  );
});
