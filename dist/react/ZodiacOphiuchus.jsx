...
const ZodiacOphiuchus = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M3 10A6.06 6.06 0 0 1 12 10 A6.06 6.06 0 0 0 21 10" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M6 3v12a6 6 0 0 0 12 0V3" className="al-secondary al-anim-fade al-delay-1" style={{}} />
      </svg>
    </>
  );
});
