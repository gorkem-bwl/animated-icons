...
const ScanHeart = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M17 3h2a2 2 0 0 1 2 2v2" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M21 17v2a2 2 0 0 1-2 2h-2" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M3 7V5a2 2 0 0 1 2-2h2" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M7 21H5a2 2 0 0 1-2-2v-2" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <path d="M7.828 13.07A3 3 0 0 1 12 8.764a3 3 0 0 1 4.172 4.306l-3.447 3.62a1 1 0 0 1-1.449 0z" className="al-secondary al-anim-fade al-delay-4" style={{}} />
      </svg>
    </>
  );
});
