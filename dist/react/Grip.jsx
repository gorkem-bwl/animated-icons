...
const Grip = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <circle cx="12" cy="5" r="1" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <circle cx="19" cy="5" r="1" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <circle cx="5" cy="5" r="1" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <circle cx="12" cy="12" r="1" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <circle cx="19" cy="12" r="1" className="al-secondary al-anim-fade al-delay-4" style={{}} />
        <circle cx="5" cy="12" r="1" className="al-secondary al-anim-fade al-delay-5" style={{}} />
        <circle cx="12" cy="19" r="1" className="al-secondary al-anim-fade al-delay-6" style={{}} />
        <circle cx="19" cy="19" r="1" className="al-secondary al-anim-fade al-delay-7" style={{}} />
        <circle cx="5" cy="19" r="1" className="al-secondary al-anim-fade al-delay-7" style={{}} />
      </svg>
    </>
  );
});
