  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-code-2 ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="m18 16 4-4-4-4" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="m6 8-4 4 4 4" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="m14.5 4-5 16" className="al-primary al-anim-fade al-delay-2" style={{}} />
      </svg>
    </>
  );
});
