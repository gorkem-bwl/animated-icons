...
const BanknoteX = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M13 18H4a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="m17 17 5 5" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M18 12h.01" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="m22 17-5 5" className="al-secondary al-anim-fade al-delay-3" style={{}} />
