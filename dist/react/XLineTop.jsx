...
const XLineTop = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M18 4H6" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M18 8 6 20" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="m6 8 12 12" className="al-secondary al-anim-fade al-delay-2" style={{}} />
      </svg>
    </>
  );
});
