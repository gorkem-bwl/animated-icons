  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-radius ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M20.34 17.52a10 10 0 1 0-2.82 2.82" className="al-primary al-anim-scale-pop al-delay-0" style={{}} />
        <circle cx="19" cy="19" r="2" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
        <path d="m13.41 13.41 4.18 4.18" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
        <circle cx="12" cy="12" r="2" className="al-secondary al-anim-scale-pop al-delay-3" style={{}} />
      </svg>
    </>
  );
});
