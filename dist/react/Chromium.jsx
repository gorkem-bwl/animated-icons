...
const Chromium = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M10.88 21.94 15.46 14" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M21.17 8H12" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M3.95 6.06 8.54 14" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <circle cx="12" cy="12" r="10" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <circle cx="12" cy="12" r="4" className="al-secondary al-anim-fade al-delay-4" style={{}} />
      </svg>
    </>
  );
});
