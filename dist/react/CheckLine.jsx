...
const CheckLine = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M20 4L9 15" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M21 19L3 19" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M9 15L4 10" className="al-secondary al-anim-fade al-delay-2" style={{}} />
      </svg>
    </>
  );
});
