  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-check-line ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M20 4L9 15" className="al-primary al-anim-scale-pop al-delay-0" style={{}} />
        <path d="M21 19L3 19" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
        <path d="M9 15L4 10" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
      </svg>
    </>
  );
});
