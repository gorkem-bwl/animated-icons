  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-frame ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <line x1="22" x2="2" y1="6" y2="6" className="al-primary al-anim-scale-pop al-delay-0" style={{}} />
        <line x1="22" x2="2" y1="18" y2="18" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
        <line x1="6" x2="6" y1="2" y2="22" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
        <line x1="18" x2="18" y1="2" y2="22" className="al-secondary al-anim-scale-pop al-delay-3" style={{}} />
      </svg>
    </>
  );
});
