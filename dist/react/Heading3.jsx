...
const Heading3 = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M4 12h8" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M4 18V6" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M12 18V6" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M17.5 10.5c1.7-1 3.5 0 3.5 1.5a2 2 0 0 1-2 2" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <path d="M17 17.5c2 1.5 4 .3 4-1.5a2 2 0 0 0-2-2" className="al-secondary al-anim-fade al-delay-4" style={{}} />
      </svg>
    </>
  );
});
