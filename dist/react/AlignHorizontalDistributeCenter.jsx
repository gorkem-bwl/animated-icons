...
const AlignHorizontalDistributeCenter = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <rect width="6" height="14" x="4" y="5" rx="2" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <rect width="6" height="10" x="14" y="7" rx="2" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M17 22v-5" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M17 7V2" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <path d="M7 22v-3" className="al-secondary al-anim-fade al-delay-4" style={{}} />
        <path d="M7 5V2" className="al-secondary al-anim-fade al-delay-5" style={{}} />
      </svg>
    </>
  );
});
