  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-box ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M21 8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16Z" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="m3.3 7 8.7 5 8.7-5" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M12 22V12" className="al-primary al-anim-fade al-delay-2" style={{}} />
      </svg>
    </>
  );
});
