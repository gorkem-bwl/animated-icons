...
const AsteriskSquare = forwardRef(({
  size = 24,
  color = 'currentColor',
  primaryColor,
  secondaryColor,
  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-asterisk-square ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        ...
        <path d="m8.5 14 7-4" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
        <path d="m8.5 10 7 4" className="al-secondary al-anim-scale-pop al-delay-3" style={{}} />
      </svg>
    </>
  );
});

AsteriskSquare.displayName = 'AsteriskSquare';
