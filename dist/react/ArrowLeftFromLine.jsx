...
const ArrowLeftFromLine = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="m9 6-6 6 6 6" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M3 12h14" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M21 19V5" className="al-secondary al-anim-fade al-delay-2" style={{}} />
      </svg>
    </>
  );
});
