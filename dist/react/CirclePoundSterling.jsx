  ...
  return (
    <>
      ...
      >
        ...
        <path d="M10 16V9.5a1 1 0 0 1 5 0" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M8 12h4" className="al-secondary al-anim-fade al-delay-2" style={{}} />
