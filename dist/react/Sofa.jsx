...
const Sofa = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M20 9V6a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2v3" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M2 16a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-5a2 2 0 0 0-4 0v1.5a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5V11a2 2 0 0 0-4 0z" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M4 18v2" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M20 18v2" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <path d="M12 4v9" className="al-secondary al-anim-fade al-delay-4" style={{}} />
      </svg>
    </>
  );
});
