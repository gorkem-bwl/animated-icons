  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-at-sign ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <circle cx="12" cy="12" r="4" className="al-primary al-anim-mail-flap al-delay-0" style={{}} />
        <path d="M16 8v5a3 3 0 0 0 6 0v-1a10 10 0 1 0-4 8" className="al-secondary al-anim-fill al-delay-1" style={{}} />
      </svg>
    </>
  );
});
