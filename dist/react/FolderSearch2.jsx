...
const FolderSearch2 = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <circle cx="11.5" cy="12.5" r="2.5" className="al-primary al-anim-fill al-delay-0" style={{}} />
        ...
        <path d="M13.3 14.3 15 16" className="al-secondary al-anim-fade al-delay-2" style={{}} />
      </svg>
    </>
  );
});
