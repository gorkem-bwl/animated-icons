...
const NonBinary = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M12 2v10" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="m8.5 4 7 4" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="m8.5 8 7-4" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <circle cx="12" cy="17" r="5" className="al-secondary al-anim-fade al-delay-3" style={{}} />
      </svg>
    </>
  );
});
