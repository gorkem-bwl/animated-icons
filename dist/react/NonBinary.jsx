  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-non-binary ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M12 2v10" className="al-primary al-anim-scale-pop al-delay-0" style={{}} />
        <path d="m8.5 4 7 4" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
        <path d="m8.5 8 7-4" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
        <circle cx="12" cy="17" r="5" className="al-secondary al-anim-scale-pop al-delay-3" style={{}} />
      </svg>
    </>
  );
});
