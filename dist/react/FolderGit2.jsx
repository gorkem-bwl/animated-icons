...
const FolderGit2 = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M18 19a5 5 0 0 1-5-5v8" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M9 20H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h3.9a2 2 0 0 1 1.69.9l.81 1.2a2 2 0 0 0 1.67.9H20a2 2 0 0 1 2 2v5" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <circle cx="13" cy="12" r="2" className="al-secondary al-anim-fade al-delay-2" style={{}} />
