...
const Regex = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M17 3v10" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="m12.67 5.5 8.66 5" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="m12.67 10.5 8.66-5" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M9 17a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v2a2 2 0 0 0 2 2h2a2 2 0 0 0 2-2v-2z" className="al-secondary al-anim-fade al-delay-3" style={{}} />
      </svg>
    </>
  );
});
