...
const HdmiPort = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M22 9a1 1 0 0 0-1-1H3a1 1 0 0 0-1 1v4a1 1 0 0 0 1 1h1l2 2h12l2-2h1a1 1 0 0 0 1-1Z" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M7.5 12h9" className="al-secondary al-anim-fade al-delay-1" style={{}} />
      </svg>
    </>
  );
});
