...
const Bed = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M2 4v16" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M2 8h18a2 2 0 0 1 2 2v10" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M2 17h20" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M6 8v9" className="al-secondary al-anim-fade al-delay-3" style={{}} />
      </svg>
    </>
  );
});
