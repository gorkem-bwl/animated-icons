...
const AlignHorizontalSpaceAround = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <rect width="6" height="10" x="9" y="7" rx="2" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M4 22V2" className="al-secondary al-anim-fade al-delay-1" style={{}} />
