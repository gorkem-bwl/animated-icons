...
const UserRoundKey = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M19 11v6" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M19 13h2" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M2 21a8 8 0 0 1 12.868-6.349" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <circle cx="10" cy="8" r="5" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <circle cx="19" cy="19" r="2" className="al-secondary al-anim-fade al-delay-4" style={{}} />
      </svg>
    </>
  );
});
