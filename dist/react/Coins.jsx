...
const Coins = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M13.744 17.736a6 6 0 1 1-7.48-7.48" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M15 6h1v4" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="m6.134 14.768.866-.5 2 3.464" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <circle cx="16" cy="8" r="6" className="al-secondary al-anim-fade al-delay-3" style={{}} />
      </svg>
    </>
  );
});
