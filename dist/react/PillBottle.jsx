...
const PillBottle = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M18 11h-4a1 1 0 0 0-1 1v5a1 1 0 0 0 1 1h4" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M6 7v13a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V7" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <rect width="16" height="5" x="4" y="2" rx="1" className="al-secondary al-anim-fade al-delay-2" style={{}} />
      </svg>
    </>
  );
});
