  ...
  return (
    <>
      ...
      >
        ...
        <path d="M8 3H3v5" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M12 22v-8.3a4 4 0 0 0-1.172-2.872L3 3" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="m15 9 6-6" className="al-secondary al-anim-fade al-delay-3" style={{}} />
      </svg>
    </>
  );
});
