...
const Torus = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <ellipse cx="12" cy="11" rx="3" ry="2" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <ellipse cx="12" cy="12.5" rx="10" ry="8.5" className="al-secondary al-anim-fade al-delay-1" style={{}} />
      </svg>
    </>
  );
});
