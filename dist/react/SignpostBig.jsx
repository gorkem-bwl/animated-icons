...
const SignpostBig = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M10 9H4L2 7l2-2h6" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M14 5h6l2 2-2 2h-6" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M10 22V4a2 2 0 1 1 4 0v18" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M8 22h8" className="al-secondary al-anim-fade al-delay-3" style={{}} />
      </svg>
    </>
  );
});
