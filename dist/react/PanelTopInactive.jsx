...
const PanelTopInactive = forwardRef(({
  size = 24,
  color = 'currentColor',
  primaryColor,
  secondaryColor,
  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-panel-top-inactive ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        ...
        <path d="M19 9h2" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
        <path d="M3 9h2" className="al-secondary al-anim-scale-pop al-delay-3" style={{}} />
        <path d="M9 9h1" className="al-secondary al-anim-scale-pop al-delay-4" style={{}} />
      </svg>
    </>
  );
});

PanelTopInactive.displayName = 'PanelTopInactive';
