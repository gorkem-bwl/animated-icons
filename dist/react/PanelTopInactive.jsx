  ...
  return (
    <>
      ...
      >
        ...
        <path d="M19 9h2" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M3 9h2" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <path d="M9 9h1" className="al-secondary al-anim-fade al-delay-4" style={{}} />
      </svg>
    </>
  );
});
