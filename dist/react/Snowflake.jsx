  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-snowflake ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="m10 20-1.25-2.5L6 18" className="al-primary al-anim-fade al-delay-0" style={{}} />
        <path d="M10 4 8.75 6.5 6 6" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="m14 20 1.25-2.5L18 18" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="m14 4 1.25 2.5L18 6" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <path d="m17 21-3-6h-4" className="al-secondary al-anim-fade al-delay-4" style={{}} />
        <path d="m17 3-3 6 1.5 3" className="al-secondary al-anim-fade al-delay-5" style={{}} />
        <path d="M2 12h6.5L10 9" className="al-secondary al-anim-fade al-delay-6" style={{}} />
        <path d="m20 10-1.5 2 1.5 2" className="al-secondary al-anim-fade al-delay-7" style={{}} />
        <path d="M22 12h-6.5L14 15" className="al-secondary al-anim-fade al-delay-7" style={{}} />
        <path d="m4 10 1.5 2L4 14" className="al-secondary al-anim-fade al-delay-7" style={{}} />
        <path d="m7 21 3-6-1.5-3" className="al-secondary al-anim-fade al-delay-7" style={{}} />
        <path d="m7 3 3 6h4" className="al-secondary al-anim-fade al-delay-7" style={{}} />
      </svg>
    </>
  );
});
