...
const BookType = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M10 13h4" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M12 6v7" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M16 8V6H8v2" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M4 19.5v-15A2.5 2.5 0 0 1 6.5 2H19a1 1 0 0 1 1 1v18a1 1 0 0 1-1 1H6.5a1 1 0 0 1 0-5H20" className="al-secondary al-anim-fade al-delay-3" style={{}} />
      </svg>
    </>
  );
});
