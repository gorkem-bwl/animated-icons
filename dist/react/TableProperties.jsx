...
const TableProperties = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M15 3v18" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <rect width="18" height="18" x="3" y="3" rx="2" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M21 9H3" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M21 15H3" className="al-secondary al-anim-fade al-delay-3" style={{}} />
      </svg>
    </>
  );
});
