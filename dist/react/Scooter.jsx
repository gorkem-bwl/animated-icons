...
const Scooter = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M21 4h-3.5l2 11.05" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M6.95 17h5.142c.523 0 .95-.406 1.063-.916a6.5 6.5 0 0 1 5.345-5.009" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <circle cx="19.5" cy="17.5" r="2.5" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <circle cx="4.5" cy="17.5" r="2.5" className="al-secondary al-anim-fade al-delay-3" style={{}} />
      </svg>
    </>
  );
});
