  ...
  return (
    <>
      ...
      >
        ...
        <circle cx="11.5" cy="14.5" r="2.5" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M13.3 16.3 15 18" className="al-secondary al-anim-fade al-delay-3" style={{}} />
      </svg>
    </>
  );
});
