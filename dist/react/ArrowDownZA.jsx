...
const ArrowDownZa = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="m3 16 4 4 4-4" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M7 4v16" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M15 4h5l-5 6h5" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M15 20v-3.5a2.5 2.5 0 0 1 5 0V20" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <path d="M20 18h-5" className="al-secondary al-anim-fade al-delay-4" style={{}} />
      </svg>
    </>
  );
});
