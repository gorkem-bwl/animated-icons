...
const BetweenVerticalStart = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <rect width="7" height="13" x="3" y="8" rx="1" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="m15 2-3 3-3-3" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <rect width="7" height="13" x="14" y="8" rx="1" className="al-secondary al-anim-fade al-delay-2" style={{}} />
      </svg>
    </>
  );
});
