  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-git-pull-request-closed ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <circle cx="6" cy="6" r="3" className="al-primary al-anim-scale-pop al-delay-0" style={{}} />
        <path d="M6 9v12" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
        <path d="m21 3-6 6" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
        <path d="m21 9-6-6" className="al-secondary al-anim-scale-pop al-delay-3" style={{}} />
        <path d="M18 11.5V15" className="al-secondary al-anim-scale-pop al-delay-4" style={{}} />
        <circle cx="18" cy="18" r="3" className="al-secondary al-anim-scale-pop al-delay-5" style={{}} />
      </svg>
    </>
  );
});
