  ...
  return (
    <>
      ...
      >
        ...
        <path d="M6 9v12" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="m21 3-6 6" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="m21 9-6-6" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <path d="M18 11.5V15" className="al-secondary al-anim-fade al-delay-4" style={{}} />
