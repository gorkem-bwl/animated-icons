...
const Merge = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="m8 6 4-4 4 4" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M12 2v10.3a4 4 0 0 1-1.172 2.872L4 22" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="m20 22-5-5" className="al-secondary al-anim-fade al-delay-2" style={{}} />
      </svg>
    </>
  );
});
