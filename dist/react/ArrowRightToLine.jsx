...
const ArrowRightToLine = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M17 12H3" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="m11 18 6-6-6-6" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M21 5v14" className="al-secondary al-anim-fade al-delay-2" style={{}} />
      </svg>
    </>
  );
});
