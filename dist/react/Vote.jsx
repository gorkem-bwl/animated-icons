...
const Vote = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="m9 12 2 2 4-4" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M5 7c0-1.1.9-2 2-2h10a2 2 0 0 1 2 2v12H5V7Z" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M22 19H2" className="al-secondary al-anim-fade al-delay-2" style={{}} />
      </svg>
    </>
  );
});
