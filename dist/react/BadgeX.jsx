  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-badge-x ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        ...
        <line x1="15" x2="9" y1="9" y2="15" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
        <line x1="9" x2="15" y1="9" y2="15" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
      </svg>
    </>
  );
});
