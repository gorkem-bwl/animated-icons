...
const Key = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="m15.5 7.5 2.3 2.3a1 1 0 0 0 1.4 0l2.1-2.1a1 1 0 0 0 0-1.4L19 4" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="m21 2-9.6 9.6" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <circle cx="7.5" cy="15.5" r="5.5" className="al-secondary al-anim-fade al-delay-2" style={{}} />
      </svg>
    </>
  );
});
