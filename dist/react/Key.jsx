  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-key ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="m15.5 7.5 2.3 2.3a1 1 0 0 0 1.4 0l2.1-2.1a1 1 0 0 0 0-1.4L19 4" className="al-primary al-anim-fade al-delay-0" style={{ '--al-rotation': '45deg' }} />
        <path d="m21 2-9.6 9.6" className="al-secondary al-anim-fade al-delay-1" style={{ '--al-rotation': '45deg' }} />
        <circle cx="7.5" cy="15.5" r="5.5" className="al-secondary al-anim-fill al-delay-2" style={{ '--al-rotation': '45deg' }} />
      </svg>
    </>
  );
});
