  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-bluetooth ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="m7 7 10 10-5 5V2l5 5L7 17" className="al-primary al-anim-pulse-element al-delay-0" style={{}} />
      </svg>
    </>
  );
});
