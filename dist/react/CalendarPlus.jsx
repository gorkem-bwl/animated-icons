...
const CalendarPlus = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M16 19h6" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M16 2v4" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M19 16v6" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M21 12.598V6a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h8.5" className="al-secondary al-anim-fade al-delay-3" style={{}} />
