...
const Sticker = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M21 9a2.4 2.4 0 0 0-.706-1.706l-3.588-3.588A2.4 2.4 0 0 0 15 3H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2z" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M15 3v5a1 1 0 0 0 1 1h5" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M8 13h.01" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="M16 13h.01" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <path d="M10 16s.8 1 2 1c1.3 0 2-1 2-1" className="al-secondary al-anim-fade al-delay-4" style={{}} />
      </svg>
    </>
  );
});
