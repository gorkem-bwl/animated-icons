  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-icon-file-input ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="M4 11V4a2 2 0 0 1 2-2h8a2.4 2.4 0 0 1 1.706.706l3.588 3.588A2.4 2.4 0 0 1 20 8v12a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2v-1" className="al-primary al-anim-scale-pop al-delay-0" style={{}} />
        <path d="M14 2v5a1 1 0 0 0 1 1h5" className="al-secondary al-anim-scale-pop al-delay-1" style={{}} />
        <path d="M2 15h10" className="al-secondary al-anim-scale-pop al-delay-2" style={{}} />
        <path d="m9 18 3-3-3-3" className="al-secondary al-anim-scale-pop al-delay-3" style={{}} />
      </svg>
    </>
  );
});
