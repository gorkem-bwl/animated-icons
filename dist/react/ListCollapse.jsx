...
const ListCollapse = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M10 5h11" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M10 12h11" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <path d="M10 19h11" className="al-secondary al-anim-fade al-delay-2" style={{}} />
        <path d="m3 10 3-3-3-3" className="al-secondary al-anim-fade al-delay-3" style={{}} />
        <path d="m3 20 3-3-3-3" className="al-secondary al-anim-fade al-delay-4" style={{}} />
      </svg>
    </>
  );
});
