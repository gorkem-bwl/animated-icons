...
const Rss = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path d="M4 11a9 9 0 0 1 9 9" className="al-primary al-anim-fill al-delay-0" style={{}} />
        <path d="M4 4a16 16 0 0 1 16 16" className="al-secondary al-anim-fade al-delay-1" style={{}} />
        <circle cx="5" cy="19" r="1" className="al-secondary al-anim-fade al-delay-2" style={{}} />
      </svg>
    </>
  );
});
