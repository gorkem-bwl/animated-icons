  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-lucide-icon animated-lucide-reply-all ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path d="m12 17-5-5 5-5" className="al-primary al-anim-mail-flap al-delay-0" style={{}} />
        <path d="M22 18v-2a4 4 0 0 0-4-4H7" className="al-secondary al-anim-fill al-delay-1" style={{}} />
        <path d="m7 17-5-5 5-5" className="al-secondary al-anim-fill al-delay-2" style={{}} />
      </svg>
    </>
  );
});
