...
const ChartPie = forwardRef(({
  ...
  return (
    <>
      ...
      >
        <title>{label}</title>
        <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 6a7.5 7.5 0 1 0 7.5 7.5h-7.5V6Z" className="ah-primary ah-anim-fill ah-delay-0" style={{}} />
        <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 10.5H21A7.5 7.5 0 0 0 13.5 3v7.5Z" className="ah-secondary ah-anim-scale-pop ah-delay-1" style={{}} />
      </svg>
    </>
  );
});
