  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-heroicon animated-heroicon-chart-pie ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 6a7.5 7.5 0 1 0 7.5 7.5h-7.5V6Z" className="ah-primary ah-anim-gear ah-delay-0" style={{ '--ah-rotation': '45deg' }} />
        <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 10.5H21A7.5 7.5 0 0 0 13.5 3v7.5Z" className="ah-secondary ah-anim-fade ah-delay-1" style={{ '--ah-rotation': '45deg' }} />
      </svg>
    </>
  );
});
