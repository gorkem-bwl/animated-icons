...
const HandThumbDown = forwardRef(({
  size = 24,
  color = 'currentColor',
  primaryColor,
  secondaryColor,
  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-heroicon animated-heroicon-hand-thumb-down ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
