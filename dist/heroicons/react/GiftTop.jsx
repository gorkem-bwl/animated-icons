  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-heroicon animated-heroicon-gift-top ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
