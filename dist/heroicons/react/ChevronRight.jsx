  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-heroicon animated-heroicon-chevron-right ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path strokeLinecap="round" strokeLinejoin="round" d="m8.25 4.5 7.5 7.5-7.5 7.5" className="ah-primary ah-anim-nudge ah-delay-0" style={{ '--ah-tx': '2px', '--ah-ty': '0px' }} />
      </svg>
    </>
  );
});
