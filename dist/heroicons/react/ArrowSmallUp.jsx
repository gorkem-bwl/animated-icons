  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-heroicon animated-heroicon-arrow-small-up ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 19.5v-15m0 0-6.75 6.75M12 4.5l6.75 6.75" className="ah-primary ah-anim-nudge ah-delay-0" style={{ '--ah-tx': '0px', '--ah-ty': '-2px' }} />
      </svg>
    </>
  );
});
