...
const ReceiptRefund = forwardRef(({
  size = 24,
  color = 'currentColor',
  primaryColor,
  secondaryColor,
  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-heroicon animated-heroicon-receipt-refund ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
