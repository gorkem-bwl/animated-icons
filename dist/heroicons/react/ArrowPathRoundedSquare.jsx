...
const ArrowPathRoundedSquare = forwardRef(({
  size = 24,
  color = 'currentColor',
  primaryColor,
  secondaryColor,
  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-heroicon animated-heroicon-arrow-path-rounded-square ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
