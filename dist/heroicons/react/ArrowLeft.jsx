  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-heroicon animated-heroicon-arrow-left ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 19.5 3 12m0 0 7.5-7.5M3 12h18" className="ah-primary ah-anim-nudge ah-delay-0" style={{ '--ah-tx': '-2px', '--ah-ty': '0px' }} />
      </svg>
    </>
  );
});
