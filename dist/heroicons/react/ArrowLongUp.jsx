  ...
  return (
    <>
      ...
      <svg
        ...
        className={`animated-heroicon animated-heroicon-arrow-long-up ${className}`}
        style={cssVars}
        role="img"
        aria-label={label}
        {...props}
      >
        <title>{label}</title>
        <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 6.75 12 3m0 0 3.75 3.75M12 3v18" className="ah-primary ah-anim-nudge ah-delay-0" style={{ '--ah-tx': '0px', '--ah-ty': '-2px' }} />
      </svg>
    </>
  );
});
