...
export const iconSetConfigs = {
  lucide: {
    ...
    outSvelte: path.join(ROOT, 'dist/svelte'),
    outSolid: path.join(ROOT, 'dist/solid'),
    outWc: path.join(ROOT, 'dist/web-components'),
  ...
  iconoir: {
    ...
    outSvelte: path.join(ROOT, 'dist/iconoir/svelte'),
    outSolid: path.join(ROOT, 'dist/iconoir/solid'),
    outWc: path.join(ROOT, 'dist/iconoir/web-components'),
  ...
  heroicons: {
    ...
    outSvelte: path.join(ROOT, 'dist/heroicons/svelte'),
    outSolid: path.join(ROOT, 'dist/heroicons/solid'),
    outWc: path.join(ROOT, 'dist/heroicons/web-components'),
