...
export default function IconCard({
  ...
  return (
    ...
    >
      <div
        className="flex h-10 w-10 items-center justify-center text-neutral-600 dark:text-white/70 group-hover:text-neutral-900 dark:group-hover:text-white transition-colors [&_svg]:w-6 [&_svg]:h-6"
