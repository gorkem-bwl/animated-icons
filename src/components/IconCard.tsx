  ...
  return (
    <div className="relative">
      ...
      {open && svgContent && (
        ...
        >
          <style>{`@keyframes popIn { from { opacity: 0; transform: translateX(-50%) translateY(-4px) scale(0.97); } to { opacity: 1; transform: translateX(-50%) translateY(0) scale(1); } }`}</style>
